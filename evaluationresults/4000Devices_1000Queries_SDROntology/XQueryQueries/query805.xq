...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB2xxmini_0 in $node_Object_0/RFDevice:hasProducer
  ...
  let $GRAPH_4 :=  
    ...
    for $node_FormationJamming_0 in $node_Quantity_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("FormationJamming_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("FormationJamming_0"))
