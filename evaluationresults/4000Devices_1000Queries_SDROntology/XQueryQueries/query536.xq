...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Transceiving_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_12 :=  
    ...
    let $value_Value_0 := fn:data($node_Value_0/@rdf:about)
    for $node_Object_0 in $node_Value_0/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_13 :=  
    ...
    for $node_Frequency_0 in $node_Object_0/RFDevice:hasGain
