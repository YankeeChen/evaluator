...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE312_0 in $node_InstantaneousFrequencyMeasurementReceiver_0/Nuvio:aggregateOf
    let $value_USRPE312_0 := fn:data($node_USRPE312_0/@rdf:resource)
    where fn:exists($node_InstantaneousFrequencyMeasurementReceiver_0) and fn:exists($value_USRPE312_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance986"]/Nuvio:aggregateOf
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("InstantaneousFrequencyMeasurementReceiver_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("InstantaneousFrequencyMeasurementReceiver_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_0,$GRAPH_5,("USRPE312_0"))
  return
    $GRAPH_6
return
