...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasPulseRepetitionInterval/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Power_instance0"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
