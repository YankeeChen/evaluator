...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX300_0 := fn:data($node_USRPX300_0/@rdf:about)
    for $node_Var0 in $node_USRPX300_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Percentage_0) and fn:exists($node_Var0) and $node_Percentage_0/RFDevice:hasMaxPowerConsumption/@rdf:resource = $value_Var0
    return
      <xqllib:result>
