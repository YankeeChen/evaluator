...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_CommunicationsSystem_0 := fn:data($node_CommunicationsSystem_0/@rdf:about)
    for $node_Entity_0 in $node_CommunicationsSystem_0/RFDevice:hasCapability
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) <= -1953041244)]
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_0,$GRAPH_13,("CommunicationsSystem_0"))
  return
    $GRAPH_14
return
