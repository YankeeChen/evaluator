...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE3xx_0 in $node_Entity_0/Nuvio:compositeOf
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue1"]) <= -991452084)]
  ...
  let $GRAPH_11 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Jammer_instance164"]/Nuvio:expresses
