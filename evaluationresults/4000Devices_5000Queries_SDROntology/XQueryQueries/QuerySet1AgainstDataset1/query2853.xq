...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CommunicationsSystem_0 in $node_Entity_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Entity_0 in $node_WeightUnit_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_15 :=  
    for $node_Object_0 in $doc_ObjectDescription[RFDevice:hasMaxPowerConsumption/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance224"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
