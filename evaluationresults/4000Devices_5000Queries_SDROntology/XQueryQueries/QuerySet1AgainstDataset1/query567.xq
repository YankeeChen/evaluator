...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    for $node_InformationEntity_0 in $node_Kintex7FPGA_0/Nuvio:expresses
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:resource)
    where fn:exists($value_InformationEntity_0) and fn:exists($node_Kintex7FPGA_0)
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Kintex7FPGA_0 in $node_Var1/RFDevice:hasProducer
    let $value_Kintex7FPGA_0 := fn:data($node_Kintex7FPGA_0/@rdf:resource)
    where fn:exists($value_Kintex7FPGA_0) and fn:exists($node_Var1)
    return
      <xqllib:result>
        <xqllib:var name="Kintex7FPGA_0">{$value_Kintex7FPGA_0}</xqllib:var>
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_7,$GRAPH_11,("Kintex7FPGA_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_6,$GRAPH_12,())
  let $GRAPH_14 := xqllib:and($GRAPH_3,$GRAPH_13,("Entity_0","InformationEntity_0"))
