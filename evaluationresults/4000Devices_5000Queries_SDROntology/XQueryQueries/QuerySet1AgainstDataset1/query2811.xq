...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_CortexA9_0/Nuvio:partOf
    ...
    where fn:exists($node_CortexA9_0) and fn:exists($value_InstantaneousFrequencyMeasurementReceiver_0)
    return
      <xqllib:result>
