...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_JammingSystem_0 := fn:data($node_JammingSystem_0/@rdf:about)
    for $node_Receiver_0 in $node_JammingSystem_0/Nuvio:partOf
    let $value_Receiver_0 := fn:data($node_Receiver_0/@rdf:resource)
    where fn:exists($node_JammingSystem_0) and fn:exists($value_Receiver_0)
    return
      <xqllib:result>
        <xqllib:var name="JammingSystem_0">{$value_JammingSystem_0}</xqllib:var>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Receiver_0 in $node_Entity_0/Nuvio:aggregateOf
    let $value_Receiver_0 := fn:data($node_Receiver_0/@rdf:resource)
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_BlinkingJamming_0) and fn:exists($node_Entity_0) and $node_BlinkingJamming_0/RFDevice:supportsTuning/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("BlinkingJamming_0"))
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_4,$GRAPH_13,("Entity_0","UnitOfMeasure_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_3,$GRAPH_14,("Entity_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_2,$GRAPH_15,("Receiver_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_1,$GRAPH_16,("Receiver_0"))
