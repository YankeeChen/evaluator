...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    where fn:exists($node_Object_0) and fn:exists($node_SpotJamming_0) and $node_SpotJamming_0/RFDevice:hasCapability/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
        <xqllib:var name="Object_0">{$value_Object_0}</xqllib:var>
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("SpotJamming_0"))
