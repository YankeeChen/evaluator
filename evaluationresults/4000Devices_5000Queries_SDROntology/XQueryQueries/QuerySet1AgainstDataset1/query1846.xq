...
let $result :=  
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("WeightUnit_0"))
  let $GRAPH_8 :=  
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_2,$GRAPH_11,("Weight_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_1,$GRAPH_12,("Weight_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_0,$GRAPH_13,("SurveillanceRadar_0"))
  return
    $GRAPH_14
return
