...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPN210_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Weight_instance37"]/RFDevice:hasMaxPowerConsumption
  ...
  let $GRAPH_2 := xqllib:and($GRAPH_0,$GRAPH_1,("USRPN210_0"))
  return
    $GRAPH_2
return
