...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Frequency_instance103"]/RFDevice:hasBandwidth
  ...
  let $GRAPH_12 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_InformationEntity_0) and fn:exists($node_Var0) and $node_InformationEntity_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_14 := $GRAPH_13[(data(xqllib:var[@name="DataValue0"]) < -1300335753)]
  let $GRAPH_15 :=  
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_12,$GRAPH_16,("InformationEntity_0","Var0"))
  ...
  let $GRAPH_21 := xqllib:optional($GRAPH_4,$GRAPH_20,("Var0"))
  let $GRAPH_22 := xqllib:and($GRAPH_3,$GRAPH_21,("Var0"))
  let $GRAPH_23 := xqllib:and($GRAPH_2,$GRAPH_22,("Var0"))
  let $GRAPH_24 :=  
