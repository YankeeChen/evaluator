...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:about)
    for $node_Var0 in $node_ContinuousWaveRadar_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) < 1273737434)]
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_4,$GRAPH_12,("Var0"))
