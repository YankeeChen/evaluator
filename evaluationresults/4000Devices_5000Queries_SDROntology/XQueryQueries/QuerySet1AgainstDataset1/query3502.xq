...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_CrossPolarizationJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 := xqllib:and($GRAPH_1,$GRAPH_2,("CrossPolarizationJamming_0"))
