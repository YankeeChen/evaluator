...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_TrackingRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_3 :=  
    for $node_PulseDopplerRadarModulation_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#TimeInterval_instance46"]/RFDevice:hasMaxOutputPower
