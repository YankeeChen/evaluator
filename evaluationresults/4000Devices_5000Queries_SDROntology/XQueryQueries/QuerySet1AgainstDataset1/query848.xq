...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE312_0 in $node_Entity_0/Nuvio:partOf
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Voltage_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("USRPE312_0"))
  return
    $GRAPH_10
return
