...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX310_0 := fn:data($node_USRPX310_0/@rdf:about)
    for $node_Entity_0 in $node_USRPX310_0/RFDevice:hasMaxPowerConsumption
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Situation_0 in $node_Object_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("Entity_0","Situation_0"))
