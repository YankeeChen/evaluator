...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_GNURadio_0 in $node_Object_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    where fn:exists($node_Distance_0) and fn:exists($node_Object_0) and $node_Distance_0/RFDevice:hasCapacity/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
