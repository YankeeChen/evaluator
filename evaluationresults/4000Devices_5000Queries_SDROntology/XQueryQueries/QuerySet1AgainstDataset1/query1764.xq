...
let $result :=  
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) = -1747037439)]
  ...
  let $GRAPH_12 :=  
    ...
    for $node_Var0 in $node_TimeUnit_0/Nuvio:hasUnitOfMeasure
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
    where fn:exists($node_TimeUnit_0) and fn:exists($value_Var0)
    return
      <xqllib:result>
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_12,$GRAPH_13,("TimeUnit_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_11,$GRAPH_14,("Var0"))
  let $GRAPH_16 := ($GRAPH_10,$GRAPH_15)
  let $GRAPH_17 := xqllib:and($GRAPH_8,$GRAPH_16,("Entity_0"))
  ...
  let $GRAPH_20 :=  
    ...
    for $node_Entity_0 in $node_USRPB205mini_i_0/Nuvio:isExpressedBy
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_22 :=  
    ...
    for $node_USRPB205mini_i_0 in $node_Object_0/RFDevice:isProducerOf
    let $value_USRPB205mini_i_0 := fn:data($node_USRPB205mini_i_0/@rdf:resource)
    where fn:exists($node_Object_0) and fn:exists($value_USRPB205mini_i_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_24 := xqllib:and($GRAPH_22,$GRAPH_23,("Object_0"))
  let $GRAPH_25 := xqllib:and($GRAPH_21,$GRAPH_24,("USRPB205mini_i_0"))
  let $GRAPH_26 := ($GRAPH_20,$GRAPH_25)
  let $GRAPH_27 := xqllib:and($GRAPH_18,$GRAPH_26,("Entity_0"))
  let $GRAPH_28 := xqllib:optional($GRAPH_2,$GRAPH_27,("Entity_0"))
  let $GRAPH_29 := xqllib:and($GRAPH_1,$GRAPH_28,("Entity_0"))
  let $GRAPH_30 := xqllib:optional($GRAPH_0,$GRAPH_29,("USRPN3xx_0"))
  return
    $GRAPH_30
return
