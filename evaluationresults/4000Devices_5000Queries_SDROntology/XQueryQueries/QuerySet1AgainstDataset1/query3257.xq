...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Aircraft_0 in $doc_ObjectDescription[RFDevice:supportsSpectrumSensing/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Moving_instance89"]
    let $value_Aircraft_0 := fn:data($node_Aircraft_0/@rdf:about)
