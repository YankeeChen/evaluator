...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ElectricCharge_0) and fn:exists($node_Entity_0) and $node_ElectricCharge_0/RFDevice:hasTransmitPowerRange/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_5,$GRAPH_8,("ElectricCharge_0"))
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("InformationContent_0"))
