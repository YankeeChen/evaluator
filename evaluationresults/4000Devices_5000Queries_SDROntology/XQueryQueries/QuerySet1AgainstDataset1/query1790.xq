...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_Ratio_0/RFDevice:hasEffectiveRadiatedPower
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_12 :=  
    ...
    for $node_Value_0 in $node_Object_0/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_14 := $GRAPH_13[(data(xqllib:var[@name="DataValue0"]) >= 2014599334)]
  let $GRAPH_15 := ($GRAPH_12,$GRAPH_14)
  let $GRAPH_16 := xqllib:and($GRAPH_10,$GRAPH_15,("Value_0"))
