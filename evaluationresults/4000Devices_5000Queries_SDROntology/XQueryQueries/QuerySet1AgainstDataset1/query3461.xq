...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Process_0 in $node_AutomaticGainControl_0/Nuvio:hasSubprocess
    let $value_Process_0 := fn:data($node_Process_0/@rdf:resource)
    where fn:exists($node_AutomaticGainControl_0) and fn:exists($value_Process_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_4,$GRAPH_5,("AutomaticGainControl_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("AutomaticGainControl_0"))
