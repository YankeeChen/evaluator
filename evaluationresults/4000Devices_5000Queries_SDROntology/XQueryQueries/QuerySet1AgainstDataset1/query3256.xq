...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CR_0 in $node_Var0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Transmitting_0) and fn:exists($node_Var0) and $node_Transmitting_0/Nuvio:hasSubprocess/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Transmitting_0 in $node_Power_0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_3,$GRAPH_10,("Transmitting_0"))
  let $GRAPH_12 := xqllib:optional($GRAPH_2,$GRAPH_11,("Transmitting_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_1,$GRAPH_12,("Var0"))
  let $GRAPH_14 := xqllib:and($GRAPH_0,$GRAPH_13,("CR_0"))
  return
    $GRAPH_14
return
