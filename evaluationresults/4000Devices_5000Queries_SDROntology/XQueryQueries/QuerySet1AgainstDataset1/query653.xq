...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ElectronicAttackSystem_0 := fn:data($node_ElectronicAttackSystem_0/@rdf:about)
    for $node_Entity_0 in $node_ElectronicAttackSystem_0/Nuvio:compositeOf
  ...
  let $GRAPH_3 := $GRAPH_2[(data(xqllib:var[@name="DataValue0"]) < 482335370)]
  let $GRAPH_4 := xqllib:and($GRAPH_1,$GRAPH_3,("Entity_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_0,$GRAPH_4,("ElectronicAttackSystem_0"))
  return
    $GRAPH_5
return
