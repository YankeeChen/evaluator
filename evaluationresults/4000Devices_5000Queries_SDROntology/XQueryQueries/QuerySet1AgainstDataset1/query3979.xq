...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_Kintex7FPGA_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Kintex7FPGA_0 in $node_Var0/RFDevice:hasProducer
  ...
  let $GRAPH_3 := xqllib:and($GRAPH_1,$GRAPH_2,("Kintex7FPGA_0"))
  let $GRAPH_4 := xqllib:and($GRAPH_0,$GRAPH_3,("USRPX310_0"))
  return
    $GRAPH_4
return
