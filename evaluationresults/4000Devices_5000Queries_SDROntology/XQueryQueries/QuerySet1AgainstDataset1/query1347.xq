...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_RadioComponent_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_RadioComponent_0 in $node_DirectConversionReceiver_0/Nuvio:aggregateOf
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:resource)
    where fn:exists($node_DirectConversionReceiver_0) and fn:exists($value_RadioComponent_0)
    return
      <xqllib:result>
