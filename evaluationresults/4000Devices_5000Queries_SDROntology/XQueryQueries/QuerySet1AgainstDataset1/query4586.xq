...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SearchRadar_0 in $node_Entity_0/RFDevice:supportsJamming
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) < -1420376143)]
  ...
  let $GRAPH_14 := xqllib:optional($GRAPH_0,$GRAPH_13,("SearchRadar_0"))
  return
    $GRAPH_14
return
