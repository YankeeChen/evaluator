...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPE312_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#DirectConversionReceiver_instance78"]/Nuvio:partOf
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("USRPE312_0"))
  return
    $GRAPH_2
return
