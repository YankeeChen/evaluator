...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE312_0 in $node_Var0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) > -21.15)]
  let $GRAPH_9 := xqllib:optional($GRAPH_6,$GRAPH_8,("Var1"))
