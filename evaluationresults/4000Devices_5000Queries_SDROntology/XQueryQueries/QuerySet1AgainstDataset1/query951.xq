...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN200_0 in $node_Object_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    for $node_ElectricCharge_0 in $node_Object_0/RFDevice:hasChargingTime
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("ElectricCharge_0"))
