...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Entity_0 in $node_Var0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_6 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPN200"]
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_Var1/RFDevice:supportsTransmitting
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_8 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#FixedBandwidthSensing"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("ElectronicSupport_0"))
  ...
  let $GRAPH_19 := xqllib:and($GRAPH_0,$GRAPH_18,("Full_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_19
return
