...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_RadioComponent_0 in $node_CortexA9_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_CortexA9_0 in $doc_ObjectDescription
    let $value_CortexA9_0 := fn:data($node_CortexA9_0/@rdf:about)
    for $node_IEDJammer_0 in $node_CortexA9_0/Nuvio:partOf
    let $value_IEDJammer_0 := fn:data($node_IEDJammer_0/@rdf:resource)
    where fn:exists($node_CortexA9_0) and fn:exists($value_IEDJammer_0)
    return
      <xqllib:result>
        <xqllib:var name="CortexA9_0">{$value_CortexA9_0}</xqllib:var>
  ...
  let $GRAPH_5 :=  
    ...
    let $value_IEDJammer_0 := fn:data($node_IEDJammer_0/@rdf:about)
    for $node_FreqencyRange_0 in $node_IEDJammer_0/RFDevice:hasFrequencyRange
    let $value_FreqencyRange_0 := fn:data($node_FreqencyRange_0/@rdf:resource)
    where fn:exists($value_FreqencyRange_0) and fn:exists($node_IEDJammer_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_7 :=  
    ...
    let $value_FreqencyRange_0 := fn:data($node_FreqencyRange_0/@rdf:about)
    for $node_Entity_0 in $node_FreqencyRange_0/RFDevice:hasMin
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_9,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_8,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_7,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_6,$GRAPH_19,("FreqencyRange_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_5,$GRAPH_20,("FreqencyRange_0"))
  let $GRAPH_22 := xqllib:optional($GRAPH_4,$GRAPH_21,("IEDJammer_0"))
  let $GRAPH_23 := xqllib:and($GRAPH_3,$GRAPH_22,("IEDJammer_0"))
  let $GRAPH_24 := xqllib:and($GRAPH_2,$GRAPH_23,("CortexA9_0"))
  let $GRAPH_25 := xqllib:and($GRAPH_1,$GRAPH_24,("RadioComponent_0"))
  let $GRAPH_26 := xqllib:optional($GRAPH_0,$GRAPH_25,("CommunicationsSystem_0"))
  return
    $GRAPH_26
return
