...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var1 in $node_Var2/RFDevice:supportsTuning
  ...
  let $GRAPH_4 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#LongitudeValue"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
