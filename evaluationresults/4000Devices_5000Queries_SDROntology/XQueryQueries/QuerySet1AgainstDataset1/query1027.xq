...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE3xx_0 in $node_Entity_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) != -1579502944)]
  ...
  let $GRAPH_14 := xqllib:optional($GRAPH_0,$GRAPH_13,("USRPE3xx_0"))
  return
    $GRAPH_14
return
