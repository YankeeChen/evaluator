...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance2905"]/RFDevice:hasPulseRepetitionInterval
  ...
  let $GRAPH_8 :=  
    ...
    for $node_QuantityRange_0 in $node_ElectricCharge_0/RFDevice:hasMin
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_7,$GRAPH_10,("QuantityRange_0"))
