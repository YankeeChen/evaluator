...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Situation_0 := fn:data($node_Situation_0/@rdf:about)
    where fn:exists($node_CommunicationsJamming_0) and fn:exists($node_Situation_0) and $node_CommunicationsJamming_0/Nuvio:relevantIndividual/@rdf:resource = $value_Situation_0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_4,$GRAPH_9,("Entity_0","Situation_0"))
