...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ModelX_0 in $node_Entity_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Power_instance42"]/RFDevice:hasPulseRepetitionInterval
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) < 238209682)]
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("ModelX_0"))
  return
    $GRAPH_11
return
