...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_Jammer_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Jammer_0 in $node_Object_0/RFDevice:isProducerOf
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    where fn:exists($node_Gain_0) and fn:exists($node_Object_0) and $node_Gain_0/RFDevice:hasWidth/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
