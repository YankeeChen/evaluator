...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_Var0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasFrequencyRange/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#RadioFrequencyBand_instance53"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
