...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_RadarSystem_0 := fn:data($node_RadarSystem_0/@rdf:about)
    for $node_Var0 in $node_RadarSystem_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPN300"]
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Var0 in $node_Var1/Nuvio:aggregateOf
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Var1 in $node_Var2/RFDevice:hasWeight
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var1 in $node_Var3/RFDevice:hasHeight
    let $value_Var1 := fn:data($node_Var1/@rdf:resource)
  ...
  let $GRAPH_7 :=  
    for $node_Var1 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Data_14bit"]/RFDevice:hasResolution
    let $value_Var1 := fn:data($node_Var1/@rdf:resource)
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_4,$GRAPH_9,("Var1"))
