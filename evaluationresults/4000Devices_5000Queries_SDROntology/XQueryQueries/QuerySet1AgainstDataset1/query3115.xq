...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#PolygonPatch"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_9,$GRAPH_10,("InformationContent_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_8,$GRAPH_11,("InformationRepresentation_0"))
