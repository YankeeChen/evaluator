...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN310_0 in $node_XilinxZynq7100SoC_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_XilinxZynq7100SoC_0 in $doc_ObjectDescription[RFDevice:hasProducer/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Producer_instance817"]
    let $value_XilinxZynq7100SoC_0 := fn:data($node_XilinxZynq7100SoC_0/@rdf:about)
    where fn:exists($node_XilinxZynq7100SoC_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("XilinxZynq7100SoC_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("XilinxZynq7100SoC_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_0,$GRAPH_5,("USRPN310_0"))
  return
    $GRAPH_6
return
