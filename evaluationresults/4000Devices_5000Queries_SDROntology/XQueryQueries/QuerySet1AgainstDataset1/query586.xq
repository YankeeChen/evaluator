...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Distance_0) and fn:exists($node_Var0) and $node_Distance_0/RFDevice:hasVoltage/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("Distance_0"))
