...
let $result :=  
  ...
  let $GRAPH_9 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_ContinuousWaveRadar_0 in $node_Entity_0/Nuvio:isExpressedBy
  ...
  let $GRAPH_11 :=  
    for $node_ContinuousWaveRadar_0 in $doc_ObjectDescription[RFDevice:isDeployedOn/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Satellite_instance43"]
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:about)
    where fn:exists($node_ContinuousWaveRadar_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_10,$GRAPH_11,("ContinuousWaveRadar_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_9,$GRAPH_12,("ContinuousWaveRadar_0"))
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_0,$GRAPH_18,("Full_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_19
return
