...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_Entity_0/RFDevice:hasWidth
  ...
  let $GRAPH_5 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_USRPE312_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_CommunicationsJamming_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($node_CommunicationsJamming_0) and fn:exists($value_Entity_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_7 :=  
    for $node_CommunicationsJamming_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Power_instance82"]/RFDevice:hasPulseWidth
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("CommunicationsJamming_0"))
