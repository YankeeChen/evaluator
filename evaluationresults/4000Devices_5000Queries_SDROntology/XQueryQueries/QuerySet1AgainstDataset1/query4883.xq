...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Full_DuplexCommunicationsSystem_0 in $node_Weight_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_8 := $GRAPH_7[not((data(xqllib:var[@name="DataValue0"]) > xs:double("0.0")))]
  let $GRAPH_9 := xqllib:and($GRAPH_6,$GRAPH_8,("Var0"))
  let $GRAPH_10 := xqllib:and($GRAPH_3,$GRAPH_9,("Var0"))
  let $GRAPH_11 := xqllib:optional($GRAPH_2,$GRAPH_10,("Weight_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_1,$GRAPH_11,("Weight_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("Full_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_13
return
