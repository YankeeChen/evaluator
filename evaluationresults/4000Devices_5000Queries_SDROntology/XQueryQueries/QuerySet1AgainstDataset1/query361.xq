...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_BarrageJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    for $node_BarrageJamming_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Power_instance49"]/RFDevice:hasEffectiveRadiatedPower
