...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) = -9.1)]
  let $GRAPH_6 :=  
  ...
  let $GRAPH_15 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_InformationContent_0 in $node_Var0/Nuvio:represents
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_14,$GRAPH_15,("InformationContent_0","Var0"))
