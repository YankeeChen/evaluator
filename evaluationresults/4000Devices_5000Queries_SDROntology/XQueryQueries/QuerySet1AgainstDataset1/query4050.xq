...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX3xx_0 in $node_Object_0/RFDevice:isProducerOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Object_0 in $node_EmitterLocationDetection_0/RFDevice:supportsTuning
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_0,$GRAPH_5,("USRPX3xx_0"))
  return
    $GRAPH_6
return
