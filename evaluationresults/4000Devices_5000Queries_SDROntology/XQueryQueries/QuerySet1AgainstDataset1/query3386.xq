...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_210_0 in $node_Var0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Var0 in $node_Var1/RFDevice:hasMaxPowerConsumption
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_0,$GRAPH_6,("USRPB200_210_0"))
  return
    $GRAPH_7
return
