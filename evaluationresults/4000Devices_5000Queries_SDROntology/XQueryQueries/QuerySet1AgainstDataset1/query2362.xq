...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN3xx_0 := fn:data($node_USRPN3xx_0/@rdf:about)
    for $node_Var0 in $node_USRPN3xx_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance5669"]/Nuvio:subprocessOf
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
