...
let $result :=  
  ...
  let $GRAPH_9 :=  
    for $node_Object_0 in $doc_ObjectDescription[RFDevice:hasPolarization/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#AntennaPolarization_instance40"]
