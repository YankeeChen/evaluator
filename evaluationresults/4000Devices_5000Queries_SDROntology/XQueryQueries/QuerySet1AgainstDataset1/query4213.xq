...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX3xx_0 := fn:data($node_USRPX3xx_0/@rdf:about)
    for $node_Var0 in $node_USRPX3xx_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_3 :=  
    ...
    for $node_LineStringSegment_0 in $node_Var0/RFDevice:hasTarget
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("LineStringSegment_0"))
