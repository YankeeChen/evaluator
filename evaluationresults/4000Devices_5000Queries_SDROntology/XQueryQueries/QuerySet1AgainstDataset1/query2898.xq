...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_CommunicationsJamming_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_6 :=  
    for $node_CommunicationsJamming_0 in $doc_ObjectDescription
    let $value_CommunicationsJamming_0 := fn:data($node_CommunicationsJamming_0/@rdf:about)
    for $node_Entity_0 in $node_CommunicationsJamming_0/RFDevice:hasPulseRepetitionFrequency
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($node_CommunicationsJamming_0) and fn:exists($value_Entity_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("CommunicationsJamming_0"))
  let $GRAPH_8 := xqllib:optional($GRAPH_4,$GRAPH_7,("CommunicationsJamming_0","Entity_0"))
  let $GRAPH_9 :=  
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_0,$GRAPH_16,("SDR_0"))
  return
    $GRAPH_17
return
