...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN300_0 in $node_Entity_0/RFDevice:isProducerOf
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Object_0 in $node_AngleModulation_0/Nuvio:participatesIn
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($node_AngleModulation_0) and fn:exists($value_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("AngleModulation_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,())
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("Entity_0","Object_0"))
