...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicSupportSystem_0 in $node_EmitterIdentification_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    for $node_EmitterIdentification_0 in $doc_ObjectDescription
    let $value_EmitterIdentification_0 := fn:data($node_EmitterIdentification_0/@rdf:about)
    for $node_Var0 in $node_EmitterIdentification_0/Nuvio:participatesIn
