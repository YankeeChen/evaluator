...
let $result :=  
  ...
  let $GRAPH_15 := $GRAPH_14[(data(xqllib:var[@name="DataValue0"]) >= xs:decimal("0"))]
  let $GRAPH_17 :=  
  ...
  let $GRAPH_19 := $GRAPH_18[(data(xqllib:var[@name="DataValue1"]) != 1242729940)]
  ...
  let $GRAPH_23 := xqllib:and($GRAPH_12,$GRAPH_22,("Entity_0"))
  let $GRAPH_24 :=  
  ...
  let $GRAPH_27 := xqllib:and($GRAPH_23,$GRAPH_26,("Entity_0"))
  let $GRAPH_28 := xqllib:and($GRAPH_11,$GRAPH_27,("Entity_0"))
  let $GRAPH_29 := xqllib:and($GRAPH_1,$GRAPH_28,("Entity_0"))
  let $GRAPH_30 := xqllib:and($GRAPH_0,$GRAPH_29,("USRPB210_0"))
  return
    $GRAPH_30
return
