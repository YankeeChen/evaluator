...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_MonostaticRadar_0 in $node_Process_0/RFDevice:supportsJamming
  ...
  let $GRAPH_2 :=  
    for $node_Process_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and RFDevice:hasPulseRepetitionFrequency/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance4789"]
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
