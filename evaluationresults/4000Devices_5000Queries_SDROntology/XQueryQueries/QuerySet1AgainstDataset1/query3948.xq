...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_MonostaticRadar_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) > 68927010)]
  let $GRAPH_6 := xqllib:and($GRAPH_3,$GRAPH_5,("Value_0"))
  let $GRAPH_7 := xqllib:optional($GRAPH_2,$GRAPH_6,("Value_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_1,$GRAPH_7,("Entity_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("MonostaticRadar_0"))
  return
    $GRAPH_9
return
