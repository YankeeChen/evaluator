...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200mini_i_0 := fn:data($node_USRPB200mini_i_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB200mini_i_0/Nuvio:aggregateOf
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($value_Entity_0) and fn:exists($node_USRPB200mini_i_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPN3xx"]
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_QuantityRange_0 in $node_Entity_0/RFDevice:hasBandwidthRange
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("QuantityRange_0"))
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_0,$GRAPH_13,("USRPB200mini_i_0"))
  return
    $GRAPH_14
return
