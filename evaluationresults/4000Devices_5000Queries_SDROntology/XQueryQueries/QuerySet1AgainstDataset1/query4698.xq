...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Entity_0 in $node_CrossEyeJamming_0/Nuvio:subprocessOf
  ...
  let $GRAPH_7 :=  
    ...
    for $node_CrossEyeJamming_0 in $node_Attribute_0/RFDevice:hasEffectiveRadiatedPower
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_6,$GRAPH_9,("CrossEyeJamming_0"))
  let $GRAPH_11 := xqllib:optional($GRAPH_5,$GRAPH_10,("CrossEyeJamming_0"))
