...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ModelX_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and Nuvio:hasProcessQuantity/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance365"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
