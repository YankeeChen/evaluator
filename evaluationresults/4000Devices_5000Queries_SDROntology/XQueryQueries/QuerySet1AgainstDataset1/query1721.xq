...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[Nuvio:hasObjectQuality/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#AntennaPolarization_instance9"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_0,$GRAPH_3,("USRPN210_0"))
  return
    $GRAPH_4
return
