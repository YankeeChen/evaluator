...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN300_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_USRPN2xx_0 in $node_Var0/Nuvio:relevantIndividual
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("USRPN2xx_0"))
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("InformationEntity_0","Var0"))
