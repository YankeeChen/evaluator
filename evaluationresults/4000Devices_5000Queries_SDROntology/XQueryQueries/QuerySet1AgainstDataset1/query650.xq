...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_Transmitter_0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    for $node_Transmitter_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#RadarBand_X"]/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_1,$GRAPH_5,("Transmitter_0"))
