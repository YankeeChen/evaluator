...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RFSystem_0 in $node_Receiver_0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    for $node_Receiver_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#RadioFrequencyBand_instance227"]/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_0,$GRAPH_6,("RFSystem_0"))
  return
    $GRAPH_7
return
