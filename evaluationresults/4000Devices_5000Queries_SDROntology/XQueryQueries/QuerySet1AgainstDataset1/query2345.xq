...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200mini_0 in $node_Spartan6FPGA_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Spartan6FPGA_0 in $node_Var0/RFDevice:isProducerOf
  ...
  let $GRAPH_3 := xqllib:and($GRAPH_1,$GRAPH_2,("Spartan6FPGA_0"))
