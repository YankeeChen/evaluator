...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE3xx_0 := fn:data($node_USRPE3xx_0/@rdf:about)
    for $node_Entity_0 in $node_USRPE3xx_0/RFDevice:hasProducer
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) <= 1362482430)]
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Process_0 in $node_Gain_0/RFDevice:hasEffectiveRadiatedPower
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_11,$GRAPH_14,("Gain_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_10,$GRAPH_15,("Gain_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_9,$GRAPH_16,())
  let $GRAPH_18 := xqllib:and($GRAPH_2,$GRAPH_17,("Entity_0","Process_0"))
