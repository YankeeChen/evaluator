...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE312_0 in $node_Entity_0/RFDevice:hasProducer
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) >= 1500518022)]
  let $GRAPH_8 := xqllib:and($GRAPH_5,$GRAPH_7,("LatitudeValueInDegree_0"))
