...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_XilinxZynq7100SoC_0/Nuvio:compositeOf
  ...
  let $GRAPH_3 :=  
    for $node_XilinxZynq7100SoC_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#CortexA9_instance10"]/Nuvio:aggregateOf
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_0,$GRAPH_5,("USRPN3xx_0"))
  return
    $GRAPH_6
return
