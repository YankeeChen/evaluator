...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseDopplerRadarModulation_0 in $node_Attribute_0/RFDevice:hasTransmitPowerRange
