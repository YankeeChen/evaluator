...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Jammer_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#RadioFrequencyBand_instance21"]/RFDevice:hasFrequencyRange
