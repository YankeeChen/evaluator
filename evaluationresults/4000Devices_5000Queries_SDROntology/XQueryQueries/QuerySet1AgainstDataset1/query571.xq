...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Attribute_0 in $node_Var0/Nuvio:expresses
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Angle_0) and fn:exists($node_Var0) and $node_Angle_0/RFDevice:hasPulseRepetitionInterval/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("Attribute_0","Var0"))
  let $GRAPH_15 :=  
