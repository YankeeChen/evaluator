...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#XC6SLX75FPGA"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
  ...
  let $GRAPH_5 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Xilinx"]/RFDevice:isProducerOf
  ...
  let $GRAPH_10 :=  
    ...
    for $node_InformationEntity_0 in $node_InformationContent_0/Nuvio:represents
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_10,$GRAPH_13,("InformationEntity_0"))
