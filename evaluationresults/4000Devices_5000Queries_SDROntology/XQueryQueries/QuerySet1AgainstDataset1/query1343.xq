...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200_210_0 := fn:data($node_USRPB200_210_0/@rdf:about)
    for $node_Weight_0 in $node_USRPB200_210_0/RFDevice:hasVoltage
  ...
  let $GRAPH_9 := $GRAPH_8[not((data(xqllib:var[@name="DataValue0"]) >= xs:decimal("0")))]
  ...
  let $GRAPH_21 := xqllib:optional($GRAPH_0,$GRAPH_20,("USRPB200_210_0"))
  return
    $GRAPH_21
return
