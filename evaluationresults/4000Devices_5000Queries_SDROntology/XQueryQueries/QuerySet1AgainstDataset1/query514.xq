...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CommunicationsSystem_0 in $node_Entity_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#ContinuousWaveRadarModulation_instance21"]/RFDevice:supportsJamming
  ...
  let $GRAPH_11 := $GRAPH_10[(data(xqllib:var[@name="DataValue0"]) < -938183637)]
