...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_RadioComponent_0/Nuvio:compositeOf
    let $value_USRPX310_0 := fn:data($node_USRPX310_0/@rdf:resource)
    where fn:exists($node_RadioComponent_0) and fn:exists($value_USRPX310_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_11 :=  
    for $node_RadioComponent_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Producer_instance502"]/RFDevice:hasProducer
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_10,$GRAPH_11,("RadioComponent_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_2,$GRAPH_12,("RadioComponent_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_1,$GRAPH_13,("RadioComponent_0"))
