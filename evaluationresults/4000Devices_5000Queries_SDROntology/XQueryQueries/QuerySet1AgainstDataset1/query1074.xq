...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) >= -1997230352)]
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Object_0 in $node_DataSize_0/RFDevice:hasVoltage
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_2,$GRAPH_8,("Entity_0","Object_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("Entity_0"))
  let $GRAPH_11 := xqllib:optional($GRAPH_0,$GRAPH_10,("RadarWarningReceiver_0"))
  return
    $GRAPH_11
return
