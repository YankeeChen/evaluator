...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_InformationContent_0) and fn:exists($node_Var1) and $node_InformationContent_0/Nuvio:expresses/@rdf:resource = $value_Var1
    return
      <xqllib:result>
  ...
  let $GRAPH_4 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#ContinuousWaveRadarModulation"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_8 :=  
    ...
    where fn:exists($node_InformationEntity_0) and fn:exists($node_Var2) and $node_Var2/Nuvio:informationSource/@rdf:resource = $value_InformationEntity_0
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
  ...
  let $GRAPH_10 :=  
    for $node_Var2 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object"]
    let $value_Var2 := fn:data($node_Var2/@rdf:about)
    where fn:exists($node_Var2)
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("Var2"))
  let $GRAPH_12 := xqllib:and($GRAPH_8,$GRAPH_11,("Var2"))
  let $GRAPH_13 := xqllib:and($GRAPH_7,$GRAPH_12,("InformationEntity_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_6,$GRAPH_13,())
  let $GRAPH_15 := xqllib:and($GRAPH_3,$GRAPH_14,("InformationContent_0","Var1"))
  let $GRAPH_16 :=  
    for $node_Var1 in $doc_ObjectDescription
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_18 :=  
    ...
    let $value_Var3 := fn:data($node_Var3/@rdf:about)
    for $node_DataValue0 in $node_Var3/Nuvio:hasDataValue
    let $value_DataValue0 := fn:data($node_DataValue0)
    where fn:exists($value_DataValue0) and fn:exists($node_Var3)
    return
      <xqllib:result>
        <xqllib:var name="DataValue0">{$value_DataValue0}</xqllib:var>
        <xqllib:var name="Var3">{$value_Var3}</xqllib:var>
      </xqllib:result>
  let $GRAPH_19 := $GRAPH_18[(data(xqllib:var[@name="DataValue0"]) <= -29.28)]
  let $GRAPH_20 := xqllib:and($GRAPH_17,$GRAPH_19,("Var3"))
  let $GRAPH_21 := xqllib:and($GRAPH_16,$GRAPH_20,("Var3"))
  let $GRAPH_22 := xqllib:and($GRAPH_15,$GRAPH_21,("Var1"))
  let $GRAPH_23 := xqllib:and($GRAPH_2,$GRAPH_22,("Var1"))
  let $GRAPH_24 :=  
  ...
  let $GRAPH_27 := xqllib:and($GRAPH_0,$GRAPH_26,("USRPB200mini_i_0"))
  return
    $GRAPH_27
return
