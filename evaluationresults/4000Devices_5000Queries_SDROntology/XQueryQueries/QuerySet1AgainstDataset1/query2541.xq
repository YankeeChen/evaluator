...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE3xx_0 in $node_XilinxZynq7020SoC_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_XilinxZynq7020SoC_0 in $doc_ObjectDescription[Nuvio:aggregateOf/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance1330"]
    let $value_XilinxZynq7020SoC_0 := fn:data($node_XilinxZynq7020SoC_0/@rdf:about)
    where fn:exists($node_XilinxZynq7020SoC_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("XilinxZynq7020SoC_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("XilinxZynq7020SoC_0"))
