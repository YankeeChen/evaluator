...
let $result :=  
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_4,$GRAPH_5,("Curve_0"))
  let $GRAPH_7 :=  
  ...
  let $GRAPH_9 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Var0) and $doc_ObjectDescription[@rdf:ID = "InformationUnit_instance0"]/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Var0
    return
      <xqllib:result>
        <xqllib:var name="Var0">{$value_Var0}</xqllib:var>
      </xqllib:result>
