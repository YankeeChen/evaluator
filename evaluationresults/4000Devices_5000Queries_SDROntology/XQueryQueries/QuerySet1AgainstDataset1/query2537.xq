...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_Entity_0/RFDevice:hasCapacity
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_Object_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Object_0 in $node_OnOffKeyingModulation_0/RFDevice:hasCapability
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($value_Object_0) and fn:exists($node_OnOffKeyingModulation_0)
    return
      <xqllib:result>
        <xqllib:var name="Object_0">{$value_Object_0}</xqllib:var>
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("OnOffKeyingModulation_0"))
  ...
  let $GRAPH_14 := xqllib:optional($GRAPH_0,$GRAPH_13,("PulseDopplerRadar_0"))
  return
    $GRAPH_14
return
