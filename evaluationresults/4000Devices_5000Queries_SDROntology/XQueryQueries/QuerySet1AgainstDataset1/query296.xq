...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_InformationContent_0/Nuvio:expresses
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) <= 684206206)]
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_0,$GRAPH_8,("USRPX3xx_0"))
  return
    $GRAPH_9
return
