...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) > -623957395)]
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("InformationEntity_0"))
  ...
  let $GRAPH_18 := xqllib:optional($GRAPH_0,$GRAPH_17,("CR_0"))
  return
    $GRAPH_18
return
