...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_RadarJammer_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#RangeGatePullOffJamming_instance1"]/RFDevice:supportsTransmitting
