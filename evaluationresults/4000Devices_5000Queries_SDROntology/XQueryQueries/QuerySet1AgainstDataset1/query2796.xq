...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_DeceptiveCommunicationsJamming_0 in $node_Entity_0/Nuvio:hasSubprocess
  ...
  let $GRAPH_9 :=  
    ...
    for $node_DeceptiveCommunicationsJamming_0 in $node_Quantity_0/RFDevice:hasEffectiveRadiatedPower
    let $value_DeceptiveCommunicationsJamming_0 := fn:data($node_DeceptiveCommunicationsJamming_0/@rdf:resource)
    where fn:exists($value_DeceptiveCommunicationsJamming_0) and fn:exists($node_Quantity_0)
    return
      <xqllib:result>
        <xqllib:var name="DeceptiveCommunicationsJamming_0">{$value_DeceptiveCommunicationsJamming_0}</xqllib:var>
        <xqllib:var name="Quantity_0">{$value_Quantity_0}</xqllib:var>
      </xqllib:result>
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("DeceptiveCommunicationsJamming_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_7,$GRAPH_10,("DeceptiveCommunicationsJamming_0"))
  ...
  let $GRAPH_18 := xqllib:and($GRAPH_0,$GRAPH_17,("RadarSystem_0"))
  return
    $GRAPH_18
return
