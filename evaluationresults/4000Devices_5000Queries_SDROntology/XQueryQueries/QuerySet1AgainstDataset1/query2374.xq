...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Satellite_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_CommunicationsSystem_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_6,$GRAPH_9,("Var0"))
  let $GRAPH_11 :=  
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_4,$GRAPH_15,("CommunicationsSystem_0","Entity_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_3,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_2,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_1,$GRAPH_18,("Satellite_0"))
