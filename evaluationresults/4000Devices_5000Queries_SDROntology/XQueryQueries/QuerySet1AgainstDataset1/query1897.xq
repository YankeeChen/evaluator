...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_Full_DuplexCommunicationsSystem_0 := fn:data($node_Full_DuplexCommunicationsSystem_0/@rdf:about)
    for $node_Object_0 in $node_Full_DuplexCommunicationsSystem_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Weight_instance339"]/RFDevice:hasGain
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
