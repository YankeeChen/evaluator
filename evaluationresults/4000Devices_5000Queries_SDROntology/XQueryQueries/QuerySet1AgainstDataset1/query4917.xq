...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN300_0 in $node_Entity_0/Nuvio:partOf
  ...
  let $GRAPH_3 := $GRAPH_2[not((data(xqllib:var[@name="DataValue0"]) >= -1.57))]
  let $GRAPH_4 := xqllib:and($GRAPH_1,$GRAPH_3,("Entity_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_0,$GRAPH_4,("USRPN300_0"))
  return
    $GRAPH_5
return
