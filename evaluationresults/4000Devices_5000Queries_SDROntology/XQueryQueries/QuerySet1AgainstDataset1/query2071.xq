...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_Situation_0/Nuvio:expresses
  ...
  let $GRAPH_4 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#AbstractSurfacePatch"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
