...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ElectronicAttackSystem_0 := fn:data($node_ElectronicAttackSystem_0/@rdf:about)
    for $node_Var0 in $node_ElectronicAttackSystem_0/RFDevice:supportsJamming
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_Var0) and $node_Entity_0/Nuvio:expresses/@rdf:resource = $value_Var0
    return
      <xqllib:result>
