...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Process_0 in $doc_ObjectDescription
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
    for $node_ModelX_0 in $node_Process_0/Nuvio:participatesIn
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("ModelX_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("ModelX_0"))
