...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB2xx_0 in $node_Entity_0/RFDevice:hasChargingTime
  ...
  let $GRAPH_4 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Hz_per_s"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) != 2061392190)]
  let $GRAPH_10 := xqllib:and($GRAPH_7,$GRAPH_9,())
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("Entity_0","Value_0"))
