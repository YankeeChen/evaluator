...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Var0 in $node_Angle_0/RFDevice:hasWidth
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
    where fn:exists($node_Angle_0) and fn:exists($value_Var0)
    return
      <xqllib:result>
  ...
  let $GRAPH_9 :=  
    for $node_Angle_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#LongitudeValueInRadian_instance0"]/Nuvio:hasValue
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("Angle_0"))
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_15,$GRAPH_16,("Process_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_1,$GRAPH_17,("Var0"))
  let $GRAPH_19 := xqllib:and($GRAPH_0,$GRAPH_18,("USRPN2xx_0"))
  return
    $GRAPH_19
return
