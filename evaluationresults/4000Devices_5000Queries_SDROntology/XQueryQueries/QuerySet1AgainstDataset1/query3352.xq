...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SDR_0 in $node_Entity_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_USRPN310_0 in $node_Entity_0/Nuvio:expresses
  ...
  let $GRAPH_5 :=  
    ...
    for $node_USRPN310_0 in $node_Var0/RFDevice:hasMaxPowerConsumption
    let $value_USRPN310_0 := fn:data($node_USRPN310_0/@rdf:resource)
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("USRPN310_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("USRPN310_0"))
  let $GRAPH_8 :=  
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) < -657488417)]
