...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB2xxmini_0 := fn:data($node_USRPB2xxmini_0/@rdf:about)
    for $node_Var0 in $node_USRPB2xxmini_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Freq_61_44MHz"]/RFDevice:hasChargingTime
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
