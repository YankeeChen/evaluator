...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN300_0 in $node_Var0/Nuvio:compositeOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Var1/RFDevice:hasCapacity
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_0,$GRAPH_5,("USRPN300_0"))
  return
    $GRAPH_6
return
