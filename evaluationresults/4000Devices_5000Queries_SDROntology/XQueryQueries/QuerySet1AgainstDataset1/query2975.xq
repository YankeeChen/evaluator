...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_RadarWarningReceiver_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("RadarWarningReceiver_0"))
  let $GRAPH_7 :=  
  ...
  let $GRAPH_10 :=  
    for $node_Value_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#WeightUnit_instance5"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("Value_0"))
