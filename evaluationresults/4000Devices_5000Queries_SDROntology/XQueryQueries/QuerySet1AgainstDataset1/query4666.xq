...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Transceiving_0 := fn:data($node_Transceiving_0/@rdf:about)
    where fn:exists($node_CyclostationaryDetection_0) and fn:exists($node_Transceiving_0) and $node_CyclostationaryDetection_0/Nuvio:subprocessOf/@rdf:resource = $value_Transceiving_0
    return
      <xqllib:result>
