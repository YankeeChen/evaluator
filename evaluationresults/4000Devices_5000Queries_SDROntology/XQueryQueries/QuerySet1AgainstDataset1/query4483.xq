...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_GainRange_0) and $node_GainRange_0/RFDevice:hasTarget/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("GainRange_0"))
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("ContinuousWaveRadar_0"))
  return
    $GRAPH_10
return
