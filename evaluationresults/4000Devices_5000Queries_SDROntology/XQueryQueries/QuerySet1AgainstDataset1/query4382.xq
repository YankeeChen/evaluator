...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Full_DuplexCommunicationsSystem_0 in $node_Transceiving_0/RFDevice:supportsJamming
  ...
  let $GRAPH_4 :=  
    for $node_Transceiving_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Power_instance93"]/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("Transceiving_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("Transceiving_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_1,$GRAPH_6,("Transceiving_0"))
