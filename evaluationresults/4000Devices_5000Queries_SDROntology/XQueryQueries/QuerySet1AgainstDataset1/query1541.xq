...
let $result :=  
  ...
  let $GRAPH_10 :=  
    ...
    for $node_FreqencyRange_0 in $node_Entity_0/RFDevice:hasMax
  ...
  let $GRAPH_17 := $GRAPH_16[(data(xqllib:var[@name="DataValue0"]) > -86.55)]
  let $GRAPH_18 := xqllib:and($GRAPH_15,$GRAPH_17,("Var1"))
  let $GRAPH_19 := xqllib:and($GRAPH_14,$GRAPH_18,("Power_0"))
  ...
  let $GRAPH_23 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ElectronicSupportSystem_0) and fn:exists($node_Entity_0) and $node_ElectronicSupportSystem_0/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_25 :=  
    for $node_ElectronicSupportSystem_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Producer_instance19"]/RFDevice:isProducerOf
  ...
  let $GRAPH_26 := xqllib:and($GRAPH_24,$GRAPH_25,("ElectronicSupportSystem_0"))
  let $GRAPH_27 := xqllib:and($GRAPH_23,$GRAPH_26,("ElectronicSupportSystem_0"))
  let $GRAPH_28 := ($GRAPH_22,$GRAPH_27)
  let $GRAPH_29 := xqllib:and($GRAPH_20,$GRAPH_28,("Entity_0"))
  let $GRAPH_30 := xqllib:and($GRAPH_11,$GRAPH_29,("Entity_0"))
  let $GRAPH_31 := xqllib:and($GRAPH_10,$GRAPH_30,("Entity_0"))
  let $GRAPH_32 := xqllib:optional($GRAPH_9,$GRAPH_31,("FreqencyRange_0"))
  let $GRAPH_33 := xqllib:and($GRAPH_8,$GRAPH_32,("FreqencyRange_0"))
  let $GRAPH_34 := ($GRAPH_7,$GRAPH_33)
  let $GRAPH_35 := ($GRAPH_5,$GRAPH_34)
  let $GRAPH_36 := ($GRAPH_3,$GRAPH_35)
  let $GRAPH_37 := xqllib:and($GRAPH_1,$GRAPH_36,("Var0"))
  let $GRAPH_38 := xqllib:and($GRAPH_0,$GRAPH_37,("PulseDopplerRadar_0"))
  return
    $GRAPH_38
return
