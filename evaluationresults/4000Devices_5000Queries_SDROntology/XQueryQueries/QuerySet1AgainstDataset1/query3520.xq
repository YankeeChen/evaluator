...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SDR_0 in $node_Jammer_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_Jammer_0 in $doc_ObjectDescription[RFDevice:hasCapability/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription4000.owl#Instance4092"]
    let $value_Jammer_0 := fn:data($node_Jammer_0/@rdf:about)
