...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) < 57.93)]
  ...
  let $GRAPH_11 :=  
    ...
    for $node_Entity_0 in $node_Processor_0/Nuvio:isExpressedBy
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_6,$GRAPH_12,("Entity_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_2,$GRAPH_13,("Entity_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("Entity_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("USRPN3xx_0"))
  return
    $GRAPH_16
return
