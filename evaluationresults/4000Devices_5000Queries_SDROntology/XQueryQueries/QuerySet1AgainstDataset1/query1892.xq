...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
    where fn:exists($node_DigitalModulation_0) and fn:exists($node_Process_0) and $node_DigitalModulation_0/Nuvio:subprocessOf/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_6,$GRAPH_7,("DigitalModulation_0"))
