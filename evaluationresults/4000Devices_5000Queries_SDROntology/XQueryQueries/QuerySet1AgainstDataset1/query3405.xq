...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Processor_0) and fn:exists($node_Var0) and $node_Processor_0/RFDevice:hasTarget/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("Processor_0"))
