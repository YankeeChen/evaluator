...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Var0) and $doc_ObjectDescription[@rdf:ID = "Instance5356"]/Nuvio:subprocessOf/@rdf:resource = $value_Var0
    return
      <xqllib:result>
        <xqllib:var name="Var0">{$value_Var0}</xqllib:var>
      </xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("USRPB200mini_i_0"))
  return
    $GRAPH_11
return
