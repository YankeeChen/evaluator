...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_Entity_0/Nuvio:compositeOf
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) < xs:double("-3.702797"))]
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_2,$GRAPH_10,("Entity_0","InformationContent_0"))
