...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN2xx_0 := fn:data($node_USRPN2xx_0/@rdf:about)
    for $node_Entity_0 in $node_USRPN2xx_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#ArcByBulge"]
