...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN310_0 := fn:data($node_USRPN310_0/@rdf:about)
    for $node_XilinxZynq7100SoC_0 in $node_USRPN310_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_XilinxZynq7100SoC_0 in $node_Producer_0/RFDevice:isProducerOf
    let $value_XilinxZynq7100SoC_0 := fn:data($node_XilinxZynq7100SoC_0/@rdf:resource)
    where fn:exists($node_Producer_0) and fn:exists($value_XilinxZynq7100SoC_0)
    return
      <xqllib:result>
