...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Process_0 in $node_Var0/Nuvio:isExpressedBy
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Var0 in $node_Ratio_0/Nuvio:relevantIndividual
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("ElectronicAttackSystem_0"))
  return
    $GRAPH_10
return
