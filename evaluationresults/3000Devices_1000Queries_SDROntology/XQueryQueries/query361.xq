...
let $result :=  
  ...
  let $GRAPH_6 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Var0 in $node_Entity_0/Nuvio:participatesIn
  ...
  let $GRAPH_7 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Instance1476"]/RFDevice:supportsTuning
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("ElectronicSupportSystem_0"))
  return
    $GRAPH_17
return
