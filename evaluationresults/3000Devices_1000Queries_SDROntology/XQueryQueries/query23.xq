...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_CommunicationsSystem_0 := fn:data($node_CommunicationsSystem_0/@rdf:about)
    for $node_Transmitting_0 in $node_CommunicationsSystem_0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Transmitting_0 in $node_Entity_0/RFDevice:hasMaxOutputPower
    let $value_Transmitting_0 := fn:data($node_Transmitting_0/@rdf:resource)
  ...
  let $GRAPH_7 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_UnitOfMeasure_0 in $node_Entity_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) < 110780861)]
  let $GRAPH_11 := ($GRAPH_8,$GRAPH_10)
  let $GRAPH_12 := xqllib:optional($GRAPH_4,$GRAPH_11,("Entity_0","Value_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_3,$GRAPH_12,("Entity_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_2,$GRAPH_13,("Transmitting_0"))
