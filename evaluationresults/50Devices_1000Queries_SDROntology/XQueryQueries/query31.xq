...
let $result :=  
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("MannedPlatform_0"))
  let $GRAPH_5 :=  
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_CompositeCurve_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("CompositeCurve_0"))
