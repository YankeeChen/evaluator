...
let $result :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) <= -1741085027)]
  ...
  let $GRAPH_13 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription50.owl#Power_instance2"]/RFDevice:hasPulseRepetitionFrequency
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_19 := xqllib:and($GRAPH_0,$GRAPH_18,("SurveillanceRadar_0"))
  return
    $GRAPH_19
return
