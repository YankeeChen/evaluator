...
let $result :=  
  ...
  let $GRAPH_6 :=  
    for $node_Jamming_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Power_instance14"]/RFDevice:hasMaxOutputPower
    let $value_Jamming_0 := fn:data($node_Jamming_0/@rdf:resource)
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_3,$GRAPH_7,("Jamming_0"))
  let $GRAPH_9 :=  
