...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_PulseDopplerRadar_0 := fn:data($node_PulseDopplerRadar_0/@rdf:about)
    for $node_Object_0 in $node_PulseDopplerRadar_0/RFDevice:isProducerOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_CommunicationsJamming_0 in $node_Object_0/Nuvio:hasParticipant
    let $value_CommunicationsJamming_0 := fn:data($node_CommunicationsJamming_0/@rdf:resource)
    where fn:exists($value_CommunicationsJamming_0) and fn:exists($node_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_CommunicationsJamming_0 in $node_Attribute_0/RFDevice:hasTransmitPowerRange
    let $value_CommunicationsJamming_0 := fn:data($node_CommunicationsJamming_0/@rdf:resource)
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("CommunicationsJamming_0"))
