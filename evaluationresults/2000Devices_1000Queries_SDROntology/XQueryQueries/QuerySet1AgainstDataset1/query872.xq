...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_RFSystem_0 := fn:data($node_RFSystem_0/@rdf:about)
    for $node_Object_0 in $node_RFSystem_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_CoverPulsesJamming_0 in $node_Object_0/RFDevice:supportsTransmitting
    let $value_CoverPulsesJamming_0 := fn:data($node_CoverPulsesJamming_0/@rdf:resource)
    where fn:exists($value_CoverPulsesJamming_0) and fn:exists($node_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_4 :=  
    ...
    for $node_CoverPulsesJamming_0 in $node_Power_0/RFDevice:hasPulseWidth
    let $value_CoverPulsesJamming_0 := fn:data($node_CoverPulsesJamming_0/@rdf:resource)
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("CoverPulsesJamming_0"))
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("CoverPulsesJamming_0"))
