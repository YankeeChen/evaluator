...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB210_0 in $node_Entity_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_Entity_1/Nuvio:isExpressedBy
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Entity_0 in $node_PulseDopplerRadarModulation_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("PulseDopplerRadarModulation_0"))
  let $GRAPH_8 :=  
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_0,$GRAPH_12,("USRPB210_0"))
  return
    $GRAPH_13
return
