...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_MonostaticRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsJamming
  ...
  let $GRAPH_2 :=  
    ...
    for $node_PulseDopplerRadarModulation_0 in $node_Quantity_0/RFDevice:hasPulseRepetitionInterval
