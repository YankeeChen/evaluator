...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
    where fn:exists($node_AutomaticGainControl_0) and fn:exists($node_Process_0) and $node_AutomaticGainControl_0/Nuvio:hasSubprocess/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
