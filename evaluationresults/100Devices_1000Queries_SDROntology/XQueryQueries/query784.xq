...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:about)
    for $node_DirectConversionReceiver_0 in $node_ContinuousWaveRadar_0/Nuvio:aggregateOf
  ...
  let $GRAPH_5 :=  
    for $node_QuantityRange_0 in $doc_ObjectDescription
    let $value_QuantityRange_0 := fn:data($node_QuantityRange_0/@rdf:about)
    for $node_NoiseFigure_0 in $node_QuantityRange_0/RFDevice:hasMax
    let $value_NoiseFigure_0 := fn:data($node_NoiseFigure_0/@rdf:resource)
    where fn:exists($value_NoiseFigure_0) and fn:exists($node_QuantityRange_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("ContinuousWaveRadar_0"))
  return
    $GRAPH_12
return
