...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_Object_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    where fn:exists($node_DeceptiveJamming_0) and fn:exists($node_Object_0) and $node_DeceptiveJamming_0/Nuvio:participatesIn/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_5 :=  
    ...
    for $node_DeceptiveJamming_0 in $node_Power_0/RFDevice:hasPulseRepetitionFrequency
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_2,$GRAPH_8,("DeceptiveJamming_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("Object_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("USRPX310_0"))
  return
    $GRAPH_11
return
