...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    where fn:exists($node_Object_0) and fn:exists($node_Transceiving_0) and $node_Transceiving_0/Nuvio:hasParticipant/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
        <xqllib:var name="Object_0">{$value_Object_0}</xqllib:var>
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_0,$GRAPH_6,("ElectronicSupportSystem_0"))
  return
    $GRAPH_7
return
