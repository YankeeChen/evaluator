...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_Var2/RFDevice:supportsTuning
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) > 962353296)]
  ...
  let $GRAPH_23 := xqllib:and($GRAPH_0,$GRAPH_22,("USRPN300_0"))
  return
    $GRAPH_23
return
