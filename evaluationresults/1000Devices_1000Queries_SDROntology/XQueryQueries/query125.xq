...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    where fn:exists($node_AngleUnit_0) and fn:exists($node_Value_0) and $node_AngleUnit_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Value_0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) = -231191909)]
  let $GRAPH_11 :=  
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_8,$GRAPH_12,("AngleUnit_0","Value_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_7,$GRAPH_13,())
  let $GRAPH_15 := xqllib:and($GRAPH_2,$GRAPH_14,("Entity_0","Value_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_1,$GRAPH_15,("Entity_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_0,$GRAPH_16,("BistaticRadar_0"))
  return
    $GRAPH_17
return
