...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_GNURadio_0 := fn:data($node_GNURadio_0/@rdf:about)
    for $node_Object_0 in $node_GNURadio_0/RFDevice:hasProducer
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Object_0 in $node_AnalogModulation_0/Nuvio:hasParticipant
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_0,$GRAPH_6,("GNURadio_0"))
  return
    $GRAPH_7
return
