...
let $result :=  
  ...
  let $GRAPH_9 :=  
    for $node_Var2 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#NonNegativeDecimalValue"]
    let $value_Var2 := fn:data($node_Var2/@rdf:about)
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_0,$GRAPH_15,("USRPB200_0"))
  return
    $GRAPH_16
return
