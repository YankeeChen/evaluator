...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_CumulativeDetection_0) and fn:exists($node_Object_0) and $node_CumulativeDetection_0/Nuvio:hasParticipant/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
