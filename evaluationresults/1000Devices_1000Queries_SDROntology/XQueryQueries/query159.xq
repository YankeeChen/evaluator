...
let $result :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) = -21.88)]
  ...
  let $GRAPH_13 := $GRAPH_12[(data(xqllib:var[@name="DataValue1"]) = 1895693771)]
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_14,$GRAPH_15,("SpatialAreaUnit_0"))
  ...
  let $GRAPH_20 := xqllib:and($GRAPH_0,$GRAPH_19,("MonostaticRadar_0"))
  return
    $GRAPH_20
return
