...
let $result :=  
  ...
  let $GRAPH_14 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#AntennaPolarization_instance19"]/Nuvio:hasProcessQuality
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_16 := ($GRAPH_11,$GRAPH_15)
