...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPB200mini_i_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#XC6SLX150FPGA_instance14"]/Nuvio:compositeOf
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("USRPB200mini_i_0"))
  return
    $GRAPH_2
return
