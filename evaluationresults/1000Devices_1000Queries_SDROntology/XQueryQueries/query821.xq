...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_CR_0 := fn:data($node_CR_0/@rdf:about)
    for $node_Entity_0 in $node_CR_0/RFDevice:hasWeight
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Object_0/Nuvio:compositeOf
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_2,$GRAPH_15,("Entity_0","Process_0"))
