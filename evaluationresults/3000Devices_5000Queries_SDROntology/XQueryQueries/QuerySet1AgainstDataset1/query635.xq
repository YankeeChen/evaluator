...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN3xx_0 := fn:data($node_USRPN3xx_0/@rdf:about)
    for $node_Var0 in $node_USRPN3xx_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Freq_122_88MHz"]/RFDevice:hasHeight
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var1 in $node_Var0/RFDevice:hasLevel
