...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RadarWarningReceiver_0 in $node_Object_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and Nuvio:hasObjectQuality/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#AntennaPolarization_instance17"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
