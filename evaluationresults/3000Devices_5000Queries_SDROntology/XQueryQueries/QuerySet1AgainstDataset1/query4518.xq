...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_ElectronicSupport_0 in $node_Entity_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_8,$GRAPH_9,("ElectronicSupport_0"))
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("USRPE313_0"))
  return
    $GRAPH_16
return
