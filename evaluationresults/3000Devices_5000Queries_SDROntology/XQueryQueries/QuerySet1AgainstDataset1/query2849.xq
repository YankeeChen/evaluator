...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ContinuousWaveRadar_0 in $node_Submarine_0/RFDevice:isDeployedOn
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:resource)
    where fn:exists($value_ContinuousWaveRadar_0) and fn:exists($node_Submarine_0)
    return
      <xqllib:result>
        <xqllib:var name="ContinuousWaveRadar_0">{$value_ContinuousWaveRadar_0}</xqllib:var>
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_Producer_0/RFDevice:hasProducer
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_2,$GRAPH_12,("Submarine_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_1,$GRAPH_13,("Submarine_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("ContinuousWaveRadar_0"))
  return
    $GRAPH_15
return
