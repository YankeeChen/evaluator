...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB2xxmini_0 := fn:data($node_USRPB2xxmini_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB2xxmini_0/RFDevice:hasHeight
  ...
  let $GRAPH_8 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:isProducerOf/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Producer_instance123"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
