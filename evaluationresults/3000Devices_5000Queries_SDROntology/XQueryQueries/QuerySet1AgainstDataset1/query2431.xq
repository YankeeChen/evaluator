...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Entity_0 in $node_Frequency_0/RFDevice:hasMax
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_5,$GRAPH_8,("Entity_0","Frequency_0"))
  let $GRAPH_10 :=  
    for $node_Entity_0 in $doc_ObjectDescription[Nuvio:relevantIndividual/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Instance4615"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_4,$GRAPH_13,("Entity_0","InformationContent_0"))
