...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE313_0 := fn:data($node_USRPE313_0/@rdf:about)
    for $node_Var0 in $node_USRPE313_0/RFDevice:hasCapability
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("Attribute_0","Var0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("Var0"))
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPE313_0"))
  return
    $GRAPH_12
return
