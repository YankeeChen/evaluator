...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200_0 := fn:data($node_USRPB200_0/@rdf:about)
    for $node_Var0 in $node_USRPB200_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[Nuvio:participatesIn/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#CommunicationsJamming_instance3"]
