...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) <= -1092861919)]
  let $GRAPH_10 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_6,$GRAPH_11,("Entity_0","Var0"))
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_17,$GRAPH_18,("InformationContent_0"))
