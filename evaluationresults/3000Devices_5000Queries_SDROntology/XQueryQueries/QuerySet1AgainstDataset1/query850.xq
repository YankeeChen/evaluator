...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Transmitting_0 in $node_Power_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_1,$GRAPH_5,("Transmitting_0"))
  let $GRAPH_7 := xqllib:optional($GRAPH_0,$GRAPH_6,("CommunicationsSystem_0"))
  return
    $GRAPH_7
return
