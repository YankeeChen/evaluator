...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200mini_i_0 in $node_Var0/RFDevice:hasCapability
  ...
  let $GRAPH_4 :=  
    for $node_Var2 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Decibel_milliwatts"]/Nuvio:hasUnitOfMeasure
