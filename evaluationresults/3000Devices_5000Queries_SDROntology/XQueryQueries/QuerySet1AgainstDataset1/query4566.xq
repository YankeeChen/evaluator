...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ArcByCenterPoint_0) and fn:exists($node_Entity_0) and $node_ArcByCenterPoint_0/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("Submarine_0"))
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_0,$GRAPH_13,("USRPX310_0"))
  return
    $GRAPH_14
return
