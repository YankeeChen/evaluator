...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_Entity_0/RFDevice:hasProducer
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_Attribute_0/RFDevice:hasCapacity
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_Attribute_0) and fn:exists($node_Entity_0) and $node_Attribute_0/RFDevice:hasCapability/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Attribute_0">{$value_Attribute_0}</xqllib:var>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
      </xqllib:result>
  let $GRAPH_9 := xqllib:optional($GRAPH_7,$GRAPH_8,("Attribute_0","Entity_0"))
  let $GRAPH_10 :=  
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("InstantaneousFrequencyMeasurementReceiver_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("InstantaneousFrequencyMeasurementReceiver_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("SDR_0"))
  return
    $GRAPH_16
return
