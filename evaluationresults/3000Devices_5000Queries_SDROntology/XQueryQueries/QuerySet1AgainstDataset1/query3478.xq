...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_PulseDopplerRadar_0 := fn:data($node_PulseDopplerRadar_0/@rdf:about)
    for $node_Transmitter_0 in $node_PulseDopplerRadar_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Transmitter_0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyRange
    let $value_Transmitter_0 := fn:data($node_Transmitter_0/@rdf:resource)
  ...
  let $GRAPH_4 :=  
    ...
    for $node_RadarFrequencyBand_0 in $node_Entity_0/RFDevice:hasMax
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_5,$GRAPH_10,("Entity_0","InformationEntity_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_4,$GRAPH_11,("Entity_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_3,$GRAPH_12,("RadarFrequencyBand_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("Transmitter_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("Transmitter_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("PulseDopplerRadar_0"))
  return
    $GRAPH_16
return
