...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB205mini_i_0 := fn:data($node_USRPB205mini_i_0/@rdf:about)
    for $node_Var0 in $node_USRPB205mini_i_0/RFDevice:hasCapability
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Situation_0) and fn:exists($node_Var0) and $node_Situation_0/Nuvio:hasSubprocess/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("OnOffKeyingModulation_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("Situation_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_1,$GRAPH_6,("Var0"))
  let $GRAPH_8 := xqllib:and($GRAPH_0,$GRAPH_7,("USRPB205mini_i_0"))
  return
    $GRAPH_8
return
