...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[RFDevice:hasLevel/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#NoiseFigure_instance58"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
