...
let $result :=  
  ...
  let $GRAPH_5 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.w3.org/2004/02/skos/core#ConceptScheme"]
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("Entity_0","UnitOfMeasure_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("Entity_0"))
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("RFSystem_0"))
  return
    $GRAPH_12
return
