...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPB200mini_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Aircraft_instance77"]/RFDevice:isDeployedOn
