...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_0 in $node_Entity_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_9 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_RadarModulation_0) and fn:exists($node_Var0) and $node_RadarModulation_0/RFDevice:supportsJamming/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("RadarModulation_0"))
  ...
  let $GRAPH_18 :=  
    ...
    where fn:exists($node_InformationUnit_0) and fn:exists($node_Value_0) and $node_InformationUnit_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Value_0
    return
      <xqllib:result>
  ...
  let $GRAPH_20 := xqllib:and($GRAPH_18,$GRAPH_19,("InformationUnit_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_17,$GRAPH_20,())
  let $GRAPH_22 := xqllib:and($GRAPH_2,$GRAPH_21,("Entity_0","Value_0"))
