...
let $result :=  
  ...
  let $GRAPH_8 :=  
    for $node_Jamming_0 in $doc_ObjectDescription
    let $value_Jamming_0 := fn:data($node_Jamming_0/@rdf:about)
    for $node_Power_0 in $node_Jamming_0/RFDevice:hasPulseRepetitionFrequency
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("Jamming_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_6,$GRAPH_9,("Jamming_0"))
  let $GRAPH_11 :=  
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_14,$GRAPH_15,("UnitOfMeasure_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_1,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_0,$GRAPH_17,("USRPN300_0"))
  return
    $GRAPH_18
return
