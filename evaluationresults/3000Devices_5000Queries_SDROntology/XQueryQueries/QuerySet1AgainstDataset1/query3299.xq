...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Value_0/Nuvio:hasValue
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) != 378385845)]
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_0,$GRAPH_8,("RadarWarningReceiver_0"))
  return
    $GRAPH_9
return
