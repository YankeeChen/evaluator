...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE310_0 in $node_Entity_0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Attribute_0 in $node_Entity_0/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = 1527466970)]
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("USRPE310_0"))
  return
    $GRAPH_16
return
