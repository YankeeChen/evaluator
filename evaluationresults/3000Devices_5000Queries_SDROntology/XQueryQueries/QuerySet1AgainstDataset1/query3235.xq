...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ContinuousWaveRadar_0 in $node_IEDTrigger_0/Nuvio:aggregateOf
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) < -29377461)]
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_2,$GRAPH_12,("IEDTrigger_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_1,$GRAPH_13,("IEDTrigger_0"))
