...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) = -40.04)]
  let $GRAPH_10 :=  
  ...
  let $GRAPH_13 := $GRAPH_12[(data(xqllib:var[@name="DataValue1"]) >= 608113416)]
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_7,$GRAPH_16,("Entity_0"))
