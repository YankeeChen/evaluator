...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    where fn:exists($node_FrequencyScanRate_0) and fn:exists($node_Object_0) and $node_FrequencyScanRate_0/RFDevice:hasMaxPowerConsumption/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_0,$GRAPH_3,("USRPE310_0"))
  return
    $GRAPH_4
return
