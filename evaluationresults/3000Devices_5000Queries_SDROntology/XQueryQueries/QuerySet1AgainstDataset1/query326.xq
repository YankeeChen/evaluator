...
let $result :=  
  ...
  let $GRAPH_13 :=  
    ...
    where fn:exists($node_Height_0) and fn:exists($node_Object_0) and $node_Height_0/RFDevice:hasMaxPowerConsumption/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_13,$GRAPH_14,("Height_0"))
