...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    where fn:exists($node_Object_0) and fn:exists($node_SpotJamming_0) and $node_SpotJamming_0/Nuvio:participatesIn/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
        <xqllib:var name="Object_0">{$value_Object_0}</xqllib:var>
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("TrackingRadar_0"))
  return
    $GRAPH_15
return
