...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Var0 in $node_InformationRepresentation_0/Nuvio:representedBy
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_7,$GRAPH_8,("InformationRepresentation_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_6,$GRAPH_9,("Var0"))
  let $GRAPH_11 :=  
    for $node_Process_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Transceiving_instance59"]/Nuvio:hasSubprocess
