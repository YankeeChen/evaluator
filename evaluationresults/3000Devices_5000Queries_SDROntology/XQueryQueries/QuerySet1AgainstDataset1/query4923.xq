...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) != -1605582924)]
  let $GRAPH_6 :=  
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_DataSize_0/Nuvio:expresses
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("DataSize_0"))
