...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#NoiseFigure_instance144"]/RFDevice:hasPulseRepetitionInterval
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("FreqencyRange_0"))
  let $GRAPH_8 := ($GRAPH_4,$GRAPH_7)
  let $GRAPH_9 := xqllib:and($GRAPH_2,$GRAPH_8,("Var0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("Var0"))
  let $GRAPH_11 := xqllib:optional($GRAPH_0,$GRAPH_10,("USRPB2xxmini_0"))
  return
    $GRAPH_11
return
