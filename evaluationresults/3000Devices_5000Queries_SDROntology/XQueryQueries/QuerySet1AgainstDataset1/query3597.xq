...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_Weight_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = 950823441)]
  let $GRAPH_7 := xqllib:optional($GRAPH_4,$GRAPH_6,("Var0"))
