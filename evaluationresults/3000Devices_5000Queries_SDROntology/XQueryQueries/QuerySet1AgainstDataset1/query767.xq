...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE3xx_0 := fn:data($node_USRPE3xx_0/@rdf:about)
    for $node_Var0 in $node_USRPE3xx_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasMaxPowerConsumption/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#Freq_61_44MHz"]
