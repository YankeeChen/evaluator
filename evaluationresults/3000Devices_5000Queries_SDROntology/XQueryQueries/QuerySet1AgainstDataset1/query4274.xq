...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsJamming
  ...
  let $GRAPH_2 :=  
    for $node_PulseDopplerRadarModulation_0 in $doc_ObjectDescription
    let $value_PulseDopplerRadarModulation_0 := fn:data($node_PulseDopplerRadarModulation_0/@rdf:about)
    for $node_TimeInterval_0 in $node_PulseDopplerRadarModulation_0/RFDevice:hasEffectiveRadiatedPower
