...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX3xx_0 in $node_Var0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) != 2.78)]
  let $GRAPH_6 := xqllib:and($GRAPH_3,$GRAPH_5,("Var2"))
  let $GRAPH_7 := xqllib:and($GRAPH_2,$GRAPH_6,("Var1"))
  let $GRAPH_8 := xqllib:and($GRAPH_1,$GRAPH_7,("Var0"))
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("USRPX3xx_0"))
  return
    $GRAPH_9
return
