...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CommunicationsSystem_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_7 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Role"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_12,$GRAPH_16,("Entity_0"))
  ...
  let $GRAPH_21 := xqllib:optional($GRAPH_5,$GRAPH_20,("Entity_0","Process_0"))
  ...
  let $GRAPH_25 := xqllib:and($GRAPH_0,$GRAPH_24,("CommunicationsSystem_0"))
  return
    $GRAPH_25
return
