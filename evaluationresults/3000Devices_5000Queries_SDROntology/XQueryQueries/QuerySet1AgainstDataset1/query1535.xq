...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN310_0 := fn:data($node_USRPN310_0/@rdf:about)
    for $node_Entity_0 in $node_USRPN310_0/RFDevice:hasSamplingRate
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_RFSystem_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("RFSystem_0"))
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) > 327865862)]
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("Attribute_0"))
