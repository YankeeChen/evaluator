...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Spartan3ADSPFPGA_0/Nuvio:aggregateOf
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("Spartan3ADSPFPGA_0"))
  ...
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Var2 in $node_Var0/RFDevice:hasLevel
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("USRPX3xx_0"))
  return
    $GRAPH_13
return
