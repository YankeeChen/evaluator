...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RFSystem_0 in $node_Receiver_0/Nuvio:compositeOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Receiver_0 in $node_Object_0/Nuvio:aggregateOf
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_0,$GRAPH_7,("RFSystem_0"))
  return
    $GRAPH_8
return
