...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN200_0 in $node_Var0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Power_0 in $node_Var0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_5 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#NonNegativeIntegerValue"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) <= 2115654635)]
  let $GRAPH_8 := xqllib:and($GRAPH_5,$GRAPH_7,("Var1"))
  let $GRAPH_9 := xqllib:and($GRAPH_4,$GRAPH_8,("Var1"))
  let $GRAPH_10 := xqllib:and($GRAPH_3,$GRAPH_9,("Power_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("Power_0"))
  let $GRAPH_12 :=  
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("USRPN200_0"))
  return
    $GRAPH_15
return
