...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Transmitting_0 in $node_Quantity_0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_1,$GRAPH_7,("Transmitting_0"))
  let $GRAPH_9 := xqllib:optional($GRAPH_0,$GRAPH_8,("Half_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_9
return
