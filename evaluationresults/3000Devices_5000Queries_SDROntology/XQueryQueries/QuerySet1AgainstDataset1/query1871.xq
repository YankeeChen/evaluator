...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_IEDJammer_0/Nuvio:compositeOf
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("IEDJammer_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("IEDJammer_0"))
  let $GRAPH_8 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
