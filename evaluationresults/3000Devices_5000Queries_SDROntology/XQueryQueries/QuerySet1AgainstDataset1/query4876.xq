...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_USRPE310_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_6 :=  
    ...
    for $node_USRPE310_0 in $node_Var0/RFDevice:hasCenterFrequency
    let $value_USRPE310_0 := fn:data($node_USRPE310_0/@rdf:resource)
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("USRPE310_0"))
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_0,$GRAPH_11,("MonostaticRadar_0"))
  return
    $GRAPH_12
return
