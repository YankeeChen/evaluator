...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SearchRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:hasCapability
  ...
  let $GRAPH_2 :=  
    for $node_PulseDopplerRadarModulation_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#TimeInterval_instance47"]/RFDevice:hasPulseRepetitionFrequency
