...
let $result :=  
  ...
  let $GRAPH_11 :=  
    ...
    for $node_Entity_0 in $node_USRPX3xx_0/Nuvio:isExpressedBy
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_2,$GRAPH_15,("Ship_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_1,$GRAPH_16,("Ship_0"))
  let $GRAPH_18 := xqllib:optional($GRAPH_0,$GRAPH_17,("SearchRadar_0"))
  return
    $GRAPH_18
return
