...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_DeceptiveCommunicationsJamming_0) and fn:exists($node_Entity_0) and $node_DeceptiveCommunicationsJamming_0/Nuvio:hasParticipant/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_DeceptiveCommunicationsJamming_0 in $node_Entity_0/RFDevice:hasMaxSensedPower
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("DeceptiveCommunicationsJamming_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("DeceptiveCommunicationsJamming_0","Entity_0"))
