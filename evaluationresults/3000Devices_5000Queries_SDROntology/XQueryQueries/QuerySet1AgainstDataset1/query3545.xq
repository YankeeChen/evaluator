...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Var0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyAccuracy
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_11 := $GRAPH_10[(data(xqllib:var[@name="DataValue0"]) >= -3.14)]
  let $GRAPH_12 := xqllib:and($GRAPH_9,$GRAPH_11,("Entity_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_8,$GRAPH_12,("RadarFrequencyBand_0"))
