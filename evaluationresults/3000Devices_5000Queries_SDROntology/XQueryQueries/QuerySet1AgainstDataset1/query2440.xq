...
let $result :=  
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = 1804546048)]
  let $GRAPH_8 :=  
  ...
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#InformationUnit_instance0"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("DataSize_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("Object_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("USRPB2xxmini_0"))
  return
    $GRAPH_16
return
