...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) < -1264268165)]
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue1"]) = 1111341188)]
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_15,$GRAPH_16,("EmitterIdentification_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_14,$GRAPH_17,("Object_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_1,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_0,$GRAPH_19,("USRPE312_0"))
  return
    $GRAPH_20
return
