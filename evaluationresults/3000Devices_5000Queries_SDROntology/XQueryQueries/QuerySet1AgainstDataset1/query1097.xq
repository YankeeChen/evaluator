...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SearchRadar_0 in $node_Entity_0/RFDevice:hasProducer
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_UnitOfMeasure_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#PulseRadar_instance44"]/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_6,$GRAPH_9,("InformationContent_0"))
