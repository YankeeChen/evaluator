...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CR_0 in $node_Object_0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    for $node_BlinkingJamming_0 in $node_Object_0/Nuvio:participatesIn
  ...
  let $GRAPH_4 :=  
    ...
    let $value_BlinkingJamming_0 := fn:data($node_BlinkingJamming_0/@rdf:about)
    for $node_Entity_0 in $node_BlinkingJamming_0/RFDevice:hasTransmitPowerRange
  ...
  let $GRAPH_10 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_Clothoid_0) and fn:exists($node_Entity_0) and $node_Clothoid_0/Nuvio:expresses/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_3,$GRAPH_13,("BlinkingJamming_0"))
  let $GRAPH_15 := xqllib:optional($GRAPH_2,$GRAPH_14,("BlinkingJamming_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_1,$GRAPH_15,("Object_0"))
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("CR_0"))
  return
    $GRAPH_17
return
