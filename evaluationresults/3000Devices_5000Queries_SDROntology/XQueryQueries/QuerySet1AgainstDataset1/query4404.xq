...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_RadioComponent_0 in $node_OmnidirectionalAntenna_0/Nuvio:aggregateOf
  ...
  let $GRAPH_5 :=  
    ...
    for $node_OmnidirectionalAntenna_0 in $node_Quality_0/Nuvio:hasObjectQuality
    let $value_OmnidirectionalAntenna_0 := fn:data($node_OmnidirectionalAntenna_0/@rdf:resource)
    where fn:exists($value_OmnidirectionalAntenna_0) and fn:exists($node_Quality_0)
    return
      <xqllib:result>
        <xqllib:var name="OmnidirectionalAntenna_0">{$value_OmnidirectionalAntenna_0}</xqllib:var>
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_4,$GRAPH_7,("OmnidirectionalAntenna_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_3,$GRAPH_8,("OmnidirectionalAntenna_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("RadioComponent_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("RadioComponent_0"))
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPB2xx_0"))
  return
    $GRAPH_12
return
