...
let $result :=  
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) <= -1775414506)]
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_RadarSystem_0) and fn:exists($node_Var0) and $node_RadarSystem_0/RFDevice:hasTarget/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("Component_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_8,$GRAPH_11,("RadarSystem_0"))
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_3,$GRAPH_15,("UnitOfMeasure_0","Var0"))
  let $GRAPH_17 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
