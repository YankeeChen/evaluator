...
let $result :=  
  ...
  let $GRAPH_13 :=  
    ...
    where fn:exists($node_Height_0) and fn:exists($node_Object_0) and $node_Height_0/RFDevice:hasWidth/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_18 := xqllib:and($GRAPH_14,$GRAPH_17,("Var1"))
  let $GRAPH_19 := xqllib:and($GRAPH_13,$GRAPH_18,("Height_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_12,$GRAPH_19,("Object_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_1,$GRAPH_20,("Var0"))
  let $GRAPH_22 := xqllib:and($GRAPH_0,$GRAPH_21,("USRPN300_0"))
  return
    $GRAPH_22
return
