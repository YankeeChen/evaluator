...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_RadioFrequencyBand_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Frequency_instance50"]/RFDevice:hasMin
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("InstantaneousFrequencyMeasurementReceiver_0"))
