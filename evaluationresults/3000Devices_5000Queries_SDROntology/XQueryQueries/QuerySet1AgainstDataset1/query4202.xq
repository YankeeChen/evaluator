...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) <= 56.54)]
  ...
  let $GRAPH_8 :=  
    ...
    let $value_InformationContent_0 := fn:data($node_InformationContent_0/@rdf:about)
    for $node_InformationRepresentation_1 in $doc_ObjectDescription
    let $value_InformationRepresentation_1 := fn:data($node_InformationRepresentation_1/@rdf:about)
    where fn:exists($node_InformationContent_0) and fn:exists($node_InformationRepresentation_1) and $node_InformationRepresentation_1/Nuvio:represents/@rdf:resource = $value_InformationContent_0
    return
      <xqllib:result>
        <xqllib:var name="InformationContent_0">{$value_InformationContent_0}</xqllib:var>
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_6,$GRAPH_9,())
