...
let $result :=  
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Entity_0 in $node_Entity_2/Nuvio:isExpressedBy
  ...
  let $GRAPH_11 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Satellite"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_12 :=  
    ...
    for $node_Entity_0 in $node_Entity_1/RFDevice:supportsTuning
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_13,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 := ($GRAPH_10,$GRAPH_17)
  let $GRAPH_19 := xqllib:and($GRAPH_8,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_7,$GRAPH_19,("Var0"))
  let $GRAPH_21 := xqllib:optional($GRAPH_6,$GRAPH_20,("Var0"))
