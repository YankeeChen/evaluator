...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RadarWarningReceiver_0 in $node_Weight_0/RFDevice:hasCapacity
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) != xs:double("58.820923"))]
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("RadarWarningReceiver_0"))
  return
    $GRAPH_9
return
