...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_EmitterIdentification_0) and fn:exists($node_Object_0) and $node_EmitterIdentification_0/RFDevice:supportsSpectrumSensing/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
