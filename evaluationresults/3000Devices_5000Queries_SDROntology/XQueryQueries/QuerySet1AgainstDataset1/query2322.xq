...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Object_0) and fn:exists($node_Var0) and $node_Object_0/Nuvio:subprocessOf/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Object_0 in $node_EmitterIdentification_0/Nuvio:hasParticipant
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($node_EmitterIdentification_0) and fn:exists($value_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("EmitterIdentification_0"))
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("Object_0"))
