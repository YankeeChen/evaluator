...
let $result :=  
  ...
  let $GRAPH_5 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#RadarFrequencyBand_instance60"]/RFDevice:hasBandwidthRange
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("PulseRadar_0"))
  return
    $GRAPH_9
return
