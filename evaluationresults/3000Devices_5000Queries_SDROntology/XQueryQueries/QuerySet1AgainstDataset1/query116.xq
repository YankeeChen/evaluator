...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Process_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and RFDevice:hasEffectiveRadiatedPower/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription3000.owl#NoiseFigure_instance97"]
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
