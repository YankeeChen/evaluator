...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPN310_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#GroundPlatform_instance26"]/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("USRPN310_0"))
  return
    $GRAPH_2
return
