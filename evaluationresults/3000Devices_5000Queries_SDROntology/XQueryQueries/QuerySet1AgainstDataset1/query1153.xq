...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:about)
    for $node_Process_0 in $node_ContinuousWaveRadar_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_FrequencyShiftKeyingModulation_0) and fn:exists($node_Process_0) and $node_FrequencyShiftKeyingModulation_0/Nuvio:subprocessOf/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
