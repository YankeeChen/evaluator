...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Object_0 in $node_AmplitudeShiftKeyingModulation_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("AmplitudeShiftKeyingModulation_0"))
