...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200mini_0 in $node_Object_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and RFDevice:hasGain/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#Freq_70MHz"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
