...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicSupportSystem_0 in $node_EmitterLocationDetection_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("EmitterLocationDetection_0"))
