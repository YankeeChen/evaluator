...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE310_0 := fn:data($node_USRPE310_0/@rdf:about)
    for $node_Object_0 in $node_USRPE310_0/RFDevice:isDeployedOn
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($value_Object_0) and fn:exists($node_USRPE310_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_CrossPolarizationJamming_0) and fn:exists($node_Object_0) and $node_CrossPolarizationJamming_0/RFDevice:supportsTransmitting/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("CrossPolarizationJamming_0"))
