...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_0 in $node_FPGA_0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    for $node_FPGA_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#IEDTrigger_instance100"]/Nuvio:compositeOf
