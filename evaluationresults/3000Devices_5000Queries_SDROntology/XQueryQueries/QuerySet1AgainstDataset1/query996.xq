...
let $result :=  
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Entity_0 in $node_UnitOfMeasure_0/RFDevice:supportsJamming
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_15 :=  
    ...
    where fn:exists($node_Entity_1) and fn:exists($node_Process_0) and $node_Entity_1/Nuvio:hasProcessQuality/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
