...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_SpotJamming_0 in $node_Var0/Nuvio:participatesIn
    let $value_SpotJamming_0 := fn:data($node_SpotJamming_0/@rdf:resource)
    where fn:exists($value_SpotJamming_0) and fn:exists($node_Var0)
    return
      <xqllib:result>
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_5,$GRAPH_8,("SpotJamming_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_4,$GRAPH_9,("SpotJamming_0"))
  let $GRAPH_11 :=  
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_0,$GRAPH_15,("TrackingRadar_0"))
  return
    $GRAPH_16
return
