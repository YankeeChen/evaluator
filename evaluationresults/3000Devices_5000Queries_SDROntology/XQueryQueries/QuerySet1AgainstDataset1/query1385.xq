...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_Component_0/Nuvio:aggregateOf
  ...
  let $GRAPH_11 :=  
    ...
    for $node_Entity_0 in $node_FrequencyScanRate_0/RFDevice:hasHeight
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_13 :=  
    for $node_FrequencyScanRate_0 in $doc_ObjectDescription
    let $value_FrequencyScanRate_0 := fn:data($node_FrequencyScanRate_0/@rdf:about)
    for $node_Var1 in $node_FrequencyScanRate_0/Nuvio:hasValue
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_12,$GRAPH_13,("FrequencyScanRate_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_11,$GRAPH_14,("FrequencyScanRate_0"))
  let $GRAPH_16 :=  
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_5,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_4,$GRAPH_19,("Entity_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_3,$GRAPH_20,("RadioFrequencyBand_0"))
  let $GRAPH_22 :=  
