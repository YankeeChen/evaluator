...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Object_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Instance3288"]/RFDevice:hasChargingTime
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_2,$GRAPH_7,("RadioComponent_0"))
