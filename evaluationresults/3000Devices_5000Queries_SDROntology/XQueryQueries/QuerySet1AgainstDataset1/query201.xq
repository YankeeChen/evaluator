...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_Entity_0/Nuvio:aggregateOf
  ...
  let $GRAPH_5 :=  
    for $node_Value_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#AngleUnit_Degree"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) <= -1238347641)]
  let $GRAPH_8 := ($GRAPH_5,$GRAPH_7)
  let $GRAPH_9 := xqllib:optional($GRAPH_3,$GRAPH_8,())
