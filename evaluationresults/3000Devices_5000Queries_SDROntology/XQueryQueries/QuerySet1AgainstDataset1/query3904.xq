...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_Process_0) and $node_Entity_0/Nuvio:subprocessOf/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) >= xs:double("-14.864479"))]
  ...
  let $GRAPH_18 := $GRAPH_17[(data(xqllib:var[@name="DataValue1"]) >= 1665565335)]
  let $GRAPH_19 := xqllib:and($GRAPH_16,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_15,$GRAPH_19,("Entity_0"))
  let $GRAPH_21 := ($GRAPH_9,$GRAPH_20)
  let $GRAPH_22 := ($GRAPH_7,$GRAPH_21)
  let $GRAPH_23 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_24 := xqllib:and($GRAPH_22,$GRAPH_23,("Entity_0","InformationRepresentation_0"))
  let $GRAPH_25 := xqllib:and($GRAPH_5,$GRAPH_24,("Entity_0"))
  let $GRAPH_26 := xqllib:and($GRAPH_4,$GRAPH_25,("Process_0"))
  let $GRAPH_27 := ($GRAPH_3,$GRAPH_26)
  let $GRAPH_28 := xqllib:and($GRAPH_1,$GRAPH_27,("Submarine_0"))
  let $GRAPH_29 := xqllib:and($GRAPH_0,$GRAPH_28,("ElectronicSupportSystem_0"))
  return
    $GRAPH_29
return
