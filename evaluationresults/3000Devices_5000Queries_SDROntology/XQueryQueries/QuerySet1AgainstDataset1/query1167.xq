...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicSupportSystem_0 in $node_Entity_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) <= -1653581652)]
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("Entity_0","UnitOfMeasure_0"))
