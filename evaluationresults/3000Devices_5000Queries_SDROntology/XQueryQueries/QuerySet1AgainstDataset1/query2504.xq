...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPB200_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Producer_instance986"]/RFDevice:hasProducer
