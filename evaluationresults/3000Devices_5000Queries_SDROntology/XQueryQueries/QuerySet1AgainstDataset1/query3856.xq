...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) >= -1031373556)]
  let $GRAPH_10 := xqllib:optional($GRAPH_7,$GRAPH_9,("AngleValue_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_6,$GRAPH_10,("AngleValue_0"))
