...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE310_0 in $node_Entity_0/RFDevice:isProducerOf
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/sf#MultiLineString"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_4 :=  
    for $node_Situation_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#SuperheterodyneReceiver_instance111"]/Nuvio:relevantIndividual
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,())
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("Entity_0","Situation_0"))
