...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB2xxmini_0 in $node_Entity_0/RFDevice:isProducerOf
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) <= xs:double("-49.68127"))]
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("USRPB2xxmini_0"))
  return
    $GRAPH_11
return
