...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and Nuvio:hasObjectQuantity/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Freq_1GHz"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
