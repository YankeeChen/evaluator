...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Entity_0 in $node_Var0/RFDevice:hasLevel
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Power_instance69"]/Nuvio:hasProcessQuantity
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_Velocity_0/RFDevice:hasMaxPowerConsumption
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
