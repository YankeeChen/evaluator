...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) <= xs:double("71.47066545599449"))]
  let $GRAPH_6 := xqllib:optional($GRAPH_3,$GRAPH_5,("Entity_0"))
  let $GRAPH_7 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#CoverJamming_instance1"]/Nuvio:participatesIn
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("ModelX_0"))
  return
    $GRAPH_13
return
