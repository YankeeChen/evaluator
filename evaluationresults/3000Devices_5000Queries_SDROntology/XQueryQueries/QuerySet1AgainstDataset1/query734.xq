...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Half_DuplexCommunicationsSystem_0 in $node_Entity_0/RFDevice:hasHeight
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Entity_0 in $node_Var0/Nuvio:isExpressedBy
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPB2xxmini"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
