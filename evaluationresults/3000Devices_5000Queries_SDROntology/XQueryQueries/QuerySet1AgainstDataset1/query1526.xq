...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_SDR_0 := fn:data($node_SDR_0/@rdf:about)
    for $node_RadioComponent_0 in $node_SDR_0/Nuvio:aggregateOf
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:resource)
    where fn:exists($value_RadioComponent_0) and fn:exists($node_SDR_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    ...
    for $node_RadioComponent_0 in $node_XilinxZynq7020SoC_0/Nuvio:partOf
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:resource)
  ...
  let $GRAPH_3 :=  
    ...
    for $node_XilinxZynq7020SoC_0 in $node_Entity_0/Nuvio:aggregateOf
    let $value_XilinxZynq7020SoC_0 := fn:data($node_XilinxZynq7020SoC_0/@rdf:resource)
    where fn:exists($node_Entity_0) and fn:exists($value_XilinxZynq7020SoC_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_2,$GRAPH_16,("XilinxZynq7020SoC_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_1,$GRAPH_17,("RadioComponent_0"))
