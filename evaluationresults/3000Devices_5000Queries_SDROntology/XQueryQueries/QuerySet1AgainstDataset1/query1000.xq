...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_Object_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Object_0 in $node_Height_0/RFDevice:hasVoltage
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($node_Height_0) and fn:exists($value_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_4 :=  
    for $node_Height_0 in $doc_ObjectDescription
    let $value_Height_0 := fn:data($node_Height_0/@rdf:about)
    for $node_Var0 in $node_Height_0/Nuvio:hasValue
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("Height_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("Height_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_1,$GRAPH_6,("Object_0"))
  let $GRAPH_8 := xqllib:optional($GRAPH_0,$GRAPH_7,("PulseDopplerRadar_0"))
  return
    $GRAPH_8
return
