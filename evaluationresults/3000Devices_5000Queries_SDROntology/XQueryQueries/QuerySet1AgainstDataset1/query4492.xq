...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SearchRadar_0 in $node_Entity_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_6 :=  
    for $node_IEDTrigger_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#RFFrontEnd_instance108"]/Nuvio:partOf
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_3,$GRAPH_7,("IEDTrigger_0"))
  let $GRAPH_9 :=  
