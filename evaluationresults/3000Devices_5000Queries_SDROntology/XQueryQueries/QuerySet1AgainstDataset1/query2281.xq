...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseRadar_0 in $node_PulseRadarModulation_0/RFDevice:hasCapability
    let $value_PulseRadar_0 := fn:data($node_PulseRadar_0/@rdf:resource)
    where fn:exists($node_PulseRadarModulation_0) and fn:exists($value_PulseRadar_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_Frequency_0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_3,$GRAPH_7,("Frequency_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_2,$GRAPH_8,("PulseRadarModulation_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("PulseRadarModulation_0"))
