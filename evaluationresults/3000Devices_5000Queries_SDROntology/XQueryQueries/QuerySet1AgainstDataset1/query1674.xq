...
let $result :=  
  ...
  let $GRAPH_10 :=  
    for $node_Process_0 in $doc_ObjectDescription
    let $value_Process_0 := fn:data($node_Process_0/@rdf:about)
    for $node_Value_0 in $node_Process_0/Nuvio:subprocessOf
  ...
  let $GRAPH_13 := $GRAPH_12[(data(xqllib:var[@name="DataValue0"]) > 1469893560)]
  let $GRAPH_14 := xqllib:and($GRAPH_11,$GRAPH_13,("Value_0"))
  let $GRAPH_15 := xqllib:optional($GRAPH_10,$GRAPH_14,("Value_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_9,$GRAPH_15,())
  let $GRAPH_17 := xqllib:and($GRAPH_2,$GRAPH_16,("Entity_0","Process_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_1,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:optional($GRAPH_0,$GRAPH_18,("CommunicationsSystem_0"))
  return
    $GRAPH_19
return
