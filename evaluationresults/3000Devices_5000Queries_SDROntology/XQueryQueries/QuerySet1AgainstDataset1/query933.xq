...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/sf#Geometry"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Power_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_18 := xqllib:optional($GRAPH_0,$GRAPH_17,("BistaticRadar_0"))
  return
    $GRAPH_18
return
