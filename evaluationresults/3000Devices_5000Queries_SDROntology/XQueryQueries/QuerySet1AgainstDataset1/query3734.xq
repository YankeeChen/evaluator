...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_JammingSystem_0 := fn:data($node_JammingSystem_0/@rdf:about)
    for $node_Var0 in $node_JammingSystem_0/RFDevice:hasCapability
  ...
  let $GRAPH_9 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPB200"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Entity_0 in $node_Var1/RFDevice:hasNoiseFigure
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_11 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Ratio"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_18 := xqllib:and($GRAPH_7,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_6,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_5,$GRAPH_19,("Var0"))
  let $GRAPH_21 := xqllib:and($GRAPH_4,$GRAPH_20,("Var0"))
  let $GRAPH_22 := xqllib:and($GRAPH_1,$GRAPH_21,("Var0"))
  let $GRAPH_23 := xqllib:and($GRAPH_0,$GRAPH_22,("JammingSystem_0"))
  return
    $GRAPH_23
return
