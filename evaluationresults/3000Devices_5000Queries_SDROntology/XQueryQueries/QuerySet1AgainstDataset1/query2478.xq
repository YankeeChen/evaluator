...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_InstantaneousFrequencyMeasurementReceiver_0/Nuvio:partOf
  ...
  let $GRAPH_4 :=  
    ...
    where fn:exists($node_ElectronicSupport_0) and fn:exists($node_Object_0) and $node_ElectronicSupport_0/RFDevice:supportsTransmitting/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPN3xx_0"))
  return
    $GRAPH_12
return
