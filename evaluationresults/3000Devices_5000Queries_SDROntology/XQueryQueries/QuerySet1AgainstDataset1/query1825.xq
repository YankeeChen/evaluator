...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseRadar_0 in $node_Entity_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_3 := $GRAPH_2[(data(xqllib:var[@name="DataValue0"]) = 1601539697)]
  let $GRAPH_4 := xqllib:and($GRAPH_1,$GRAPH_3,("Entity_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_0,$GRAPH_4,("PulseRadar_0"))
  return
    $GRAPH_5
return
