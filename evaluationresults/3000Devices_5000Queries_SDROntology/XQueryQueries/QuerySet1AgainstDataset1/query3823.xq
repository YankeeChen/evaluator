...
let $result :=  
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) > 1933752070)]
  ...
  let $GRAPH_16 :=  
    for $node_Process_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription3000.owl#Instance642"]/Nuvio:hasSubprocess
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_15,$GRAPH_16,("Process_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_4,$GRAPH_17,("Var0"))
  let $GRAPH_19 := xqllib:optional($GRAPH_3,$GRAPH_18,("Var0"))
