...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Half_DuplexCommunicationsSystem_0 in $node_Transmitting_0/RFDevice:supportsTuning
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Transmitting_0 in $node_Attribute_0/RFDevice:hasMaxSensedPower
