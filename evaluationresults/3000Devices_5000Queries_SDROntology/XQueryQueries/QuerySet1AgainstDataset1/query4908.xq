...
let $result :=  
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_2,$GRAPH_4,("Var1"))
  let $GRAPH_6 :=  
    ...
    for $node_Var0 in $node_RangeGatePullOffJamming_0/RFDevice:supportsTuning
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("RangeGatePullOffJamming_0"))
  let $GRAPH_9 := xqllib:optional($GRAPH_5,$GRAPH_8,("Var0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("Var0"))
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("USRPE313_0"))
  return
    $GRAPH_11
return
