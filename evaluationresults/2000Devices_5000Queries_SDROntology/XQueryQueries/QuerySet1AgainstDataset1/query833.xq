...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RadarWarningReceiver_0 in $node_DirectConversionReceiver_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_DirectConversionReceiver_0 in $node_Entity_0/Nuvio:compositeOf
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("Value_0"))
