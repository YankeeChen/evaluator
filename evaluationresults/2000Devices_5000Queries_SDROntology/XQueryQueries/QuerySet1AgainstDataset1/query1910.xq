...
let $result :=  
  ...
  let $GRAPH_7 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Percentage_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("Percentage_0"))
  let $GRAPH_10 := ($GRAPH_6,$GRAPH_9)
  let $GRAPH_11 := xqllib:and($GRAPH_4,$GRAPH_10,("Entity_0"))
  let $GRAPH_13 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#WeightUnit_instance1"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_11,$GRAPH_15,("Entity_0"))
  let $GRAPH_17 := xqllib:optional($GRAPH_3,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 :=  
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_17,$GRAPH_18,())
  let $GRAPH_20 := xqllib:and($GRAPH_2,$GRAPH_19,("Entity_0","UnitOfMeasure_0"))
