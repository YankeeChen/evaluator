...
let $result :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) < 760979904)]
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Entity_0 in $node_TimeUnit_0/Nuvio:expresses
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($value_Entity_0) and fn:exists($node_TimeUnit_0)
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_10,$GRAPH_11,("TimeUnit_0"))
  ...
  let $GRAPH_16 :=  
    for $node_Process_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and RFDevice:hasMaxSensedPower/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Frequency_instance178"]
  ...
  let $GRAPH_19 := xqllib:and($GRAPH_0,$GRAPH_18,("MonostaticRadar_0"))
  return
    $GRAPH_19
return
