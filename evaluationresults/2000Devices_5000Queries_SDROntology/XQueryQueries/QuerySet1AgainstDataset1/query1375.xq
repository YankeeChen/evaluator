...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE313_0 := fn:data($node_USRPE313_0/@rdf:about)
    for $node_Entity_0 in $node_USRPE313_0/Nuvio:partOf
  ...
  let $GRAPH_4 := $GRAPH_3[(data(xqllib:var[@name="DataValue0"]) > 1430887003)]
  let $GRAPH_5 := xqllib:optional($GRAPH_2,$GRAPH_4,("Entity_0"))
