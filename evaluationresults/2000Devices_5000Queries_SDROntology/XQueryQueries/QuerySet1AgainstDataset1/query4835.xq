...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_Object_0) and $node_Entity_0/Nuvio:hasParticipant/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("PulseDopplerRadar_0"))
  return
    $GRAPH_10
return
