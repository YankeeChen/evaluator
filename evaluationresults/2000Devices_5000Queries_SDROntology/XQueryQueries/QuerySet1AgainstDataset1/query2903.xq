...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_RadioFrequencyBand_0 in $node_Weight_0/RFDevice:hasMin
    let $value_RadioFrequencyBand_0 := fn:data($node_RadioFrequencyBand_0/@rdf:resource)
    where fn:exists($value_RadioFrequencyBand_0) and fn:exists($node_Weight_0)
    return
      <xqllib:result>
        <xqllib:var name="RadioFrequencyBand_0">{$value_RadioFrequencyBand_0}</xqllib:var>
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_4,$GRAPH_16,("Weight_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_3,$GRAPH_17,("RadioFrequencyBand_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_2,$GRAPH_18,("RadioFrequencyBand_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_1,$GRAPH_19,("Jammer_0"))
