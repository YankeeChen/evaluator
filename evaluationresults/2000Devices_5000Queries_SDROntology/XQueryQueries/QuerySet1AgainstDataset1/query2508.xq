...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_0 in $node_XC6SLX75FPGA_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_XC6SLX75FPGA_0 in $doc_ObjectDescription
    let $value_XC6SLX75FPGA_0 := fn:data($node_XC6SLX75FPGA_0/@rdf:about)
    for $node_Entity_0 in $node_XC6SLX75FPGA_0/RFDevice:isProducerOf
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) > -734671126)]
  let $GRAPH_8 := xqllib:and($GRAPH_5,$GRAPH_7,("Value_0"))
  let $GRAPH_9 := xqllib:optional($GRAPH_4,$GRAPH_8,("Value_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_3,$GRAPH_9,("Entity_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("XC6SLX75FPGA_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_1,$GRAPH_11,("XC6SLX75FPGA_0"))
