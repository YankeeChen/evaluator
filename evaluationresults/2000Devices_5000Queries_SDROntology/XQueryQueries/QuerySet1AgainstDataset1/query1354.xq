...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_SearchRadar_0 := fn:data($node_SearchRadar_0/@rdf:about)
    for $node_Entity_0 in $node_SearchRadar_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Amplifier"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Quantity_0/RFDevice:hasNoiseFigure
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_Entity_1/RFDevice:hasEffectiveRadiatedPower
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_20 := $GRAPH_19[(data(xqllib:var[@name="DataValue0"]) >= -2113793898)]
  let $GRAPH_21 := ($GRAPH_18,$GRAPH_20)
  let $GRAPH_22 := ($GRAPH_16,$GRAPH_21)
  let $GRAPH_23 :=  
  ...
  let $GRAPH_24 := xqllib:and($GRAPH_22,$GRAPH_23,("Entity_0"))
  let $GRAPH_25 := xqllib:optional($GRAPH_10,$GRAPH_24,("Entity_0"))
  let $GRAPH_26 := xqllib:optional($GRAPH_9,$GRAPH_25,("Entity_0","Entity_1"))
  let $GRAPH_27 := xqllib:and($GRAPH_5,$GRAPH_26,("Entity_0"))
  let $GRAPH_28 := xqllib:and($GRAPH_2,$GRAPH_27,("Entity_0"))
  let $GRAPH_29 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    for $node_CumulativeDetection_0 in $node_Object_0/RFDevice:supportsTransmitting
    let $value_CumulativeDetection_0 := fn:data($node_CumulativeDetection_0/@rdf:resource)
    where fn:exists($value_CumulativeDetection_0) and fn:exists($node_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_31 := xqllib:and($GRAPH_29,$GRAPH_30,("CumulativeDetection_0"))
  let $GRAPH_32 := xqllib:and($GRAPH_28,$GRAPH_31,("Object_0"))
  let $GRAPH_33 := xqllib:and($GRAPH_1,$GRAPH_32,("Entity_0"))
  let $GRAPH_34 := xqllib:optional($GRAPH_0,$GRAPH_33,("SearchRadar_0"))
  return
    $GRAPH_34
return
