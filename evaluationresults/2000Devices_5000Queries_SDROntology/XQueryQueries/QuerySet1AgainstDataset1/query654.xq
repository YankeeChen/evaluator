...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_ElectronicProtection_0) and fn:exists($node_Var0) and $node_ElectronicProtection_0/Nuvio:subprocessOf/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("ElectronicProtection_0"))
