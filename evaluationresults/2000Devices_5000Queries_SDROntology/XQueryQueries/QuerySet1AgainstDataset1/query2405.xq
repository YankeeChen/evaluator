...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB2xxmini_0 := fn:data($node_USRPB2xxmini_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB2xxmini_0/RFDevice:isProducerOf
  ...
  let $GRAPH_5 :=  
    for $node_Entity_0 in $doc_ObjectDescription[RFDevice:isProducerOf/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Producer_instance218"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_Entity_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) >= 541495063)]
  ...
  let $GRAPH_22 := xqllib:and($GRAPH_20,$GRAPH_21,("GroundPlatform_0"))
  let $GRAPH_23 := xqllib:and($GRAPH_19,$GRAPH_22,("Situation_0"))
  let $GRAPH_24 := xqllib:and($GRAPH_1,$GRAPH_23,("Entity_0"))
  let $GRAPH_25 := xqllib:and($GRAPH_0,$GRAPH_24,("USRPB2xxmini_0"))
  return
    $GRAPH_25
return
