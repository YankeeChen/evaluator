...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CommunicationsSystem_0 in $node_Object_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and RFDevice:hasPolarization/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#CircularPolarization"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
