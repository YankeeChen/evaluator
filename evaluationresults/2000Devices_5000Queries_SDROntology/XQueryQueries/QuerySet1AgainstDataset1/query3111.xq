...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN300_0 := fn:data($node_USRPN300_0/@rdf:about)
    for $node_Var0 in $node_USRPN300_0/RFDevice:hasCapability
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("Frequency_0"))
  let $GRAPH_5 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Object_0 in $node_Var0/RFDevice:hasBandwidthRange
  ...
  let $GRAPH_6 :=  
    for $node_Object_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#AntennaPolarization_instance19"]/RFDevice:hasPolarization
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
