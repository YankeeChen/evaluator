...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Var2 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#ShortValue"]
    let $value_Var2 := fn:data($node_Var2/@rdf:about)
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("Var2"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("Var2"))
