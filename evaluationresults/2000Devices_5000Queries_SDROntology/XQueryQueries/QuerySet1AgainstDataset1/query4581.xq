...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    let $value_InstantaneousFrequencyMeasurementReceiver_0 := fn:data($node_InstantaneousFrequencyMeasurementReceiver_0/@rdf:about)
    for $node_Entity_0 in $node_InstantaneousFrequencyMeasurementReceiver_0/Nuvio:compositeOf
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_2,$GRAPH_10,("InstantaneousFrequencyMeasurementReceiver_0"))
