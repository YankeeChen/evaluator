...
let $result :=  
  ...
  let $GRAPH_13 := $GRAPH_12[(data(xqllib:var[@name="DataValue1"]) != -46.33)]
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_10,$GRAPH_16,("Var0"))
  let $GRAPH_18 := xqllib:and($GRAPH_9,$GRAPH_17,("Var0"))
  let $GRAPH_19 := xqllib:and($GRAPH_8,$GRAPH_18,("Var0"))
  let $GRAPH_20 := xqllib:and($GRAPH_7,$GRAPH_19,("TimeInterval_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_6,$GRAPH_20,("TimeInterval_0"))
  let $GRAPH_22 := xqllib:and($GRAPH_5,$GRAPH_21,("RadarFrequencyBand_0"))
  let $GRAPH_23 := xqllib:and($GRAPH_4,$GRAPH_22,("RadarFrequencyBand_0"))
  let $GRAPH_24 := ($GRAPH_3,$GRAPH_23)
  let $GRAPH_25 := xqllib:and($GRAPH_1,$GRAPH_24,("Transmitter_0"))
  let $GRAPH_26 := xqllib:optional($GRAPH_0,$GRAPH_25,("RFSystem_0"))
  return
    $GRAPH_26
return
