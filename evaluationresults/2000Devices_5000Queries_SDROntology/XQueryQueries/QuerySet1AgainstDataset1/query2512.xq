...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_Entity_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_3 :=  
    for $node_InformationContent_0 in $doc_ObjectDescription
    let $value_InformationContent_0 := fn:data($node_InformationContent_0/@rdf:about)
    for $node_Entity_1 in $node_InformationContent_0/Nuvio:representedBy
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("InformationContent_0"))
