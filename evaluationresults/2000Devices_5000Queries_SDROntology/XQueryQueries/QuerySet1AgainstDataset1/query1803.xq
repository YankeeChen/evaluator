...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE312_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var1 in $node_Object_0/Nuvio:expresses
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("Object_0","Var1"))
