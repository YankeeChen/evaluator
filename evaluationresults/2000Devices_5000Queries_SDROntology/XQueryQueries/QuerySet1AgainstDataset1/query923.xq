...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Freq_300kHz"]/RFDevice:hasBandwidth
  ...
  let $GRAPH_12 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_USRPE310_0) and fn:exists($node_Var0) and $node_USRPE310_0/Nuvio:expresses/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_6,$GRAPH_14,("Var0"))
  let $GRAPH_16 :=  
