...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_DipoleAntenna_0/Nuvio:hasParticipant
  ...
  let $GRAPH_4 :=  
    for $node_DipoleAntenna_0 in $doc_ObjectDescription
    let $value_DipoleAntenna_0 := fn:data($node_DipoleAntenna_0/@rdf:about)
    for $node_Var0 in $node_DipoleAntenna_0/RFDevice:supportsTuning
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("DipoleAntenna_0"))
  let $GRAPH_8 :=  
