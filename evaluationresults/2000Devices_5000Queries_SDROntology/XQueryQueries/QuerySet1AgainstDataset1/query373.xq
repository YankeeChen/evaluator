...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_TrackingRadar_0 := fn:data($node_TrackingRadar_0/@rdf:about)
    for $node_Weight_0 in $node_TrackingRadar_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) > xs:double("0.0"))]
  let $GRAPH_6 := xqllib:and($GRAPH_3,$GRAPH_5,("Var0"))
  let $GRAPH_7 := xqllib:optional($GRAPH_2,$GRAPH_6,("Weight_0"))
