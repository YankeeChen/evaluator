...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseDopplerRadarModulation_0 in $node_Quantity_0/Nuvio:hasProcessQuantity
