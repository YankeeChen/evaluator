...
let $result :=  
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) < xs:double("30.767416407136295"))]
  let $GRAPH_6 :=  
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("Entity_0","InformationRepresentation_0"))
