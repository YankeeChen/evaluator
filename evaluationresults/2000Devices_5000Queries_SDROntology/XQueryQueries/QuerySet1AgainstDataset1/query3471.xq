...
let $result :=  
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_15,$GRAPH_16,())
  let $GRAPH_18 := xqllib:and($GRAPH_4,$GRAPH_17,("Entity_0","InformationRepresentation_0"))
  ...
  let $GRAPH_24 := xqllib:and($GRAPH_0,$GRAPH_23,("USRPN310_0"))
  return
    $GRAPH_24
return
