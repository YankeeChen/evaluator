...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseRadar_0 in $node_Object_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Object_0 in $node_Ratio_0/RFDevice:hasGain
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("Ratio_0"))
