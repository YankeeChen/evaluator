...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_DirectConversionReceiver_0/Nuvio:aggregateOf
    let $value_ElectronicAttackSystem_0 := fn:data($node_ElectronicAttackSystem_0/@rdf:resource)
    where fn:exists($node_DirectConversionReceiver_0) and fn:exists($value_ElectronicAttackSystem_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    ...
    for $node_DirectConversionReceiver_0 in $node_Artix7FPGA_0/Nuvio:partOf
    let $value_DirectConversionReceiver_0 := fn:data($node_DirectConversionReceiver_0/@rdf:resource)
    where fn:exists($node_Artix7FPGA_0) and fn:exists($value_DirectConversionReceiver_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Artix7FPGA_0 in $node_Object_0/RFDevice:isProducerOf
    let $value_Artix7FPGA_0 := fn:data($node_Artix7FPGA_0/@rdf:resource)
    where fn:exists($value_Artix7FPGA_0) and fn:exists($node_Object_0)
    return
      <xqllib:result>
        <xqllib:var name="Artix7FPGA_0">{$value_Artix7FPGA_0}</xqllib:var>
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Object_0 in $node_StandoffJamming_0/Nuvio:participatesIn
  ...
  let $GRAPH_6 :=  
    ...
    for $node_StandoffJamming_0 in $node_Attribute_0/RFDevice:hasTransmitPowerRange
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("StandoffJamming_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_4,$GRAPH_7,("StandoffJamming_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_3,$GRAPH_8,("Object_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("Artix7FPGA_0"))
