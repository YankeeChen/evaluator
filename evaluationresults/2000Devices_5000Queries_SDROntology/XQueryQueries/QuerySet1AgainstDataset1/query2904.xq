...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var0 in $node_NoiseFigure_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("NoiseFigure_0"))
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_3,$GRAPH_12,("Attribute_0","Var0"))
