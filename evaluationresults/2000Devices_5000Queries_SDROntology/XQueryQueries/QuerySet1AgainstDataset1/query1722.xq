...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPN200_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Producer_instance388"]/RFDevice:hasProducer
