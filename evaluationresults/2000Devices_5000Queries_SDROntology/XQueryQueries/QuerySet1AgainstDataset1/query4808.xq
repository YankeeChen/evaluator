...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE3xx_0 := fn:data($node_USRPE3xx_0/@rdf:about)
    for $node_Var0 in $node_USRPE3xx_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_AntennaPolarization_0) and fn:exists($node_Var0) and $node_AntennaPolarization_0/RFDevice:hasPolarization/@rdf:resource = $value_Var0
    return
      <xqllib:result>
