...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_TrackingRadar_0 in $node_Object_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_FreqencyRange_0/RFDevice:hasFrequencyAccuracy
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) != 20.21)]
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_CommunicationsSystem_0/Nuvio:expresses
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("CommunicationsSystem_0"))
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("TrackingRadar_0"))
  return
    $GRAPH_13
return
