...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Satellite_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Moving_instance43"]/RFDevice:supportsSpectrumSensing
    let $value_Satellite_0 := fn:data($node_Satellite_0/@rdf:resource)
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_0,$GRAPH_5,("USRPN210_0"))
  return
    $GRAPH_6
return
