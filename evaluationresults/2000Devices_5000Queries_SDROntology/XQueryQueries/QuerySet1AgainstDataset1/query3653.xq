...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RadarWarningReceiver_0 in $node_Entity_0/RFDevice:hasChargingTime
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_Process_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("Attribute_0","Entity_0"))
