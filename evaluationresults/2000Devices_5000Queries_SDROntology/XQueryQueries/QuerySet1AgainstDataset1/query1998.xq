...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Entity_0 in $node_Power_0/RFDevice:hasPulseRepetitionFrequency
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) <= -1192375788)]
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("PulseRadar_0"))
  return
    $GRAPH_15
return
