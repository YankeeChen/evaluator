...
let $result :=  
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) > -1871170586)]
  let $GRAPH_13 :=  
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_9,$GRAPH_14,("UnitOfMeasure_0","Var0"))
  let $GRAPH_16 :=  
  ...
  let $GRAPH_18 := xqllib:optional($GRAPH_8,$GRAPH_17,("Var0"))
