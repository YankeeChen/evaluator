...
let $result :=  
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_3,$GRAPH_6,("EmitterLocationDetection_0"))
  let $GRAPH_8 :=  
  ...
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Power_15dBm"]/RFDevice:hasEffectiveRadiatedPower
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_10,$GRAPH_18,("Var0"))
  let $GRAPH_20 := ($GRAPH_7,$GRAPH_19)
