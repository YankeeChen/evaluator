...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200mini_i_0 in $node_Entity_0/RFDevice:hasWeight
  ...
  let $GRAPH_7 :=  
    ...
    let $value_InformationRepresentation_0 := fn:data($node_InformationRepresentation_0/@rdf:about)
    for $node_InformationEntity_0 in $node_InformationRepresentation_0/Nuvio:representedBy
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_0,$GRAPH_12,("USRPB200mini_i_0"))
  return
    $GRAPH_13
return
