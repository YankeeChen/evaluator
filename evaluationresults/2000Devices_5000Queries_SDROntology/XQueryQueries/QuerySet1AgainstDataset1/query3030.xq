...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_CumulativeDetection_0/Nuvio:participatesIn
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($node_CumulativeDetection_0) and fn:exists($value_Entity_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_4,$GRAPH_5,("CumulativeDetection_0"))
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("RadarWarningReceiver_0"))
