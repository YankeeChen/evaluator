...
let $result :=  
  ...
  let $GRAPH_9 :=  
    ...
    for $node_Situation_0 in $node_ContinuousWaveRadar_0/Nuvio:relevantIndividual
    let $value_Situation_0 := fn:data($node_Situation_0/@rdf:resource)
    where fn:exists($node_ContinuousWaveRadar_0) and fn:exists($value_Situation_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("ContinuousWaveRadar_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_8,$GRAPH_11,())
  let $GRAPH_13 := xqllib:and($GRAPH_3,$GRAPH_12,("Entity_0","Situation_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("Entity_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("RadioComponent_0"))
