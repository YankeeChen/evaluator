...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ContinuousWaveRadar_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Instance2210"]/Nuvio:subprocessOf
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_0,$GRAPH_5,("ContinuousWaveRadar_0"))
  return
    $GRAPH_6
return
