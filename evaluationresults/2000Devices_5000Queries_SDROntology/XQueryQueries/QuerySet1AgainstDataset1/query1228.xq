...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_210_0 in $node_Ship_0/RFDevice:isDeployedOn
    let $value_USRPB200_210_0 := fn:data($node_USRPB200_210_0/@rdf:resource)
    where fn:exists($node_Ship_0) and fn:exists($value_USRPB200_210_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Ship_0 in $node_Process_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("Ship_0"))
