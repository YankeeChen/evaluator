...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_DeceptiveCommunicationsJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    for $node_DeceptiveCommunicationsJamming_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Power_instance24"]/RFDevice:hasPulseRepetitionInterval
  ...
  let $GRAPH_4 := xqllib:and($GRAPH_2,$GRAPH_3,("DeceptiveCommunicationsJamming_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("DeceptiveCommunicationsJamming_0"))
