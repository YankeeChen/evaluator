...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseRadar_0 in $node_PulseRadarModulation_0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_TimeInterval_0/RFDevice:hasMaxSensedPower
