...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_Entity_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_4 :=  
    for $node_InformationEntity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#InformationEntity" and Nuvio:expresses/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#PulseRadarModulation_instance9"]
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:about)
