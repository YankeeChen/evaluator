...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_BlinkingJamming_0/RFDevice:hasCapability
  ...
  let $GRAPH_2 :=  
    ...
    for $node_BlinkingJamming_0 in $node_Attribute_0/RFDevice:hasPulseRepetitionFrequency
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("BlinkingJamming_0"))
