...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Full_DuplexCommunicationsSystem_0 in $node_Transmitting_0/RFDevice:hasCapability
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Transmitting_0 in $node_Attribute_0/RFDevice:hasPulseWidth
