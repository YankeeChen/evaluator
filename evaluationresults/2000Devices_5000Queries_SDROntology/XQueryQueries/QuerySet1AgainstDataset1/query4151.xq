...
let $result :=  
  ...
  let $GRAPH_10 :=  
    ...
    for $node_InformationRepresentation_0 in $node_Entity_1/Nuvio:representedBy
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_9,$GRAPH_10,("InformationRepresentation_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_1,$GRAPH_11,("Entity_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("CR_0"))
  return
    $GRAPH_13
return
