...
let $result :=  
  ...
  let $GRAPH_11 := $GRAPH_10[not(((data(xqllib:var[@name="DataValue0"]) >= xs:decimal("-180")) or (data(xqllib:var[@name="DataValue0"]) <= xs:decimal("180"))))]
  ...
  let $GRAPH_24 := xqllib:optional($GRAPH_0,$GRAPH_23,("JammingSystem_0"))
  return
    $GRAPH_24
return
