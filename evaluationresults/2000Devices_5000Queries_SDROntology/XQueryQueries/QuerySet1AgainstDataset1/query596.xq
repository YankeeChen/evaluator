...
let $result :=  
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("Attribute_0","Var0"))
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasFrequencyRange/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#FreqencyRange_instance101"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Var0)
    return
      <xqllib:result>
