...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_PulseRadarModulation_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_TimeInterval_0/RFDevice:hasPulseRepetitionInterval
