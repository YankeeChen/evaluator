...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var0 in $node_Var1/Nuvio:compositeOf
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Var1 in $node_Var2/RFDevice:hasVoltage
  ...
  let $GRAPH_13 :=  
    ...
    for $node_Entity_0 in $node_Height_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_2,$GRAPH_16,("Entity_0","Object_0"))
