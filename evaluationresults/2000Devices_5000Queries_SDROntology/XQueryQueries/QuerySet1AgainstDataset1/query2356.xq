...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RadarSystem_0 in $node_Entity_0/RFDevice:hasWeight
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) = -37.19)]
  let $GRAPH_6 :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue1"]) >= -937203341)]
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_0,$GRAPH_15,("RadarSystem_0"))
  return
    $GRAPH_16
return
