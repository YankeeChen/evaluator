...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) >= 20.04)]
  ...
  let $GRAPH_13 :=  
    ...
    for $node_Entity_0 in $node_Var3/Nuvio:hasValue
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($value_Entity_0) and fn:exists($node_Var3)
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_15 := $GRAPH_14[(data(xqllib:var[@name="DataValue1"]) != -229019926)]
  let $GRAPH_16 := xqllib:and($GRAPH_13,$GRAPH_15,("Var3"))
  let $GRAPH_17 := xqllib:and($GRAPH_12,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_11,$GRAPH_17,("Entity_0"))
  ...
  let $GRAPH_23 := xqllib:and($GRAPH_21,$GRAPH_22,("Producer_0"))
  let $GRAPH_24 := xqllib:optional($GRAPH_20,$GRAPH_23,("Var0"))
  let $GRAPH_25 := xqllib:and($GRAPH_3,$GRAPH_24,("Var0"))
  let $GRAPH_26 := xqllib:optional($GRAPH_2,$GRAPH_25,("Var0"))
