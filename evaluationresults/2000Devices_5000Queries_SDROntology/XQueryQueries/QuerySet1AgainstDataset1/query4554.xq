...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPE310_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#DirectConversionReceiver_instance56"]/Nuvio:aggregateOf
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("USRPE310_0"))
  return
    $GRAPH_2
return
