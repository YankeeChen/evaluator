...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_Entity_0/RFDevice:hasSamplingRate
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_Var0/RFDevice:supportsTuning
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_Entity_1/RFDevice:hasMaxSensedPower
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("PulseDopplerRadar_0"))
  return
    $GRAPH_12
return
