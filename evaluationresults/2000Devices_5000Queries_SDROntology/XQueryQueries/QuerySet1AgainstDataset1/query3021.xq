...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_Object_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[RFDevice:hasPolarization/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#HorizontalPolarization"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_0,$GRAPH_3,("USRPN3xx_0"))
  return
    $GRAPH_4
return
