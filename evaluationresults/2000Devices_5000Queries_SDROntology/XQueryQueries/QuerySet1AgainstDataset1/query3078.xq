...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB2xx_0 := fn:data($node_USRPB2xx_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB2xx_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_6 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Freq_30MHz"]/RFDevice:hasBandwidth
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_3,$GRAPH_7,("Var0"))
  let $GRAPH_9 := xqllib:and($GRAPH_2,$GRAPH_8,("InformationEntity_0"))
