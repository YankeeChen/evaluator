...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var0 in $node_FixedBandwidthSensing_0/Nuvio:hasSubprocess
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_7 :=  
    for $node_FixedBandwidthSensing_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#SpectrumSensing"]
    let $value_FixedBandwidthSensing_0 := fn:data($node_FixedBandwidthSensing_0/@rdf:about)
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("FixedBandwidthSensing_0"))
