...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Aircraft_0 in $doc_ObjectDescription
    let $value_Aircraft_0 := fn:data($node_Aircraft_0/@rdf:about)
    for $node_Entity_0 in $node_Aircraft_0/RFDevice:supportsTuning
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("Aircraft_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_1,$GRAPH_11,("Aircraft_0"))
