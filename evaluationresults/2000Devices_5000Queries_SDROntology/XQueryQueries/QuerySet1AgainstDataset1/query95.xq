...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ContinuousWaveRadar_0) and fn:exists($node_Entity_0) and $node_ContinuousWaveRadar_0/Nuvio:isExpressedBy/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 :=  
    ...
    for $node_ContinuousWaveRadar_0 in $node_Var1/RFDevice:supportsTuning
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:resource)
    where fn:exists($value_ContinuousWaveRadar_0) and fn:exists($node_Var1)
    return
      <xqllib:result>
        <xqllib:var name="ContinuousWaveRadar_0">{$value_ContinuousWaveRadar_0}</xqllib:var>
  ...
  let $GRAPH_11 :=  
    ...
    for $node_Var1 in $node_Quantity_0/RFDevice:hasBandwidth
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("Quantity_0"))
  let $GRAPH_14 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#AdjustableBandwidthSensing"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_15 :=  
    for $node_Var1 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#RadarFrequencyBand_instance119"]/RFDevice:hasBandwidthRange
    let $value_Var1 := fn:data($node_Var1/@rdf:resource)
  ...
  let $GRAPH_19 := xqllib:and($GRAPH_9,$GRAPH_18,("ContinuousWaveRadar_0"))
  let $GRAPH_20 := xqllib:optional($GRAPH_8,$GRAPH_19,("ContinuousWaveRadar_0"))
  let $GRAPH_21 := xqllib:optional($GRAPH_7,$GRAPH_20,("Entity_0"))
  let $GRAPH_22 := xqllib:and($GRAPH_1,$GRAPH_21,("Entity_0"))
  let $GRAPH_23 := xqllib:and($GRAPH_0,$GRAPH_22,("RadarSystem_0"))
  return
    $GRAPH_23
return
