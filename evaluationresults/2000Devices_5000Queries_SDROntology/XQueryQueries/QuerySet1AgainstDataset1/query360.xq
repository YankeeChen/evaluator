...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Instance1255"]/Nuvio:expresses
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Process_0 in $node_TimeInterval_0/RFDevice:hasMaxOutputPower
