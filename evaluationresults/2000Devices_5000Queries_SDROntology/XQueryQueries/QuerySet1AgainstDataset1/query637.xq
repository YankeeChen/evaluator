...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SDR_0 in $node_InstantaneousFrequencyMeasurementReceiver_0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyAccuracy
