...
let $result :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) != 852578823)]
  ...
  let $GRAPH_15 :=  
    ...
    for $node_Entity_0 in $node_AntennaPolarization_0/RFDevice:hasPolarization
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_22 := xqllib:and($GRAPH_0,$GRAPH_21,("ElectronicSupportSystem_0"))
  return
    $GRAPH_22
return
