...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_BistaticRadar_0 := fn:data($node_BistaticRadar_0/@rdf:about)
    for $node_Entity_0 in $node_BistaticRadar_0/RFDevice:isProducerOf
  ...
  let $GRAPH_4 := $GRAPH_3[(data(xqllib:var[@name="DataValue0"]) < -33.95)]
  let $GRAPH_5 :=  
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_0,$GRAPH_10,("BistaticRadar_0"))
  return
    $GRAPH_11
return
