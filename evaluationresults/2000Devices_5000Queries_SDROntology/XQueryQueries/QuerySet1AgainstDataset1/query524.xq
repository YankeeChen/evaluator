...
let $result :=  
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) = -99.77)]
  ...
  let $GRAPH_20 :=  
    ...
    for $node_Var0 in $node_Var2/Nuvio:hasUnitOfMeasure
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_22 := ($GRAPH_18,$GRAPH_21)
  let $GRAPH_23 :=  
  ...
  let $GRAPH_25 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Power_0 in $node_Var0/RFDevice:hasLength
    let $value_Power_0 := fn:data($node_Power_0/@rdf:resource)
    where fn:exists($value_Power_0) and fn:exists($node_Var0)
    return
      <xqllib:result>
  ...
  let $GRAPH_27 := ($GRAPH_13,$GRAPH_26)
  let $GRAPH_28 :=  
  ...
  let $GRAPH_29 := xqllib:and($GRAPH_27,$GRAPH_28,("InformationContent_0","Var0"))
  let $GRAPH_30 := xqllib:and($GRAPH_11,$GRAPH_29,("Power_0","Var0"))
  let $GRAPH_31 := xqllib:and($GRAPH_1,$GRAPH_30,("Var0"))
  let $GRAPH_32 := xqllib:and($GRAPH_0,$GRAPH_31,("Full_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_32
return
