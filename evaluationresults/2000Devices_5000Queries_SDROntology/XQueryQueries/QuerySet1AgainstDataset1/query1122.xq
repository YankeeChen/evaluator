...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_TrackingRadar_0 in $node_RadioComponent_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_RadioComponent_0 in $node_XilinxZynq7000Family_0/Nuvio:partOf
  ...
  let $GRAPH_4 :=  
    for $node_XilinxZynq7000Family_0 in $doc_ObjectDescription
    let $value_XilinxZynq7000Family_0 := fn:data($node_XilinxZynq7000Family_0/@rdf:about)
    for $node_ParabolicDishAntenna_0 in $node_XilinxZynq7000Family_0/Nuvio:aggregateOf
    let $value_ParabolicDishAntenna_0 := fn:data($node_ParabolicDishAntenna_0/@rdf:resource)
    where fn:exists($value_ParabolicDishAntenna_0) and fn:exists($node_XilinxZynq7000Family_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("ParabolicDishAntenna_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("XilinxZynq7000Family_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("RadioComponent_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_1,$GRAPH_8,("RadioComponent_0"))
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("TrackingRadar_0"))
  return
    $GRAPH_10
return
