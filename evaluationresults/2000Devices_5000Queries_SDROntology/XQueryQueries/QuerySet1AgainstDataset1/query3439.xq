...
let $result :=  
  ...
  let $GRAPH_12 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Weight_instance49"]/RFDevice:hasPulseWidth
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_0,$GRAPH_16,("PulseDopplerRadar_0"))
  return
    $GRAPH_17
return
