...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN300_0 := fn:data($node_USRPN300_0/@rdf:about)
    for $node_XilinxZynq7000Family_0 in $node_USRPN300_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    for $node_XilinxZynq7000Family_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Producer_instance42"]/RFDevice:isProducerOf
    let $value_XilinxZynq7000Family_0 := fn:data($node_XilinxZynq7000Family_0/@rdf:resource)
