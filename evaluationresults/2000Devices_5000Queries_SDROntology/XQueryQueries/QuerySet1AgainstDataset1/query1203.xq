...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_Entity_0/RFDevice:hasHeight
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,())
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("Entity_0","InformationRepresentation_0"))
