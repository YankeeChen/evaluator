...
let $result :=  
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) > -61.75)]
  let $GRAPH_9 := xqllib:optional($GRAPH_6,$GRAPH_8,("Var0"))
  let $GRAPH_10 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Minute"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_4,$GRAPH_12,("Time_0"))
