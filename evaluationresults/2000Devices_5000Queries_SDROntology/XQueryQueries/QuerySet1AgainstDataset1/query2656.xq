...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPX310_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#GroundPlatform_instance20"]/RFDevice:isDeployedOn
