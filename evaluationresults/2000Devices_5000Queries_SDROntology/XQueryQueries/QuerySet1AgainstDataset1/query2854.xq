...
let $result :=  
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) > -638207305)]
  let $GRAPH_7 := xqllib:optional($GRAPH_4,$GRAPH_6,())
  let $GRAPH_8 := ($GRAPH_3,$GRAPH_7)
  let $GRAPH_9 := xqllib:and($GRAPH_1,$GRAPH_8,("Entity_0"))
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("USRPX3xx_0"))
  return
    $GRAPH_10
return
