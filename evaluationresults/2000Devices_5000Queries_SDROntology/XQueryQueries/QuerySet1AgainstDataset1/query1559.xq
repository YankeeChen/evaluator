...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_PulseDopplerRadar_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#InstantaneousFrequencyMeasurementReceiver_instance59"]/Nuvio:aggregateOf
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("PulseDopplerRadar_0"))
  return
    $GRAPH_2
return
