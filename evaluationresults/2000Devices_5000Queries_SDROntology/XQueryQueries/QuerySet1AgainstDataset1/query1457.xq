...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_CommunicationsSystem_0 in $node_Receiving_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Receiving_0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyAccuracy
