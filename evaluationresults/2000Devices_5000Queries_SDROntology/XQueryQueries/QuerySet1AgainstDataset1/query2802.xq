...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN310_0 := fn:data($node_USRPN310_0/@rdf:about)
    for $node_Var0 in $node_USRPN310_0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasLevel/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#Freq_125MHz"]
