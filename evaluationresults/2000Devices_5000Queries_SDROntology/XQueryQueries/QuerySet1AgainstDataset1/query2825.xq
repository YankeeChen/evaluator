...
let $result :=  
  ...
  let $GRAPH_10 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and Nuvio:hasProcessQuantity/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Power_instance6"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_12,$GRAPH_13,("InformationContent_0"))
