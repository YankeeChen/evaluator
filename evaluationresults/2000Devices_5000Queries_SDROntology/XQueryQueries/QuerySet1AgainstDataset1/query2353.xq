...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Satellite_0 in $node_Entity_0/RFDevice:hasCapability
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_Receiver_0/Nuvio:compositeOf
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("Receiver_0"))
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_2,$GRAPH_16,("Satellite_0"))
