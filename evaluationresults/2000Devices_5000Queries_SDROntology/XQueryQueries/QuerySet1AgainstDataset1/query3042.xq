...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_210_0 in $node_XilinxFPGA_0/Nuvio:compositeOf
  ...
  let $GRAPH_3 :=  
    for $node_XilinxFPGA_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#XC6SLX150FPGA_instance18"]/Nuvio:compositeOf
