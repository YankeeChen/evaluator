...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_PulseRadar_0 := fn:data($node_PulseRadar_0/@rdf:about)
    for $node_Process_0 in $node_PulseRadar_0/RFDevice:supportsTuning
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_PhaseShiftKeyingModulation_0) and fn:exists($node_Process_0) and $node_PhaseShiftKeyingModulation_0/Nuvio:subprocessOf/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
