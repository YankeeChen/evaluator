...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_USRPB200mini_0 in $node_Entity_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_5 :=  
    ...
    let $value_USRPB200mini_0 := fn:data($node_USRPB200mini_0/@rdf:about)
    for $node_Var0 in $node_USRPB200mini_0/RFDevice:hasCenterFrequency
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("USRPB200mini_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("USRPB200mini_0"))
  let $GRAPH_8 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
