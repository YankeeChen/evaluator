...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    where fn:exists($node_InformationEntity_0) and fn:exists($node_UnmannedPlatform_0) and $node_UnmannedPlatform_0/Nuvio:isExpressedBy/@rdf:resource = $value_InformationEntity_0
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_3,$GRAPH_7,("InformationEntity_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_2,$GRAPH_8,("InformationContent_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_1,$GRAPH_9,("Entity_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_0,$GRAPH_10,("CR_0"))
  return
    $GRAPH_11
return
