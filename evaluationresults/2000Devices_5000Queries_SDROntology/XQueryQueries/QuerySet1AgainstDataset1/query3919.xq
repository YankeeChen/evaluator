...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Half_DuplexCommunicationsSystem_0 in $node_Jammer_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    for $node_Object_0 in $doc_ObjectDescription[Nuvio:hasObjectQuality/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription2000.owl#AntennaPolarization_instance15"]
