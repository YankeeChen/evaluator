...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Situation_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#GNURadio_instance20"]/Nuvio:relevantIndividual
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("Situation_0"))
