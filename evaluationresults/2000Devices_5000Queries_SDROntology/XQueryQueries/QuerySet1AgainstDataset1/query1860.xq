...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPB210_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#GroundPlatform_instance40"]/RFDevice:isDeployedOn
