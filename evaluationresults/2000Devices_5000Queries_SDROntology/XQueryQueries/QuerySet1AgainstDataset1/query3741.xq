...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE3xx_0 in $node_IEDTrigger_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_IEDTrigger_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_5 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_UnitOfMeasure_0) and $node_UnitOfMeasure_0/RFDevice:supportsTransmitting/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("InformationUnit_0"))
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_2,$GRAPH_11,("IEDTrigger_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_1,$GRAPH_12,("IEDTrigger_0"))
