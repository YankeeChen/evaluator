...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE310_0 := fn:data($node_USRPE310_0/@rdf:about)
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_USRPE310_0/Nuvio:compositeOf
    ...
    where fn:exists($value_InstantaneousFrequencyMeasurementReceiver_0) and fn:exists($node_USRPE310_0)
    return
      <xqllib:result>
