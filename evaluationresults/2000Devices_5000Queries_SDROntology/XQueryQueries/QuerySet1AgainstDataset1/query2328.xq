...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN200_0 := fn:data($node_USRPN200_0/@rdf:about)
    for $node_Object_0 in $node_USRPN200_0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_CoverJamming_0) and fn:exists($node_Object_0) and $node_CoverJamming_0/RFDevice:supportsJamming/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
