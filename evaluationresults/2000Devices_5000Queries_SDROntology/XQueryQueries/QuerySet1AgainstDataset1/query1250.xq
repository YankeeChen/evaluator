...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_BistaticRadar_0 in $node_PulseRadarModulation_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_Entity_0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("PulseRadarModulation_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("PulseRadarModulation_0"))
