...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_RadioFrequencyBand_0 in $node_Voltage_0/RFDevice:hasMin
    let $value_RadioFrequencyBand_0 := fn:data($node_RadioFrequencyBand_0/@rdf:resource)
    where fn:exists($value_RadioFrequencyBand_0) and fn:exists($node_Voltage_0)
    return
      <xqllib:result>
        <xqllib:var name="RadioFrequencyBand_0">{$value_RadioFrequencyBand_0}</xqllib:var>
  ...
  let $GRAPH_11 := $GRAPH_10[(data(xqllib:var[@name="DataValue0"]) > -273492186)]
  let $GRAPH_12 := xqllib:and($GRAPH_9,$GRAPH_11,("Var1"))
  let $GRAPH_13 := xqllib:and($GRAPH_8,$GRAPH_12,("Var1"))
  let $GRAPH_14 := xqllib:and($GRAPH_7,$GRAPH_13,("Voltage_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_6,$GRAPH_14,("Voltage_0"))
  let $GRAPH_16 := ($GRAPH_5,$GRAPH_15)
  let $GRAPH_17 := xqllib:and($GRAPH_3,$GRAPH_16,("RadioFrequencyBand_0"))
