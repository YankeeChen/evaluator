...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_Attribute_0) and fn:exists($node_Var1) and $node_Attribute_0/Nuvio:isExpressedBy/@rdf:resource = $value_Var1
    return
      <xqllib:result>
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_5,$GRAPH_12,("Attribute_0","Var1"))
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_0,$GRAPH_16,("USRPB2xx_0"))
  return
    $GRAPH_17
return
