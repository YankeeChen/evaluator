...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_DRFMJamming_0/Nuvio:hasParticipant
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_6,$GRAPH_7,("DRFMJamming_0"))
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPN210_0"))
  return
    $GRAPH_12
return
