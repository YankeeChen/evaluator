...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Receiving_0 in $node_Entity_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_5 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_RadarModulation_0 in $node_Entity_0/Nuvio:hasSubprocess
    let $value_RadarModulation_0 := fn:data($node_RadarModulation_0/@rdf:resource)
    where fn:exists($node_Entity_0) and fn:exists($value_RadarModulation_0)
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_13 := $GRAPH_12[(data(xqllib:var[@name="DataValue0"]) > -2039259169)]
  let $GRAPH_14 :=  
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_11,$GRAPH_15,("UnitOfMeasure_0","Value_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_10,$GRAPH_16,("Value_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_3,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_2,$GRAPH_18,("Receiving_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_1,$GRAPH_19,("Receiving_0"))
