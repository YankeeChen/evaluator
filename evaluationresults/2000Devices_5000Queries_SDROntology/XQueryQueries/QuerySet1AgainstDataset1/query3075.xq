...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_FPGA_0 in $node_Entity_0/Nuvio:partOf
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) <= -440923106)]
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_2,$GRAPH_14,("FPGA_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_1,$GRAPH_15,("FPGA_0"))
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("USRPB200mini_0"))
  return
    $GRAPH_17
return
