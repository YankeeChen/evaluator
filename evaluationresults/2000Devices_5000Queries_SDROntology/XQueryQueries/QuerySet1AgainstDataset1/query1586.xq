...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN200_0 := fn:data($node_USRPN200_0/@rdf:about)
    for $node_Var0 in $node_USRPN200_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription2000.owl#Producer_instance274"]/RFDevice:isProducerOf
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Var1/RFDevice:hasHeight
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Var2 in $node_Var0/RFDevice:hasResolution
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_0,$GRAPH_7,("USRPN200_0"))
  return
    $GRAPH_8
return
