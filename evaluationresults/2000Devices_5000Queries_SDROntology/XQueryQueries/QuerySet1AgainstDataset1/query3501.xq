...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX3xx_0 := fn:data($node_USRPX3xx_0/@rdf:about)
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_USRPX3xx_0/Nuvio:compositeOf
    ...
    where fn:exists($value_InstantaneousFrequencyMeasurementReceiver_0) and fn:exists($node_USRPX3xx_0)
    return
      <xqllib:result>
