...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Jammer_0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_4,$GRAPH_10,("RadarFrequencyBand_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_3,$GRAPH_11,("RadarFrequencyBand_0"))
  let $GRAPH_13 := xqllib:optional($GRAPH_2,$GRAPH_12,("Jammer_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_1,$GRAPH_13,("Jammer_0"))
