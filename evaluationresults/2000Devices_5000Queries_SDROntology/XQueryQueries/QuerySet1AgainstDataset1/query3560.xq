...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB205mini_i_0 := fn:data($node_USRPB205mini_i_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB205mini_i_0/RFDevice:isProducerOf
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) >= -763759165)]
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Entity_0 in $node_PulseDopplerRadarModulation_0/Nuvio:participatesIn
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("PulseDopplerRadarModulation_0"))
