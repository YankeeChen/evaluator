...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Var0) and $node_Var0/Nuvio:hasProcessQuality/@rdf:resource = $value_Var0
    return
      <xqllib:result>
        <xqllib:var name="Var0">{$value_Var0}</xqllib:var>
      </xqllib:result>
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Var0 in $node_USRPN200_0/Nuvio:relevantIndividual
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
    where fn:exists($node_USRPN200_0) and fn:exists($value_Var0)
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("USRPN200_0"))
  let $GRAPH_11 :=  
  ...
  let $GRAPH_14 := $GRAPH_13[(data(xqllib:var[@name="DataValue0"]) != 467763220)]
  let $GRAPH_15 := xqllib:optional($GRAPH_12,$GRAPH_14,("Var0"))
  let $GRAPH_16 := xqllib:and($GRAPH_11,$GRAPH_15,("Var0"))
  let $GRAPH_17 := xqllib:optional($GRAPH_10,$GRAPH_16,("Var0"))
  let $GRAPH_18 := xqllib:and($GRAPH_7,$GRAPH_17,("Var0"))
  let $GRAPH_19 := ($GRAPH_3,$GRAPH_18)
  let $GRAPH_20 := xqllib:and($GRAPH_1,$GRAPH_19,("Var0"))
  let $GRAPH_21 := xqllib:and($GRAPH_0,$GRAPH_20,("CR_0"))
  return
    $GRAPH_21
return
