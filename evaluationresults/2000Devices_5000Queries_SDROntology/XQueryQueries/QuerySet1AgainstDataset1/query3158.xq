...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_Entity_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_11 :=  
    ...
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:about)
    for $node_MultiCurve_0 in $node_InformationEntity_0/Nuvio:isExpressedBy
    let $value_MultiCurve_0 := fn:data($node_MultiCurve_0/@rdf:resource)
    where fn:exists($node_InformationEntity_0) and fn:exists($value_MultiCurve_0)
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_11,$GRAPH_12,("MultiCurve_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_10,$GRAPH_13,("InformationEntity_0"))
