...
let $result :=  
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) = 624330791)]
  ...
  let $GRAPH_13 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Var1 in $node_Var0/RFDevice:hasHeight
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("USRPB210_0"))
  return
    $GRAPH_16
return
