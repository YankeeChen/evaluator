...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200mini_i_0 := fn:data($node_USRPB200mini_i_0/@rdf:about)
    for $node_Object_0 in $node_USRPB200mini_i_0/Nuvio:aggregateOf
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($value_Object_0) and fn:exists($node_USRPB200mini_i_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    where fn:exists($node_Attribute_0) and fn:exists($node_Object_0) and $node_Attribute_0/Nuvio:participatesIn/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
