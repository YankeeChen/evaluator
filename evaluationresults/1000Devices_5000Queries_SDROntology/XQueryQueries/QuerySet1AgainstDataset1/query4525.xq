...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_AutomaticGainControl_0) and fn:exists($node_Var0) and $node_AutomaticGainControl_0/Nuvio:relevantIndividual/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := $GRAPH_10[(data(xqllib:var[@name="DataValue0"]) <= 1729235788)]
  ...
  let $GRAPH_16 := xqllib:optional($GRAPH_5,$GRAPH_15,("Var0"))
