...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_PulseDopplerRadar_0 := fn:data($node_PulseDopplerRadar_0/@rdf:about)
    for $node_Entity_0 in $node_PulseDopplerRadar_0/RFDevice:hasProducer
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#ARMProcessor"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("Component_0"))
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_15,$GRAPH_16,("UnitOfMeasure_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_1,$GRAPH_17,("Entity_0"))
  let $GRAPH_19 := xqllib:optional($GRAPH_0,$GRAPH_18,("PulseDopplerRadar_0"))
  return
    $GRAPH_19
return
