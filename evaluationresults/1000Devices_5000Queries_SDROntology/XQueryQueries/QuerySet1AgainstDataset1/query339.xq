...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN310_0 := fn:data($node_USRPN310_0/@rdf:about)
    for $node_Entity_0 in $node_USRPN310_0/RFDevice:hasVoltage
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_UnitOfMeasure_0 in $node_Entity_0/Nuvio:participatesIn
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_9,$GRAPH_15,("InformationEntity_0"))
  let $GRAPH_17 := xqllib:and($GRAPH_8,$GRAPH_16,("InformationRepresentation_0"))
