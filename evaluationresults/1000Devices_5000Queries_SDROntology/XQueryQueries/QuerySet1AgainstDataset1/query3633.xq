...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX300_0 in $node_Receiver_0/Nuvio:compositeOf
    let $value_USRPX300_0 := fn:data($node_USRPX300_0/@rdf:resource)
    where fn:exists($node_Receiver_0) and fn:exists($value_USRPX300_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Receiver_0 in $node_Object_0/RFDevice:hasFrequencyAccuracy
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Object_0 in $node_NoiseJamming_0/RFDevice:hasCapability
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($node_NoiseJamming_0) and fn:exists($value_Object_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_5 :=  
    ...
    for $node_NoiseJamming_0 in $node_Quantity_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_3,$GRAPH_6,("NoiseJamming_0"))
