...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_Half_DuplexCommunicationsSystem_0 := fn:data($node_Half_DuplexCommunicationsSystem_0/@rdf:about)
    for $node_Object_0 in $node_Half_DuplexCommunicationsSystem_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Object_0 in $node_DeceptiveCommunicationsJamming_0/Nuvio:participatesIn
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
  ...
  let $GRAPH_4 :=  
    ...
    for $node_DeceptiveCommunicationsJamming_0 in $node_Power_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) < 41.23)]
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_3,$GRAPH_11,("DeceptiveCommunicationsJamming_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_2,$GRAPH_12,("DeceptiveCommunicationsJamming_0"))
