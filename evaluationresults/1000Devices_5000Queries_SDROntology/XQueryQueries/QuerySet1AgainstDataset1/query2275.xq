...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_Var0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_Entity_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_3,$GRAPH_9,("Entity_0","InformationRepresentation_0"))
