...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX3xx_0 in $node_Var0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[RFDevice:hasResolution/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#Data_14bit"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
