...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_BistaticRadar_0 in $node_Aircraft_0/RFDevice:isDeployedOn
    let $value_BistaticRadar_0 := fn:data($node_BistaticRadar_0/@rdf:resource)
    where fn:exists($node_Aircraft_0) and fn:exists($value_BistaticRadar_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Aircraft_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_7,$GRAPH_10,("Entity_0","InformationContent_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_3,$GRAPH_11,("Entity_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_2,$GRAPH_12,("Aircraft_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_1,$GRAPH_13,("Aircraft_0"))
