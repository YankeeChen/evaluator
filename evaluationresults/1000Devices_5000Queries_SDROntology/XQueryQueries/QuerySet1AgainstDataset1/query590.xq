...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN310_0 in $node_Processor_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    for $node_Processor_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Instance1387"]/Nuvio:compositeOf
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("Processor_0"))
