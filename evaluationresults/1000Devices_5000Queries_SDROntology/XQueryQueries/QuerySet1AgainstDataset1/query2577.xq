...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Length_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("Length_0"))
  let $GRAPH_6 :=  
  ...
  let $GRAPH_7 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Power_15dBm"]/Nuvio:hasProcessQuantity
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
