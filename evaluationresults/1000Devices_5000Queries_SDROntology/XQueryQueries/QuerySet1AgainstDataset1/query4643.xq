...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN310_0 in $node_Var0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Freq_122_88MHz"]/RFDevice:hasWeight
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("USRPN310_0"))
  return
    $GRAPH_9
return
