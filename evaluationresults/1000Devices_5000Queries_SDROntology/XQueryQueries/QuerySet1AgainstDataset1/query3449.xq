...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_Entity_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_5 := $GRAPH_4[(data(xqllib:var[@name="DataValue0"]) <= xs:double("73.48361"))]
  let $GRAPH_6 :=  
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_0,$GRAPH_9,("USRPX310_0"))
  return
    $GRAPH_10
return
