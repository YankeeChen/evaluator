...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ModelX_0 := fn:data($node_ModelX_0/@rdf:about)
    for $node_InstantaneousFrequencyMeasurementReceiver_0 in $node_ModelX_0/Nuvio:aggregateOf
    ...
    where fn:exists($value_InstantaneousFrequencyMeasurementReceiver_0) and fn:exists($node_ModelX_0)
    return
      <xqllib:result>
