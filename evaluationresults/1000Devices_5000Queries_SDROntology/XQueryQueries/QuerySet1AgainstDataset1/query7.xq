...
let $result :=  
  ...
  let $GRAPH_5 :=  
    for $node_Value_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#WeightUnit_instance6"]/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_7 := $GRAPH_6[(data(xqllib:var[@name="DataValue0"]) > 2094283639)]
  ...
  let $GRAPH_11 := xqllib:optional($GRAPH_0,$GRAPH_10,("RFSystem_0"))
  return
    $GRAPH_11
return
