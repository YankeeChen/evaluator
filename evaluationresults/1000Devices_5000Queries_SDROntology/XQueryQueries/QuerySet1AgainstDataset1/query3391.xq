...
let $result :=  
  ...
  let $GRAPH_7 :=  
    for $node_QuantityRange_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/SDR.owl#Time_120min"]/RFDevice:hasMin
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("TrackingRadar_0"))
  return
    $GRAPH_17
return
