...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_BistaticRadar_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#ContinuousWaveRadarModulation_instance4"]/RFDevice:hasCapability
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("BistaticRadar_0"))
  return
    $GRAPH_2
return
