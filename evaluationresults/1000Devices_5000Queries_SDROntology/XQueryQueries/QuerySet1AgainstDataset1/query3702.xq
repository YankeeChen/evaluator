...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_RFSystem_0 in $node_IEDTrigger_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_IEDTrigger_0 in $node_Transceiving_0/RFDevice:hasCapability
  ...
  let $GRAPH_5 :=  
    for $node_Transceiving_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPB205mini-i"]
    let $value_Transceiving_0 := fn:data($node_Transceiving_0/@rdf:about)
    where fn:exists($node_Transceiving_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_6 :=  
    for $node_Transceiving_0 in $doc_ObjectDescription
    let $value_Transceiving_0 := fn:data($node_Transceiving_0/@rdf:about)
    for $node_Var0 in $node_Transceiving_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("Transceiving_0"))
  let $GRAPH_8 :=  
    for $node_Transceiving_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#NoiseFigure"]
    let $value_Transceiving_0 := fn:data($node_Transceiving_0/@rdf:about)
    where fn:exists($node_Transceiving_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_7,$GRAPH_8,("Transceiving_0"))
  let $GRAPH_10 :=  
    for $node_Transceiving_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object"]
    let $value_Transceiving_0 := fn:data($node_Transceiving_0/@rdf:about)
    where fn:exists($node_Transceiving_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("Transceiving_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_4,$GRAPH_11,("Transceiving_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_3,$GRAPH_12,("Transceiving_0"))
  let $GRAPH_14 := xqllib:optional($GRAPH_2,$GRAPH_13,("IEDTrigger_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("IEDTrigger_0"))
