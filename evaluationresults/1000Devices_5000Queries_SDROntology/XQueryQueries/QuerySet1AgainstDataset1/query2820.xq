...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    for $node_Entity_0 in $node_Modulation_0/Nuvio:relevantIndividual
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("Modulation_0"))
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_5,$GRAPH_12,("Entity_0","UnitOfMeasure_0"))
