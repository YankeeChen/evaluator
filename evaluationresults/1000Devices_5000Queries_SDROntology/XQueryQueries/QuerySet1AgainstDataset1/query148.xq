...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_PulseRadarModulation_0 in $doc_ObjectDescription
    let $value_PulseRadarModulation_0 := fn:data($node_PulseRadarModulation_0/@rdf:about)
    for $node_Entity_0 in $node_PulseRadarModulation_0/RFDevice:hasMaxSensedPower
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("PulseRadarModulation_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_1,$GRAPH_8,("PulseRadarModulation_0"))
