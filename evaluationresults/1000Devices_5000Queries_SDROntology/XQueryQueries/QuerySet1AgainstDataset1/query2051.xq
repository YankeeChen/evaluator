...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE313_0 in $node_XilinxZynq7020SoC_0/Nuvio:aggregateOf
  ...
  let $GRAPH_4 :=  
    for $node_XilinxZynq7020SoC_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Artix7FPGA_instance1"]/Nuvio:partOf
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_1,$GRAPH_5,("XilinxZynq7020SoC_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_0,$GRAPH_6,("USRPE313_0"))
  return
    $GRAPH_7
return
