...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ElectronicAttackSystem_0 := fn:data($node_ElectronicAttackSystem_0/@rdf:about)
    for $node_Entity_0 in $node_ElectronicAttackSystem_0/Nuvio:partOf
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/RFDevice.owl#Half-Duplex"]/Nuvio:hasParticipant
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Object_0 in $node_Entity_0/RFDevice:hasBandwidthRange
  ...
  let $GRAPH_8 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_Entity_0) and $doc_ObjectDescription[@rdf:ID = "USRPN300_instance18"]/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
      </xqllib:result>
  let $GRAPH_9 :=  
    ...
    for $node_Entity_0 in $node_SuperheterodyneReceiver_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_11 :=  
    ...
    for $node_SuperheterodyneReceiver_0 in $node_Object_1/RFDevice:hasFrequencyRange
    let $value_SuperheterodyneReceiver_0 := fn:data($node_SuperheterodyneReceiver_0/@rdf:resource)
    where fn:exists($node_Object_1) and fn:exists($value_SuperheterodyneReceiver_0)
    return
      <xqllib:result>
        <xqllib:var name="Object_1">{$value_Object_1}</xqllib:var>
        <xqllib:var name="SuperheterodyneReceiver_0">{$value_SuperheterodyneReceiver_0}</xqllib:var>
      </xqllib:result>
  let $GRAPH_12 := xqllib:optional($GRAPH_10,$GRAPH_11,("SuperheterodyneReceiver_0"))
  let $GRAPH_13 := xqllib:and($GRAPH_9,$GRAPH_12,("SuperheterodyneReceiver_0"))
  ...
  let $GRAPH_22 := $GRAPH_21[(data(xqllib:var[@name="DataValue0"]) < -880334083)]
  let $GRAPH_23 :=  
  ...
  let $GRAPH_25 := xqllib:and($GRAPH_20,$GRAPH_24,("Entity_0","VelocityUnit_0"))
  let $GRAPH_26 := xqllib:and($GRAPH_19,$GRAPH_25,("Entity_0"))
