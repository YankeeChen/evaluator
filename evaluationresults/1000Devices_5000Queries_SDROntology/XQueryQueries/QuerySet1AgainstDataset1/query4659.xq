...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and RFDevice:hasPolarization/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#AntennaPolarization_instance7"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
