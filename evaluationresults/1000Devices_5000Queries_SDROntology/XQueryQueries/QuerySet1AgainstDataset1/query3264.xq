...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_RadarJammer_0/Nuvio:compositeOf
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_6 :=  
    ...
    for $node_RadarJammer_0 in $node_BarrageJamming_0/RFDevice:hasCapability
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_3,$GRAPH_7,("RadarJammer_0"))
  ...
  let $GRAPH_13 := xqllib:and($GRAPH_0,$GRAPH_12,("USRPN210_0"))
  return
    $GRAPH_13
return
