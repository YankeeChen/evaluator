...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB2xxmini_0 in $node_Entity_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_12,$GRAPH_13,("Entity_0","Var2"))
  ...
  let $GRAPH_18 :=  
    ...
    for $node_InformationEntity_0 in $node_OffsetCurve_0/Nuvio:isExpressedBy
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:resource)
    where fn:exists($value_InformationEntity_0) and fn:exists($node_OffsetCurve_0)
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
  ...
  let $GRAPH_20 := xqllib:optional($GRAPH_18,$GRAPH_19,("OffsetCurve_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_17,$GRAPH_20,("InformationEntity_0"))
  let $GRAPH_22 := xqllib:and($GRAPH_1,$GRAPH_21,("Entity_0"))
  let $GRAPH_23 := xqllib:and($GRAPH_0,$GRAPH_22,("USRPB2xxmini_0"))
  return
    $GRAPH_23
return
