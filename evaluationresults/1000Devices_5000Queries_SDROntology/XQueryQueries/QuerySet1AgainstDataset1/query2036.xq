...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ElectronicSupport_0) and fn:exists($node_Entity_0) and $node_ElectronicSupport_0/RFDevice:hasCapability/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_0,$GRAPH_8,("GNURadio_0"))
  return
    $GRAPH_9
return
