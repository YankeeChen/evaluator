...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#IEDTrigger_instance13"]/Nuvio:compositeOf
  ...
  let $GRAPH_8 := xqllib:optional($GRAPH_0,$GRAPH_7,("USRPE3xx_0"))
  return
    $GRAPH_8
return
