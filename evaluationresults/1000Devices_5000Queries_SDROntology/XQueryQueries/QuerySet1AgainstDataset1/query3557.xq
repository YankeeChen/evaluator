...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB2xxmini_0 := fn:data($node_USRPB2xxmini_0/@rdf:about)
    for $node_Object_0 in $node_USRPB2xxmini_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[Nuvio:hasObjectQuality/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#AntennaPolarization_instance10"]
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_0,$GRAPH_3,("USRPB2xxmini_0"))
  return
    $GRAPH_4
return
