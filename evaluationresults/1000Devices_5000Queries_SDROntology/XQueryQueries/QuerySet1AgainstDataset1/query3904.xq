...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Object_0 in $node_PulseRadarModulation_0/Nuvio:hasParticipant
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("Frequency_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_5,$GRAPH_8,("Frequency_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_4,$GRAPH_9,("PulseRadarModulation_0"))
