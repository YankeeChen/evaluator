...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Processor"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("LatitudeValueInDegree_0"))
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_0,$GRAPH_15,("RadarWarningReceiver_0"))
  return
    $GRAPH_16
return
