...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE310_0 in $node_Var0/Nuvio:partOf
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_AdjustableBandwidthSensing_0) and fn:exists($node_Var0) and $node_AdjustableBandwidthSensing_0/Nuvio:participatesIn/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("USRPE310_0"))
  return
    $GRAPH_9
return
