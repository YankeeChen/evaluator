...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB205mini_i_0 in $node_Entity_0/Nuvio:partOf
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_2,$GRAPH_14,("Entity_0","InformationContent_0"))
  let $GRAPH_16 := xqllib:and($GRAPH_1,$GRAPH_15,("Entity_0"))
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("USRPB205mini_i_0"))
  return
    $GRAPH_17
return
