...
let $result :=  
  ...
  let $GRAPH_10 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#TriangulatedSurface"]
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_8,$GRAPH_11,("InformationEntity_0"))
