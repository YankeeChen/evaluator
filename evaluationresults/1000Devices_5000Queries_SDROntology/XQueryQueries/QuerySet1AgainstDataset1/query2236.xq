...
let $result :=  
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = 11.19)]
  let $GRAPH_7 :=  
  ...
  let $GRAPH_12 :=  
    for $node_Var2 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#PositiveFloatValue"]
    let $value_Var2 := fn:data($node_Var2/@rdf:about)
  ...
  let $GRAPH_13 :=  
    ...
    for $node_Var2 in $node_Entity_1/Nuvio:hasUnitOfMeasure
    let $value_Var2 := fn:data($node_Var2/@rdf:resource)
    where fn:exists($node_Entity_1) and fn:exists($value_Var2)
    return
      <xqllib:result>
  ...
  let $GRAPH_20 := xqllib:and($GRAPH_7,$GRAPH_19,("Entity_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_6,$GRAPH_20,("Var1"))
  let $GRAPH_22 := xqllib:and($GRAPH_4,$GRAPH_21,("Var1"))
  let $GRAPH_23 := xqllib:and($GRAPH_3,$GRAPH_22,("Power_0"))
  let $GRAPH_24 := xqllib:and($GRAPH_2,$GRAPH_23,("Power_0"))
  let $GRAPH_25 := xqllib:and($GRAPH_1,$GRAPH_24,("Var0"))
  let $GRAPH_26 := xqllib:and($GRAPH_0,$GRAPH_25,("USRPB2xx_0"))
  return
    $GRAPH_26
return
