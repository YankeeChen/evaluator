...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_Var1 in $node_Entity_0/Nuvio:isExpressedBy
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_TimeInstant_0) and fn:exists($node_Var0) and $node_TimeInstant_0/RFDevice:hasPulseWidth/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:and($GRAPH_4,$GRAPH_5,("TimeInstant_0"))
  ...
  let $GRAPH_10 :=  
    for $node_Var1 in $doc_ObjectDescription
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    for $node_Entity_1 in $node_Var1/Nuvio:hasUnitOfMeasure
  ...
  let $GRAPH_16 := xqllib:and($GRAPH_2,$GRAPH_15,("Entity_0","Var1"))
