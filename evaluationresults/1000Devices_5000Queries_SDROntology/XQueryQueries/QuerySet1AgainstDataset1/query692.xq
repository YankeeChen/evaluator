...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ModelX_0 := fn:data($node_ModelX_0/@rdf:about)
    for $node_Object_0 in $node_ModelX_0/RFDevice:isDeployedOn
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_AmplitudeModulation_0) and fn:exists($node_Object_0) and $node_AmplitudeModulation_0/RFDevice:hasCapability/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
