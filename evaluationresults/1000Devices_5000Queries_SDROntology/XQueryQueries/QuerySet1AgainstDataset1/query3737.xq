...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_CR_0 := fn:data($node_CR_0/@rdf:about)
    for $node_Object_0 in $node_CR_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_InformationEntity_0) and fn:exists($node_Object_0) and $node_InformationEntity_0/RFDevice:supportsSpectrumSensing/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
