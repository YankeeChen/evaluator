...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ModelX_0 := fn:data($node_ModelX_0/@rdf:about)
    for $node_Var0 in $node_ModelX_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and Nuvio:hasSubprocess/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Instance869"]
