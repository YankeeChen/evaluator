...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX310_0 := fn:data($node_USRPX310_0/@rdf:about)
    for $node_Entity_0 in $node_USRPX310_0/Nuvio:aggregateOf
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) != -357771597)]
  let $GRAPH_7 := ($GRAPH_4,$GRAPH_6)
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("Value_0"))
