...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN210_0 in $node_XC3SD3400AFPGA_0/Nuvio:compositeOf
    let $value_USRPN210_0 := fn:data($node_USRPN210_0/@rdf:resource)
    where fn:exists($value_USRPN210_0) and fn:exists($node_XC3SD3400AFPGA_0)
    return
      <xqllib:result>
        <xqllib:var name="USRPN210_0">{$value_USRPN210_0}</xqllib:var>
  ...
  let $GRAPH_2 :=  
    for $node_XC3SD3400AFPGA_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Instance259"]/Nuvio:aggregateOf
  ...
  let $GRAPH_3 := xqllib:and($GRAPH_1,$GRAPH_2,("XC3SD3400AFPGA_0"))
