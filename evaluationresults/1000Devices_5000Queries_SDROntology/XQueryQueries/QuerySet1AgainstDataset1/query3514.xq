...
let $result :=  
  ...
  let $GRAPH_7 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_Sphere_0) and fn:exists($node_Var0) and $node_Sphere_0/RFDevice:hasTarget/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_21 := xqllib:and($GRAPH_0,$GRAPH_20,("RadarSystem_0"))
  return
    $GRAPH_21
return
