...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPN3xx_0 in $node_Object_0/RFDevice:isProducerOf
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Object" and Nuvio:participatesIn/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Instance1221"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
