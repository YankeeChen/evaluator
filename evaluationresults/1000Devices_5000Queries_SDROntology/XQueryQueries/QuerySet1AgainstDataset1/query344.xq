...
let $result :=  
  ...
  let $GRAPH_10 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_USRPB2xx_0) and $node_USRPB2xx_0/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_14 := xqllib:optional($GRAPH_0,$GRAPH_13,("MonostaticRadar_0"))
  return
    $GRAPH_14
return
