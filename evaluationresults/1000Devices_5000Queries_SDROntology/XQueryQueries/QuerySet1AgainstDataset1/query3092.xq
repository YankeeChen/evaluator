...
let $result :=  
  ...
  let $GRAPH_10 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#USRPB200mini_instance0"]/Nuvio:hasParticipant
