...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_Entity_0/Nuvio:hasObjectQuantity
  ...
  let $GRAPH_3 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Power_instance11"]/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_9 := $GRAPH_8[(data(xqllib:var[@name="DataValue0"]) >= xs:decimal("82"))]
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("SurveillanceRadar_0"))
  return
    $GRAPH_15
return
