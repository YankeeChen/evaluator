...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var1 in $node_Frequency_0/RFDevice:hasPulseRepetitionFrequency
  ...
  let $GRAPH_8 :=  
    for $node_Frequency_0 in $doc_ObjectDescription
    let $value_Frequency_0 := fn:data($node_Frequency_0/@rdf:about)
    for $node_Var2 in $node_Frequency_0/Nuvio:hasValue
    let $value_Var2 := fn:data($node_Var2/@rdf:resource)
    where fn:exists($node_Frequency_0) and fn:exists($value_Var2)
    return
      <xqllib:result>
        <xqllib:var name="Frequency_0">{$value_Frequency_0}</xqllib:var>
        <xqllib:var name="Var2">{$value_Var2}</xqllib:var>
      </xqllib:result>
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("Frequency_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_6,$GRAPH_9,("Frequency_0"))
  let $GRAPH_11 :=  
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_5,$GRAPH_12,("Var1"))
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_15,$GRAPH_16,("InformationRepresentation_0"))
  let $GRAPH_18 :=  
  ...
  let $GRAPH_21 := xqllib:optional($GRAPH_0,$GRAPH_20,("MonostaticRadar_0"))
  return
    $GRAPH_21
return
