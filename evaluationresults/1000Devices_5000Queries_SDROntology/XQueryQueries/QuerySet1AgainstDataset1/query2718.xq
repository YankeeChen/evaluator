...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Half_DuplexCommunicationsSystem_0 in $node_Entity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Var0/RFDevice:hasSamplingRate
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) < 1217334752)]
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_0,$GRAPH_12,("Half_DuplexCommunicationsSystem_0"))
  return
    $GRAPH_13
return
