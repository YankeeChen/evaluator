...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPN300_0 := fn:data($node_USRPN300_0/@rdf:about)
    for $node_Var0 in $node_USRPN300_0/Nuvio:compositeOf
  ...
  let $GRAPH_4 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#BSpline"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_0,$GRAPH_8,("USRPN300_0"))
  return
    $GRAPH_9
return
