...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Var0 in $node_Quantity_0/RFDevice:hasMax
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_12 :=  
    ...
    for $node_Var0 in $node_StandoffJamming_0/Nuvio:participatesIn
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_13 :=  
    for $node_StandoffJamming_0 in $doc_ObjectDescription
    let $value_StandoffJamming_0 := fn:data($node_StandoffJamming_0/@rdf:about)
    for $node_Attribute_0 in $node_StandoffJamming_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_19 := xqllib:and($GRAPH_17,$GRAPH_18,("Value_0"))
