...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ModelX_0 in $node_Weight_0/RFDevice:hasBeamwidth
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = -2060697512)]
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("ModelX_0"))
  return
    $GRAPH_12
return
