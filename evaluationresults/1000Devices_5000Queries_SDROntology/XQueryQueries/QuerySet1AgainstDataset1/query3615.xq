...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[RFDevice:hasPolarization/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#AntennaPolarization_instance10"]
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
