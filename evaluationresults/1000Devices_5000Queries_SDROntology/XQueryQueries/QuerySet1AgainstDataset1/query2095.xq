...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_USRPB200mini_0 in $doc_ObjectDescription[RFDevice:hasChargingTime/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Weight_instance27"]
    let $value_USRPB200mini_0 := fn:data($node_USRPB200mini_0/@rdf:about)
    where fn:exists($node_USRPB200mini_0)
    return
      <xqllib:result>
