...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE313_0 in $node_Object_0/RFDevice:hasProducer
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Object_0 := fn:data($node_Object_0/@rdf:about)
    where fn:exists($node_EmitterLocationDetection_0) and fn:exists($node_Object_0) and $node_EmitterLocationDetection_0/Nuvio:participatesIn/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Var0 in $node_Object_1/RFDevice:isDeployedOn
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
    where fn:exists($node_Object_1) and fn:exists($value_Var0)
    return
      <xqllib:result>
