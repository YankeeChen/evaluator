...
let $result :=  
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue1"]) > 86.55)]
  ...
  let $GRAPH_14 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_ADC_0) and fn:exists($node_Entity_0) and $node_ADC_0/RFDevice:hasTarget/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
