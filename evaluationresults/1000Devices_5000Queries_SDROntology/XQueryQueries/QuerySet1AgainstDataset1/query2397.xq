...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB205mini_i_0 in $node_Object_0/Nuvio:aggregateOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Object_0 in $node_ContinuousWaveRadarModulation_0/RFDevice:supportsTuning
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
    where fn:exists($node_ContinuousWaveRadarModulation_0) and fn:exists($value_Object_0)
    return
      <xqllib:result>
