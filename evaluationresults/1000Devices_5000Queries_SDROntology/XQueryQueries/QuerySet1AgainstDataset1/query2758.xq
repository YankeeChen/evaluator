...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Var0 in $node_Quantity_1/RFDevice:hasBandwidth
  ...
  let $GRAPH_10 :=  
    ...
    for $node_Var0 in $node_LongitudeValueInDegree_0/Nuvio:hasValue
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
  ...
  let $GRAPH_11 :=  
    for $node_LongitudeValueInDegree_0 in $doc_ObjectDescription
    let $value_LongitudeValueInDegree_0 := fn:data($node_LongitudeValueInDegree_0/@rdf:about)
    for $node_DataValue0 in $node_LongitudeValueInDegree_0/Nuvio:hasPrecision
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) < 1126852048)]
  let $GRAPH_13 := xqllib:and($GRAPH_10,$GRAPH_12,("LongitudeValueInDegree_0"))
  ...
  let $GRAPH_17 := xqllib:optional($GRAPH_0,$GRAPH_16,("USRPB2xxmini_0"))
  return
    $GRAPH_17
return
