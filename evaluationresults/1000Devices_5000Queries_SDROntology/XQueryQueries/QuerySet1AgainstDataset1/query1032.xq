...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200mini_0 := fn:data($node_USRPB200mini_0/@rdf:about)
    for $node_Entity_0 in $node_USRPB200mini_0/Nuvio:compositeOf
  ...
  let $GRAPH_4 := $GRAPH_3[(data(xqllib:var[@name="DataValue0"]) = 297930879)]
  let $GRAPH_5 := xqllib:and($GRAPH_2,$GRAPH_4,("Entity_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_1,$GRAPH_5,("Entity_0"))
  let $GRAPH_7 := xqllib:and($GRAPH_0,$GRAPH_6,("USRPB200mini_0"))
  return
    $GRAPH_7
return
