...
let $result :=  
  ...
  let $GRAPH_1 :=  
    for $node_JammingSystem_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#NoiseJamming_instance0"]/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 := xqllib:optional($GRAPH_0,$GRAPH_1,("JammingSystem_0"))
  return
    $GRAPH_2
return
