...
let $result :=  
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Var0 in $node_InformationEntity_0/RFDevice:supportsTuning
  ...
  let $GRAPH_9 :=  
    ...
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:about)
    where fn:exists($node_InformationEntity_0) and $doc_ObjectDescription[@rdf:ID = "Instance353"]/Nuvio:expresses/@rdf:resource = $value_InformationEntity_0
    return
      <xqllib:result>
        <xqllib:var name="InformationEntity_0">{$value_InformationEntity_0}</xqllib:var>
      </xqllib:result>
  ...
  let $GRAPH_14 := $GRAPH_13[(data(xqllib:var[@name="DataValue0"]) > -1273655867)]
  ...
  let $GRAPH_22 := xqllib:and($GRAPH_17,$GRAPH_21,("Var0"))
