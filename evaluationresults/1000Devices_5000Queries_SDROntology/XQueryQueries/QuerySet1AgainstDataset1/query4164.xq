...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_FixedBandwidthSensing_0) and fn:exists($node_Var0) and $node_FixedBandwidthSensing_0/Nuvio:hasSubprocess/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_SpatialVolumeUnit_0) and fn:exists($node_Var0) and $node_SpatialVolumeUnit_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_8 := $GRAPH_7[(data(xqllib:var[@name="DataValue0"]) >= 1685265684)]
  ...
  let $GRAPH_11 := xqllib:and($GRAPH_9,$GRAPH_10,("SpatialVolumeUnit_0"))
  let $GRAPH_12 :=  
  ...
  let $GRAPH_19 := xqllib:optional($GRAPH_2,$GRAPH_18,("Var0"))
