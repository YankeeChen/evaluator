...
let $result :=  
  ...
  let $GRAPH_6 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_InformationEntity_0) and $node_InformationEntity_0/Nuvio:hasSubprocess/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_9 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Power_0 in $node_Var0/RFDevice:hasTransmitPowerRange
  ...
  let $GRAPH_15 := $GRAPH_14[(data(xqllib:var[@name="DataValue0"]) = 204663668)]
  let $GRAPH_16 := xqllib:optional($GRAPH_13,$GRAPH_15,("Var0"))
  let $GRAPH_17 := xqllib:and($GRAPH_12,$GRAPH_16,("Var0"))
  let $GRAPH_18 := xqllib:optional($GRAPH_7,$GRAPH_17,("Var0"))
  let $GRAPH_19 := xqllib:optional($GRAPH_6,$GRAPH_18,("InformationEntity_0"))
  let $GRAPH_20 :=  
  ...
  let $GRAPH_22 :=  
    for $node_Var1 in $doc_ObjectDescription
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    for $node_DataValue1 in $node_Var1/RFDevice:hasFloatValue
  ...
  let $GRAPH_23 := $GRAPH_22[not((data(xqllib:var[@name="DataValue1"]) >= xs:decimal("0")))]
  let $GRAPH_24 := xqllib:and($GRAPH_21,$GRAPH_23,("Var1"))
  let $GRAPH_25 := xqllib:and($GRAPH_20,$GRAPH_24,("Entity_0"))
  let $GRAPH_26 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#PulseDopplerRadar_instance21"]/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_27 := xqllib:and($GRAPH_25,$GRAPH_26,("Entity_0"))
  let $GRAPH_28 :=  
    for $node_Entity_0 in $doc_ObjectDescription
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_InboundRangeGatePullOffJamming_0 in $node_Entity_0/Nuvio:participatesIn
    let $value_InboundRangeGatePullOffJamming_0 := fn:data($node_InboundRangeGatePullOffJamming_0/@rdf:resource)
    where fn:exists($node_Entity_0) and fn:exists($value_InboundRangeGatePullOffJamming_0)
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_30 := xqllib:and($GRAPH_28,$GRAPH_29,("InboundRangeGatePullOffJamming_0"))
  let $GRAPH_31 := xqllib:optional($GRAPH_27,$GRAPH_30,("Entity_0"))
  let $GRAPH_32 := xqllib:and($GRAPH_19,$GRAPH_31,("Entity_0"))
  let $GRAPH_33 := xqllib:and($GRAPH_5,$GRAPH_32,("Entity_0"))
  let $GRAPH_34 := xqllib:and($GRAPH_2,$GRAPH_33,("Entity_0"))
  let $GRAPH_35 := xqllib:and($GRAPH_1,$GRAPH_34,("Entity_0"))
  let $GRAPH_36 := xqllib:and($GRAPH_0,$GRAPH_35,("USRPX300_0"))
  return
    $GRAPH_36
return
