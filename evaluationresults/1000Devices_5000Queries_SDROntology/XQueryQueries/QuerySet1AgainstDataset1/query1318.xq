...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPE310_0 in $node_Entity_0/RFDevice:hasProducer
  ...
  let $GRAPH_7 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_Modulator_0) and $node_Modulator_0/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_9 :=  
    for $node_Modulator_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#XC6SLX75FPGA_instance27"]/Nuvio:aggregateOf
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_8,$GRAPH_9,("Modulator_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_7,$GRAPH_10,("Modulator_0"))
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_0,$GRAPH_14,("USRPE310_0"))
  return
    $GRAPH_15
return
