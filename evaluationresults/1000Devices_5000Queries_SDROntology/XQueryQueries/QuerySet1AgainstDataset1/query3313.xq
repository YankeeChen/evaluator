...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Var0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Producer_instance5"]/RFDevice:hasProducer
  ...
  let $GRAPH_12 :=  
    for $node_Situation_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#USRPB200mini_instance23"]/Nuvio:relevantIndividual
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_6,$GRAPH_13,("Entity_0","Situation_0"))
