...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_Jamming_0) and fn:exists($node_Object_0) and $node_Jamming_0/Nuvio:participatesIn/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Jamming_0 in $node_Quantity_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("Jamming_0"))
