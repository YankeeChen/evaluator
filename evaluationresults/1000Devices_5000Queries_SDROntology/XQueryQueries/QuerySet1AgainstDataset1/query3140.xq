...
let $result :=  
  ...
  let $GRAPH_7 := xqllib:optional($GRAPH_5,$GRAPH_6,("DigitalModulation_0"))
  ...
  let $GRAPH_10 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/SDR.owl#USRPN210"]
