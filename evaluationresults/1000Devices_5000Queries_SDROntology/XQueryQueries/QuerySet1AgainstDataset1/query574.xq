...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_TerrainBounceJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    ...
    for $node_TerrainBounceJamming_0 in $node_Attribute_0/RFDevice:hasPulseWidth
    let $value_TerrainBounceJamming_0 := fn:data($node_TerrainBounceJamming_0/@rdf:resource)
    where fn:exists($node_Attribute_0) and fn:exists($value_TerrainBounceJamming_0)
    return
      <xqllib:result>
