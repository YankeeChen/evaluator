...
let $result :=  
  ...
  let $GRAPH_4 :=  
    for $node_Entity_0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://cogradio.org/ont/Nuvio.owl#Process" and Nuvio:hasSubprocess/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Instance291"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
