...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_CrossEyeJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_2 :=  
    ...
    for $node_CrossEyeJamming_0 in $node_Entity_0/RFDevice:hasMaxOutputPower
