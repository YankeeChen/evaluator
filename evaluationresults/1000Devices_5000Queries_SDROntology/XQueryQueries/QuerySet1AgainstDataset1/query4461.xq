...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Full_DuplexCommunicationsSystem_0 in $node_Entity_0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_Entity_1/Nuvio:compositeOf
  ...
  let $GRAPH_11 := $GRAPH_10[(data(xqllib:var[@name="DataValue0"]) != -1441921350)]
