...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ElectronicSupportSystem_0 := fn:data($node_ElectronicSupportSystem_0/@rdf:about)
    for $node_Entity_0 in $node_ElectronicSupportSystem_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_12 := $GRAPH_11[not((data(xqllib:var[@name="DataValue0"]) <= xs:decimal("100")))]
