...
let $result :=  
  ...
  let $GRAPH_17 := $GRAPH_16[(data(xqllib:var[@name="DataValue0"]) >= 328688546)]
  let $GRAPH_18 := ($GRAPH_15,$GRAPH_17)
  let $GRAPH_19 := xqllib:and($GRAPH_7,$GRAPH_18,("Entity_0"))
  let $GRAPH_20 := xqllib:and($GRAPH_6,$GRAPH_19,("RadioFrequencyBand_0"))
  let $GRAPH_21 := xqllib:and($GRAPH_5,$GRAPH_20,("RadioFrequencyBand_0"))
  let $GRAPH_22 := ($GRAPH_4,$GRAPH_21)
