...
let $result :=  
  ...
  let $GRAPH_4 :=  
    ...
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_Distance_0) and fn:exists($node_Var1) and $node_Distance_0/RFDevice:hasVoltage/@rdf:resource = $value_Var1
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_4,$GRAPH_5,("Distance_0"))
  ...
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPE3xx_0"))
  return
    $GRAPH_12
return
