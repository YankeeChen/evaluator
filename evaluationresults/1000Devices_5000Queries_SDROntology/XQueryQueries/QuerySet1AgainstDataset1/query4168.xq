...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_Full_DuplexCommunicationsSystem_0 := fn:data($node_Full_DuplexCommunicationsSystem_0/@rdf:about)
    for $node_Entity_0 in $node_Full_DuplexCommunicationsSystem_0/Nuvio:aggregateOf
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Entity_0 in $node_Velocity_0/Nuvio:relevantIndividual
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("Velocity_0"))
