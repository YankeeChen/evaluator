...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Var0 in $node_Frequency_0/Nuvio:hasProcessQuantity
  ...
  let $GRAPH_5 :=  
    ...
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_Process_0) and fn:exists($node_Var1) and $node_Process_0/Nuvio:isExpressedBy/@rdf:resource = $value_Var1
    return
      <xqllib:result>
  ...
  let $GRAPH_8 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/gml#TriangulatedSurface"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
  ...
  let $GRAPH_9 :=  
    for $node_Var1 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#DataSize"]
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_Var1)
    return
      <xqllib:result>
  ...
  let $GRAPH_15 := xqllib:and($GRAPH_3,$GRAPH_14,("Frequency_0"))
  let $GRAPH_16 :=  
  ...
  let $GRAPH_18 := xqllib:optional($GRAPH_16,$GRAPH_17,("Var0"))
