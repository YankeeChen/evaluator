...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_ElectronicAttackSystem_0 := fn:data($node_ElectronicAttackSystem_0/@rdf:about)
    for $node_Entity_0 in $node_ElectronicAttackSystem_0/RFDevice:hasWeight
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) >= xs:decimal("-90"))]
  ...
  let $GRAPH_14 := xqllib:and($GRAPH_12,$GRAPH_13,("AmplitudeModulation_0"))
