...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_Entity_0/RFDevice:hasChargingTime
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Detection_0/Nuvio:subprocessOf
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
    where fn:exists($node_Detection_0) and fn:exists($value_Entity_0)
    return
      <xqllib:result>
