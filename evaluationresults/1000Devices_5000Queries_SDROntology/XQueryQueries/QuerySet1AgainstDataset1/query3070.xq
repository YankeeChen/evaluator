...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_InboundRangeGatePullOffJamming_0/Nuvio:subprocessOf
    let $value_Var0 := fn:data($node_Var0/@rdf:resource)
    where fn:exists($node_InboundRangeGatePullOffJamming_0) and fn:exists($value_Var0)
    return
      <xqllib:result>
