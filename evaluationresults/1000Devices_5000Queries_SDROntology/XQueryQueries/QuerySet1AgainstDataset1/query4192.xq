...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    where fn:exists($node_ElectricCharge_0) and fn:exists($node_Var0) and $node_ElectricCharge_0/RFDevice:hasPulseRepetitionFrequency/@rdf:resource = $value_Var0
    return
      <xqllib:result>
  ...
  let $GRAPH_10 := xqllib:and($GRAPH_3,$GRAPH_9,("ElectricCharge_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_2,$GRAPH_10,("ElectricCharge_0"))
