...
let $result :=  
  ...
  let $GRAPH_6 := $GRAPH_5[(data(xqllib:var[@name="DataValue0"]) = -67.15)]
  ...
  let $GRAPH_16 := $GRAPH_15[(data(xqllib:var[@name="DataValue1"]) != -269968000)]
  let $GRAPH_17 := xqllib:optional($GRAPH_14,$GRAPH_16,("Entity_0"))
  let $GRAPH_18 :=  
