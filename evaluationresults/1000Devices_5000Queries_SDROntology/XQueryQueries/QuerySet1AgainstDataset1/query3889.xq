...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_EmitterLocationDetection_0 in $doc_ObjectDescription
    let $value_EmitterLocationDetection_0 := fn:data($node_EmitterLocationDetection_0/@rdf:about)
    for $node_Var0 in $node_EmitterLocationDetection_0/RFDevice:hasTarget
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("EmitterLocationDetection_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("EmitterLocationDetection_0"))
