...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Var0 in $doc_ObjectDescription
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
    for $node_Quantity_0 in $node_Var0/RFDevice:hasBandwidth
  ...
  let $GRAPH_8 :=  
    ...
    for $node_Var0 in $node_Object_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_12 := xqllib:and($GRAPH_6,$GRAPH_11,("Quantity_0","Var0"))
