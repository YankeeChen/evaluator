...
let $result :=  
  ...
  let $GRAPH_6 :=  
    for $node_Entity_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#ModelX_instance9"]/Nuvio:partOf
  ...
  let $GRAPH_11 :=  
    for $node_Var0 in $doc_ObjectDescription[Nuvio:hasUnitOfMeasure/@rdf:resource = "http://ece.neu.edu/ontologies/RFDevice.owl#Decibel"]
    let $value_Var0 := fn:data($node_Var0/@rdf:about)
