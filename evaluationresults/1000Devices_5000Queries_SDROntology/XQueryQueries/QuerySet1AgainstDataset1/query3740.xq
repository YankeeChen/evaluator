...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_RFSystem_0 := fn:data($node_RFSystem_0/@rdf:about)
    for $node_Object_0 in $node_RFSystem_0/RFDevice:isProducerOf
  ...
  let $GRAPH_2 :=  
    for $node_Object_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#SweptSpotJamming_instance0"]/RFDevice:supportsSpectrumSensing
    let $value_Object_0 := fn:data($node_Object_0/@rdf:resource)
