...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPE313_0 := fn:data($node_USRPE313_0/@rdf:about)
    for $node_Object_0 in $node_USRPE313_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Percentage_0 in $node_Object_0/RFDevice:hasHeight
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("Percentage_0"))
