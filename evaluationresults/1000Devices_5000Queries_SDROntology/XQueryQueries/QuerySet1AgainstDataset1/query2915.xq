...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Receiving_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#RadioFrequencyBand_instance57"]/RFDevice:hasFrequencyAccuracy
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_0,$GRAPH_5,("ModelX_0"))
  return
    $GRAPH_6
return
