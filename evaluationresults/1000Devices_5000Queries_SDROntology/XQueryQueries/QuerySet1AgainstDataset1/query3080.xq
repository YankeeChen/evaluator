...
let $result :=  
  ...
  let $GRAPH_2 :=  
    for $node_Submarine_0 in $doc_ObjectDescription[RFDevice:supportsTuning/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Moving_instance16"]
    let $value_Submarine_0 := fn:data($node_Submarine_0/@rdf:about)
