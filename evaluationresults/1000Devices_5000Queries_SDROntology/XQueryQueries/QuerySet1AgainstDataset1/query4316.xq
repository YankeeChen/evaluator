...
let $result :=  
  ...
  let $GRAPH_5 :=  
    ...
    for $node_Var0 in $node_RadarFrequencyBand_0/RFDevice:hasFrequencyRange
  ...
  let $GRAPH_12 := $GRAPH_11[(data(xqllib:var[@name="DataValue0"]) >= 1624585469)]
  ...
  let $GRAPH_17 := xqllib:and($GRAPH_6,$GRAPH_16,("RadarFrequencyBand_0"))
  let $GRAPH_18 := xqllib:and($GRAPH_5,$GRAPH_17,("RadarFrequencyBand_0"))
  let $GRAPH_19 := xqllib:and($GRAPH_4,$GRAPH_18,("Var0"))
  let $GRAPH_20 := ($GRAPH_3,$GRAPH_19)
  let $GRAPH_21 := xqllib:and($GRAPH_1,$GRAPH_20,("Var0"))
  let $GRAPH_22 := xqllib:and($GRAPH_0,$GRAPH_21,("USRPE310_0"))
  return
    $GRAPH_22
return
