...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPX3xx_0 := fn:data($node_USRPX3xx_0/@rdf:about)
    for $node_RadioComponent_0 in $node_USRPX3xx_0/Nuvio:partOf
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:resource)
    where fn:exists($value_RadioComponent_0) and fn:exists($node_USRPX3xx_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_8 :=  
    for $node_RadioComponent_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Producer_instance69"]/RFDevice:isProducerOf
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:resource)
  ...
  let $GRAPH_9 := xqllib:and($GRAPH_7,$GRAPH_8,("RadioComponent_0"))
