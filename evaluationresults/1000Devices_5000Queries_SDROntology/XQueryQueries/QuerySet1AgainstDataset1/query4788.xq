...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_TrackingRadar_0 in $node_PulseDopplerRadarModulation_0/RFDevice:supportsTuning
  ...
  let $GRAPH_4 :=  
    for $node_PulseDopplerRadarModulation_0 in $doc_ObjectDescription
    let $value_PulseDopplerRadarModulation_0 := fn:data($node_PulseDopplerRadarModulation_0/@rdf:about)
    for $node_Time_0 in $node_PulseDopplerRadarModulation_0/RFDevice:hasPulseRepetitionInterval
