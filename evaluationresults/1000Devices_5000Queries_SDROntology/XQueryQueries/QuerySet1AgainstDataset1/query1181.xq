...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPX310_0 in $node_Entity_0/Nuvio:aggregateOf
  ...
  let $GRAPH_3 :=  
    ...
    for $node_Entity_0 in $node_ContinuousWaveRadar_0/Nuvio:expresses
  ...
  let $GRAPH_5 :=  
    for $node_ContinuousWaveRadar_0 in $doc_ObjectDescription
    let $value_ContinuousWaveRadar_0 := fn:data($node_ContinuousWaveRadar_0/@rdf:about)
    for $node_IEDTrigger_0 in $node_ContinuousWaveRadar_0/Nuvio:partOf
    let $value_IEDTrigger_0 := fn:data($node_IEDTrigger_0/@rdf:resource)
    where fn:exists($node_ContinuousWaveRadar_0) and fn:exists($value_IEDTrigger_0)
    return
      <xqllib:result>
        <xqllib:var name="ContinuousWaveRadar_0">{$value_ContinuousWaveRadar_0}</xqllib:var>
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_4,$GRAPH_7,("ContinuousWaveRadar_0"))
  let $GRAPH_9 := xqllib:and($GRAPH_3,$GRAPH_8,("ContinuousWaveRadar_0"))
