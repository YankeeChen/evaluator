...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_PulseDopplerRadar_0 in $node_PulseRadarModulation_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_2 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_Entity_0/RFDevice:hasPulseRepetitionInterval
  ...
  let $GRAPH_4 :=  
    ...
    where fn:exists($node_Entity_0) and fn:exists($node_Length_0) and $node_Length_0/RFDevice:hasBeamwidth/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
        <xqllib:var name="Entity_0">{$value_Entity_0}</xqllib:var>
  ...
  let $GRAPH_6 :=  
    ...
    for $node_Length_0 in $node_Var0/Nuvio:hasValue
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_5,$GRAPH_6,("Length_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_4,$GRAPH_7,("Length_0"))
  let $GRAPH_9 :=  
  ...
  let $GRAPH_13 := xqllib:optional($GRAPH_3,$GRAPH_12,("Attribute_0","Entity_0"))
  let $GRAPH_14 := xqllib:and($GRAPH_2,$GRAPH_13,("Entity_0"))
  let $GRAPH_15 := xqllib:and($GRAPH_1,$GRAPH_14,("PulseRadarModulation_0"))
  let $GRAPH_16 := xqllib:optional($GRAPH_0,$GRAPH_15,("PulseDopplerRadar_0"))
  return
    $GRAPH_16
return
