...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_RadarJamming_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_2 :=  
    ...
    for $node_RadarJamming_0 in $node_Attribute_0/RFDevice:hasMaxOutputPower
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_1,$GRAPH_4,("RadarJamming_0"))
