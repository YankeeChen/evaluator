...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_InformationEntity_0/Nuvio:isExpressedBy
  ...
  let $GRAPH_3 :=  
    ...
    let $value_InformationEntity_0 := fn:data($node_InformationEntity_0/@rdf:about)
    where fn:exists($node_ElectronicSupport_0) and fn:exists($node_InformationEntity_0) and $node_ElectronicSupport_0/Nuvio:expresses/@rdf:resource = $value_InformationEntity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_5 := xqllib:and($GRAPH_3,$GRAPH_4,("ElectronicSupport_0"))
  let $GRAPH_6 := xqllib:and($GRAPH_2,$GRAPH_5,("InformationEntity_0"))
  let $GRAPH_7 :=  
