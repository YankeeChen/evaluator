...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_SurveillanceRadar_0 := fn:data($node_SurveillanceRadar_0/@rdf:about)
    for $node_Process_0 in $node_SurveillanceRadar_0/RFDevice:hasCapability
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_LineStringSegment_0) and fn:exists($node_Process_0) and $node_LineStringSegment_0/RFDevice:hasTarget/@rdf:resource = $value_Process_0
    return
      <xqllib:result>
