...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ElectronicAttackSystem_0 in $node_RangeGatePullOffJamming_0/RFDevice:supportsJamming
  ...
  let $GRAPH_3 :=  
    ...
    for $node_RangeGatePullOffJamming_0 in $node_Power_0/RFDevice:hasEffectiveRadiatedPower
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_1,$GRAPH_6,("RangeGatePullOffJamming_0"))
