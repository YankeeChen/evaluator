...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    where fn:exists($node_TimeUnit_0) and fn:exists($node_Value_0) and $node_TimeUnit_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Value_0
    return
      <xqllib:result>
  ...
  let $GRAPH_6 := xqllib:optional($GRAPH_2,$GRAPH_5,("Value_0"))
