...
let $result :=  
  ...
  let $GRAPH_5 := xqllib:optional($GRAPH_3,$GRAPH_4,("FrequencyUnit_0"))
  let $GRAPH_6 :=  
  ...
  let $GRAPH_15 := $GRAPH_14[not((data(xqllib:var[@name="DataValue0"]) > xs:double("0.0")))]
  let $GRAPH_16 := ($GRAPH_13,$GRAPH_15)
  let $GRAPH_17 := xqllib:and($GRAPH_9,$GRAPH_16,("Var0"))
  let $GRAPH_18 := xqllib:optional($GRAPH_8,$GRAPH_17,("Entity_0"))
