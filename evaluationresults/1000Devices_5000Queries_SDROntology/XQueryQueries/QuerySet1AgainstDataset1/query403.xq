...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_SurveillanceRadar_0 in $node_PulseRadarModulation_0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    ...
    for $node_PulseRadarModulation_0 in $node_Quantity_0/RFDevice:hasPulseRepetitionFrequency
