...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    let $value_USRPB200_210_0 := fn:data($node_USRPB200_210_0/@rdf:about)
    for $node_Object_0 in $node_USRPB200_210_0/Nuvio:compositeOf
  ...
  let $GRAPH_2 :=  
    ...
    where fn:exists($node_ElectronicSupport_0) and fn:exists($node_Object_0) and $node_ElectronicSupport_0/Nuvio:hasParticipant/@rdf:resource = $value_Object_0
    return
      <xqllib:result>
