...
let $result :=  
  ...
  let $GRAPH_3 := $GRAPH_2[(data(xqllib:var[@name="DataValue0"]) > -2102052912)]
  let $GRAPH_4 := xqllib:and($GRAPH_1,$GRAPH_3,("Entity_0"))
  let $GRAPH_5 := xqllib:and($GRAPH_0,$GRAPH_4,("ElectronicSupportSystem_0"))
  return
    $GRAPH_5
return
