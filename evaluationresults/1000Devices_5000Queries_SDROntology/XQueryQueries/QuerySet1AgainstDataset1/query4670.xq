...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_GNURadio_0 in $node_Entity_0/RFDevice:hasChargingTime
  ...
  let $GRAPH_2 :=  
    for $node_Entity_0 in $doc_ObjectDescription[RFDevice:supportsSpectrumSensing/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Moving_instance22"]
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
