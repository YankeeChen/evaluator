...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_ContinuousWaveRadar_0 in $node_RadioComponent_0/Nuvio:partOf
  ...
  let $GRAPH_2 :=  
    for $node_RadioComponent_0 in $doc_ObjectDescription[Nuvio:compositeOf/@rdf:resource = "http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Mixer_instance9"]
    let $value_RadioComponent_0 := fn:data($node_RadioComponent_0/@rdf:about)
