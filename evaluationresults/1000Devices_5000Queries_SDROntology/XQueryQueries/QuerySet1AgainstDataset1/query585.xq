...
let $result :=  
  ...
  let $GRAPH_2 :=  
    ...
    for $node_Var0 in $node_PulseRadar_0/RFDevice:hasTarget
  ...
  let $GRAPH_4 :=  
    ...
    for $node_PulseRadar_0 in $node_RadioComponent_0/Nuvio:compositeOf
  ...
  let $GRAPH_7 := xqllib:and($GRAPH_3,$GRAPH_6,("PulseRadar_0"))
  let $GRAPH_8 := xqllib:and($GRAPH_2,$GRAPH_7,("PulseRadar_0"))
