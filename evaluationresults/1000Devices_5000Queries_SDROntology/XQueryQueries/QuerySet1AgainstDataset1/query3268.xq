...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB200_210_0 in $node_IEDTrigger_0/Nuvio:partOf
    let $value_USRPB200_210_0 := fn:data($node_USRPB200_210_0/@rdf:resource)
    where fn:exists($node_IEDTrigger_0) and fn:exists($value_USRPB200_210_0)
    return
      <xqllib:result>
  ...
  let $GRAPH_2 :=  
    ...
    for $node_IEDTrigger_0 in $node_Entity_0/RFDevice:supportsSpectrumSensing
  ...
  let $GRAPH_8 := xqllib:and($GRAPH_6,$GRAPH_7,("InformationContent_0"))
  let $GRAPH_9 := xqllib:optional($GRAPH_5,$GRAPH_8,("InformationRepresentation_0"))
  let $GRAPH_10 := xqllib:and($GRAPH_2,$GRAPH_9,("Entity_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("IEDTrigger_0"))
  let $GRAPH_12 := xqllib:and($GRAPH_0,$GRAPH_11,("USRPB200_210_0"))
  return
    $GRAPH_12
return
