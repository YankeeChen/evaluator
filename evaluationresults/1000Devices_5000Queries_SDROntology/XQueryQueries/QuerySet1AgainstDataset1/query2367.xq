...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_Half_DuplexCommunicationsSystem_0 in $node_Receiving_0/RFDevice:supportsTuning
  ...
  let $GRAPH_3 :=  
    for $node_Receiving_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#RadarFrequencyBand_instance10"]/RFDevice:hasBandwidthRange
