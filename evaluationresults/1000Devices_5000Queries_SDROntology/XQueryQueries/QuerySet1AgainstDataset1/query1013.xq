...
let $result :=  
  ...
  let $GRAPH_5 :=  
    for $node_Var0 in $doc_ObjectDescription[rdf:type/@rdf:resource = "http://www.opengis.net/ont/sf#Line"]
  ...
  let $GRAPH_9 := xqllib:optional($GRAPH_0,$GRAPH_8,("RadarSystem_0"))
  return
    $GRAPH_9
return
