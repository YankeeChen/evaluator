...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_JammingSystem_0 in $node_Entity_0/RFDevice:hasGain
  ...
  let $GRAPH_4 :=  
    ...
    for $node_Entity_0 in $node_Quantity_0/RFDevice:hasMin
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
  ...
  let $GRAPH_10 := $GRAPH_9[(data(xqllib:var[@name="DataValue0"]) > -1447720377)]
  ...
  let $GRAPH_14 :=  
    ...
    for $node_Entity_0 in $node_SpatialUnit_0/Nuvio:expresses
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:resource)
