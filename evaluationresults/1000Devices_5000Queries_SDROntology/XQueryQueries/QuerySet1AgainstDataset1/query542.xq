...
let $result :=  
  ...
  let $GRAPH_3 :=  
    for $node_Transmitter_0 in $doc_ObjectDescription[@rdf:about="http://ece.neu.edu/ontologies/ObjectDescription1000.owl#Producer_instance269"]/RFDevice:isProducerOf
  ...
  let $GRAPH_4 := xqllib:optional($GRAPH_2,$GRAPH_3,("Transmitter_0"))
