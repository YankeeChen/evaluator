...
let $result :=  
  ...
  let $GRAPH_3 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    where fn:exists($node_DirectConversionReceiver_0) and fn:exists($node_Entity_0) and $node_DirectConversionReceiver_0/Nuvio:relevantIndividual/@rdf:resource = $value_Entity_0
    return
      <xqllib:result>
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Entity_0 := fn:data($node_Entity_0/@rdf:about)
    for $node_BlinkingJamming_0 in $node_Entity_0/RFDevice:supportsTransmitting
  ...
  let $GRAPH_10 := xqllib:optional($GRAPH_8,$GRAPH_9,("Attribute_0"))
  let $GRAPH_11 := xqllib:and($GRAPH_1,$GRAPH_10,("Entity_0"))
  let $GRAPH_12 := xqllib:optional($GRAPH_0,$GRAPH_11,("USRPB210_0"))
  return
    $GRAPH_12
return
