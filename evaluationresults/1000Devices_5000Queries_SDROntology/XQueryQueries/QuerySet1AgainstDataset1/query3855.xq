...
let $result :=  
  ...
  let $GRAPH_1 :=  
    ...
    for $node_USRPB2xx_0 in $node_Var0/RFDevice:hasNoiseFigure
  ...
  let $GRAPH_6 :=  
    ...
    let $value_Var1 := fn:data($node_Var1/@rdf:about)
    where fn:exists($node_FrequencyUnit_0) and fn:exists($node_Var1) and $node_FrequencyUnit_0/Nuvio:hasUnitOfMeasure/@rdf:resource = $value_Var1
    return
      <xqllib:result>
